        ...
        for i = 1, keyP["propertyNumber"] do
            ...
            if messageBytes[cursor + 0] == 0x7E and messageBytes[cursor + 1] == 0x00 then
                ...
                if messageBytes[cursor + 3] > 57 then
                    keyP["wetfilm_time"] = messageBytes[cursor + 61] * 256 + messageBytes[cursor + 60]
                end
...
function dataToJson(jsonCmd)
    ...
    if keyP["wetfilm_time"] ~= nil then streams["wetfilm_time"] = keyP["wetfilm_time"] end
