...
local function jsonToModel(jsonCmd, jsonType)
    ...
    if jsonType == "control" and streams[keyT["KEY_FN_NO_WIND_SENSE"]] ~= nil then
        ...
        elseif streams[keyT["KEY_FN_NO_WIND_SENSE"]] == keyV["VALUE_FUNCTION_OFF"] then
    ...
    if
        jsonType == "control"
        and (
            streams[keyT["KEY_AUTO_TEMP_UP"]] ~= nil
            or streams[keyT["KEY_AUTO_TEMP_DOWN"]] ~= nil
            or streams[keyT["KEY_COOL_TEMP_UP"]] ~= nil
            or streams[keyT["KEY_COOL_TEMP_DOWN"]] ~= nil
            or streams[keyT["KEY_HEAT_TEMP_UP"]] ~= nil
            or streams[keyT["KEY_HEAT_TEMP_DOWN"]] ~= nil
        )
    then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
    end
    ...
    if jsonType == "control" and (streams["uvc_remove_odor"] ~= nil or streams["uvc_power_off"] ~= nil) then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
    end
    ...
    if
        jsonType == "control"
        and (
            streams["main_horizontal_guide_strip_1"] ~= nil
            or streams["main_horizontal_guide_strip_2"] ~= nil
            or streams["main_horizontal_guide_strip_3"] ~= nil
            or streams["main_horizontal_guide_strip_4"] ~= nil
        )
    then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
    ...
    if jsonType == "control" and streams["wind_speed_right"] ~= nil then
        keyP["wind_speed_right"] = checkBoundary(streams["wind_speed_right"], 1, 102)
    end
    if jsonType == "control" and streams["wind_speed_right"] ~= nil then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
    end
    ...
    if jsonType == "control" and (streams["fresh_air_on_co2"] ~= nil or streams["fresh_air_off_co2"] ~= nil) then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
    end
    ...
    if
        jsonType == "control"
        and (
            streams["wind_swing_ud_angle_up"] ~= nil
            or streams["wind_swing_ud_angle_down"] ~= nil
            or streams["app_control_remember_ud"] ~= nil
        )
    then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
    ...
    if
        jsonType == "control"
        and (
            streams["wind_swing_lr_angle_up"] ~= nil
            or streams["wind_swing_lr_angle_down"] ~= nil
            or streams["app_control_remember_lr"] ~= nil
        )
    then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
    ...
    if
        jsonType == "control"
        and (
            streams["ieco_target_rate"] ~= nil
            or streams["ieco_indoor_wind_speed"] ~= nil
            or streams["ieco_outdoor_wind_speed"] ~= nil
            or streams["ieco_frame"] ~= nil
            or streams["ieco_expansion_valve"] ~= nil
            or streams["ieco_switch"] ~= nil
        )
    then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
        keyP["ieco_status"] = 1
    ...
    if
        jsonType == "control"
        and (
            streams["cool_light_color_r"] ~= nil
            or streams["cool_light_color_g"] ~= nil
            or streams["cool_light_color_b"] ~= nil
            or streams["heat_light_color_r"] ~= nil
            or streams["heat_light_color_g"] ~= nil
            or streams["heat_light_color_b"] ~= nil
            or streams["dry_light_color_r"] ~= nil
            or streams["dry_light_color_g"] ~= nil
            or streams["dry_light_color_b"] ~= nil
            or streams["remove_odor_light_color_r"] ~= nil
            or streams["remove_odor_light_color_g"] ~= nil
            or streams["remove_odor_light_color_b"] ~= nil
            or streams["fresh_light_color_r"] ~= nil
            or streams["fresh_light_color_g"] ~= nil
            or streams["fresh_light_color_b"] ~= nil
            or streams["purifier_light_color_r"] ~= nil
            or streams["purifier_light_color_g"] ~= nil
            or streams["purifier_light_color_b"] ~= nil
        )
    then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
    ...
    if streams["linkage_2_fresh_air_control_type"] ~= nil then
        keyP["linkage_2_fresh_air_control_type"] = streams["linkage_2_fresh_air_control_type"]
    end
    if streams["linkage_2_humi_control_type"] ~= nil then
        keyP["linkage_2_humi_control_type"] = streams["linkage_2_humi_control_type"]
    end
    if streams["linkage_2_purifier_control_type"] ~= nil then
        keyP["linkage_2_purifier_control_type"] = streams["linkage_2_purifier_control_type"]
    end
    if streams["linkage_2_wind_control_type"] ~= nil then
        keyP["linkage_2_wind_control_type"] = streams["linkage_2_wind_control_type"]
    end
    if streams["linkage_2_swing_control_type"] ~= nil then
        keyP["linkage_2_swing_control_type"] = streams["linkage_2_swing_control_type"]
    end
    if streams["linkage_2_dehumidity_control_type"] ~= nil then
        keyP["linkage_2_dehumidity_control_type"] = streams["linkage_2_dehumidity_control_type"]
    end
    if streams["linkage_2_remove_arofene_control_type"] ~= nil then
        keyP["linkage_2_remove_arofene_control_type"] = streams["linkage_2_remove_arofene_control_type"]
    end
    if streams["linkage_2_remove_allergy_control_type"] ~= nil then
        keyP["linkage_2_remove_allergy_control_type"] = streams["linkage_2_remove_allergy_control_type"]
    end
    if streams["linkage_2_air_remove_odor_control_type"] ~= nil then
        keyP["linkage_2_air_remove_odor_control_type"] = streams["linkage_2_air_remove_odor_control_type"]
    end
    ...
    if
        jsonType == "control"
        and (
            streams["eco_time_switch"] ~= nil
            or streams["eco_time_sec"] ~= nil
            or streams["eco_time_min"] ~= nil
            or streams["eco_time_hour"] ~= nil
        )
    then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
    ...
    if
        jsonType == "control"
        and (streams["prevent_super_cool_2"] ~= nil or streams["prevent_super_cool_mode_select"] ~= nil)
    then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
    ...
    if streams["prevent_super_cool_mode_select"] ~= nil then
        keyP["prevent_super_cool_mode_select"] = streams["prevent_super_cool_mode_select"]
    end
    if jsonType == "control" and (streams["radar_model_control"] ~= nil or streams["radar_clear"] ~= nil) then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
        keyP["radar_control"] = 1
    end
    if streams["radar_model_control"] ~= nil then keyP["radar_model_control"] = streams["radar_model_control"] end
    ...
    if streams["standby_func_select"] ~= nil then keyP["standby_func_select"] = streams["standby_func_select"] end
    if streams["standby_background_animation"] ~= nil then
        keyP["standby_background_animation"] = streams["standby_background_animation"]
    end
    if streams["tip_animation_1"] ~= nil then keyP["tip_animation_1"] = streams["tip_animation_1"] end
    if streams["tip_animation_2"] ~= nil then keyP["tip_animation_2"] = streams["tip_animation_2"] end
    if streams["tip_animation_3"] ~= nil then keyP["tip_animation_3"] = streams["tip_animation_3"] end
    if streams["tip_animation_4"] ~= nil then keyP["tip_animation_4"] = streams["tip_animation_4"] end
    if streams["tip_animation_5"] ~= nil then keyP["tip_animation_5"] = streams["tip_animation_5"] end
    if streams["animation_quit_time"] ~= nil then keyP["animation_quit_time"] = streams["animation_quit_time"] end
    ...
    if jsonType == "control" and streams["enter_nobody_energy_save_time"] ~= nil then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
        keyP["enter_nobody_energy_save_time"] = streams["enter_nobody_energy_save_time"]
    end
    ...
    if jsonType == "control" and streams["enter_nobody_power_off_time"] ~= nil then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
        keyP["enter_nobody_power_off_time"] = streams["enter_nobody_power_off_time"]
    end
    if streams["forget_auto_power_off"] ~= nil then keyP["forget_auto_power_off"] = streams["forget_auto_power_off"] end
    ...
    if jsonType == "control" and streams["auto_wind_straight_avoid_status"] ~= nil then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
        keyP["auto_wind_straight_avoid_status"] = streams["auto_wind_straight_avoid_status"]
    end
    if streams["radar_clear"] ~= nil then keyP["radar_clear"] = streams["radar_clear"] end
    if jsonType == "control" and streams["material_len"] ~= nil then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
        keyP["material_len"] = streams["material_len"]
    end
    if streams["material_crc8"] ~= nil then keyP["material_crc8"] = streams["material_crc8"] end
    if streams["material_frame_num"] ~= nil then keyP["material_frame_num"] = streams["material_frame_num"] end
    if streams["current_frame_index"] ~= nil then keyP["current_frame_index"] = streams["current_frame_index"] end
    if streams["current_frame_len"] ~= nil then keyP["current_frame_len"] = streams["current_frame_len"] end
    if streams["current_frame_data"] ~= nil then keyP["current_frame_data"] = streams["current_frame_data"] end
    ...
    if
        jsonType == "control"
        and (
            streams["background_animation_switch"] ~= nil
            or streams["festival_push_switch"] ~= nil
            or streams["birthday_push_switch"] ~= nil
            or streams["preview_animation"] ~= nil
            or streams["background_animation"] ~= nil
            or streams["festival_animation"] ~= nil
            or streams["birthday_animation"] ~= nil
            or streams["animation_quit_time"] ~= nil
        )
    then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
    ...
    if streams["background_animation_switch"] ~= nil then
        keyP["background_animation_switch"] = streams["background_animation_switch"]
    end
    if streams["festival_push_switch"] ~= nil then keyP["festival_push_switch"] = streams["festival_push_switch"] end
    if streams["birthday_push_switch"] ~= nil then keyP["birthday_push_switch"] = streams["birthday_push_switch"] end
    if streams["preview_animation"] ~= nil then keyP["preview_animation"] = streams["preview_animation"] end
    if streams["background_animation"] ~= nil then keyP["background_animation"] = streams["background_animation"] end
    if streams["festival_animation"] ~= nil then keyP["festival_animation"] = streams["festival_animation"] end
    if streams["birthday_animation"] ~= nil then keyP["birthday_animation"] = streams["birthday_animation"] end
    if
        jsonType == "control"
        and (
            streams["power_on_background_animation_switch"] ~= nil
            or streams["power_on_festival_push_switch"] ~= nil
            or streams["power_on_birthday_push_switch"] ~= nil
            or streams["power_on_preview_animation"] ~= nil
            or streams["power_on_background_animation"] ~= nil
            or streams["power_on_festival_animation"] ~= nil
            or streams["power_on_birthday_animation"] ~= nil
            or streams["power_on_animation_quit_time"] ~= nil
        )
    then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
    ...
    if streams["power_on_background_animation_switch"] ~= nil then
        keyP["power_on_background_animation_switch"] = streams["power_on_background_animation_switch"]
    end
    if streams["power_on_festival_push_switch"] ~= nil then
        keyP["power_on_festival_push_switch"] = streams["power_on_festival_push_switch"]
    end
    if streams["power_on_birthday_push_switch"] ~= nil then
        keyP["power_on_birthday_push_switch"] = streams["power_on_birthday_push_switch"]
    end
    if streams["power_on_preview_animation"] ~= nil then
        keyP["power_on_preview_animation"] = streams["power_on_preview_animation"]
    end
    if streams["power_on_background_animation"] ~= nil then
        keyP["power_on_background_animation"] = streams["power_on_background_animation"]
    end
    if streams["power_on_festival_animation"] ~= nil then
        keyP["power_on_festival_animation"] = streams["power_on_festival_animation"]
    end
    if streams["power_on_birthday_animation"] ~= nil then
        keyP["power_on_birthday_animation"] = streams["power_on_birthday_animation"]
    end
    if streams["power_on_animation_quit_time"] ~= nil then
        keyP["power_on_animation_quit_time"] = streams["power_on_animation_quit_time"]
    end
...
local function binToModel(binData, deviceSN8)
    ...
    then
        ...
        if dataType == 0x02 or dataType == 0x03 then
            if (messageBytes[11] ~= 0) and (messageBytes[11] ~= 0xFF) then
                ...
                keyP["analysis_value"] = keyP["analysis_value"] .. ",indoor_temperature"
            end
            if (messageBytes[12] ~= 0) and (messageBytes[12] ~= 0xFF) then
                ...
                keyP["analysis_value"] = keyP["analysis_value"] .. ",outdoor_temperature"
            end
        end
        ...
        if dataType == 0x05 then
            ...
            if #binData >= 30 then keyP["wind_speed_right"] = bit.band(messageBytes[30], 0x7F) end
        end
        if dataType == 0x05 then
            if #binData >= 26 then
        ...
        if dataType == 0x05 then
            ...
            keyP["wind_straight"] = bit.rshift(bit.band(messageBytes[18], 0x08), 3)
    ...
    if dataType == 0x04 and messageBytes[0] == 0xA1 then
        keyP["is_query"] = 0
        keyP["currentWorkTime"] = bit.bor(
            (bit.band(bit.lshift(messageBytes[9], 8), 0xFF00)),
            (bit.band(messageBytes[10], 0x00FF))
        ) * 60 * 24 + messageBytes[11] * 60 + messageBytes[12]
    ...
    if messageBytes[0] == 0xC1 then
        ...
        if messageBytes[3] == 0x44 then
            ...
            keyP["total_power_consumption"] = bcd2Int(messageBytes[4]) * 10000
                + bcd2Int(messageBytes[5]) * 100
                + bcd2Int(messageBytes[6])
                + bcd2Int(messageBytes[7]) / 100
            keyP["total_operating_consumption"] = bcd2Int(messageBytes[8]) * 10000
                + bcd2Int(messageBytes[9]) * 100
                + bcd2Int(messageBytes[10])
                + bcd2Int(messageBytes[11]) / 100
            keyP["current_operating_consumption"] = bcd2Int(messageBytes[12]) * 10000
                + bcd2Int(messageBytes[13]) * 100
                + bcd2Int(messageBytes[14])
                + bcd2Int(messageBytes[15]) / 100
            keyP["current_time_power"] = bcd2Int(messageBytes[16])
                + bcd2Int(messageBytes[17]) / 100
    ...
    if dataType == 0x05 and messageBytes[0] == 0xB5 then
        ...
        for i = 1, keyP["propertyNumber"] do
            ...
            if messageBytes[cursor + 0] == 0x43 and messageBytes[cursor + 1] == 0x00 then
                if messageBytes[cursor + 3] == 0x01 or messageBytes[cursor + 3] == 0x00 then
                end
                cursor = cursor + 4
            end
            ...
            if messageBytes[cursor + 0] == 0x2B and messageBytes[cursor + 1] == 0x02 then
                keyP["offline_operating_time"] =
                    bit.bor(bit.lshift(messageBytes[cursor + 4], 8), messageBytes[cursor + 3])
            ...
            if messageBytes[cursor + 0] == 0xE2 and messageBytes[cursor + 1] == 0x00 then
                ...
                keyP["current_time_power"] = bcd2Int(messageBytes[35])
                    + bcd2Int(messageBytes[36]) / 100
            ...
            if messageBytes[cursor + 0] == 0xE1 and messageBytes[cursor + 1] == 0x00 then
                cursor = cursor + messageBytes[cursor + 2] + 3
            end
            if messageBytes[cursor + 0] == 0xE0 and messageBytes[cursor + 1] == 0x00 then
                ...
                if keyP["outdoor_temperature"] > 32767 then
                    keyP["outdoor_temperature"] = keyP["outdoor_temperature"] - 65535 - 1
                end
                ...
                if keyP["fresh_air_intake_temp"] > 32767 then
                    keyP["fresh_air_intake_temp"] = keyP["fresh_air_intake_temp"] - 65535 - 1
                end
                cursor = cursor + messageBytes[cursor + 2] + 3
            end
            ...
            if messageBytes[cursor + 0] == 0xCC and messageBytes[cursor + 1] == 0x00 then
            ...
            if messageBytes[cursor + 0] == 0xD5 and messageBytes[cursor + 1] == 0x00 then
                cursor = cursor + messageBytes[cursor + 2] + 3
            end
            ...
            if messageBytes[cursor + 0] == 0xF8 and messageBytes[cursor + 1] == 0x00 then
                ...
                keyP["animation_quit_time"] = messageBytes[cursor + 12] * 256 + messageBytes[cursor + 11]
                cursor = cursor + messageBytes[cursor + 2] + 3
            end
            if messageBytes[cursor + 0] == 0x3A and messageBytes[cursor + 1] == 0x02 then
                keyP["room_select"] = messageBytes[cursor + 3]
                cursor = cursor + messageBytes[cursor + 2] + 3
            end
            if messageBytes[cursor + 0] == 0xFF and messageBytes[cursor + 1] == 0x00 then
            ...
            if messageBytes[cursor + 0] == 0x04 and messageBytes[cursor + 1] == 0x01 then
            ...
            if messageBytes[cursor + 0] == 0x7E and messageBytes[cursor + 1] == 0x00 then
                ...
                if
                    bit.band(messageBytes[cursor + 8], keyB["BYTE_START_TIMER_SWITCH_ON"])
                ...
                if
                    bit.band(messageBytes[cursor + 9], keyB["BYTE_CLOSE_TIMER_SWITCH_ON"])
                ...
                keyP["wind_straight"] = bit.rshift(bit.band(messageBytes[cursor + 22], 0x08), 3)
                keyP["wind_avoid"] = bit.rshift(bit.band(messageBytes[cursor + 22], 0x10), 4)
                ...
                keyP["child_lock"] = bit.rshift(bit.band(messageBytes[cursor + 26], 0x80), 7)
                if keyP["wind_swing_ud_angle"] == 2 then
                    keyP["wind_swing_ud_angle"] = 13
                elseif keyP["wind_swing_ud_angle"] == 3 then
                    keyP["wind_swing_ud_angle"] = 25
                ...
                if messageBytes[cursor + 3] > 52 then
                    keyP["arofene_filter_use_time"] = messageBytes[cursor + 56] * 256 + messageBytes[cursor + 55]
                end
                if messageBytes[cursor + 3] > 53 then keyP["remove_odor_fan_speed"] = messageBytes[cursor + 57] end
                if messageBytes[cursor + 3] > 54 then keyP["control_source"] = messageBytes[cursor + 58] end
                ...
                if messageBytes[cursor + 3] > 57 then
                    keyP["wetfilm_time_use"] = messageBytes[cursor + 61] * 256 + messageBytes[cursor + 60]
                end
                ...
                if messageBytes[cursor + 3] > 63 then
                    ...
                    keyP["standby_display"] = bit.rshift(bit.band(messageBytes[cursor + 67], 0x40), 6)
                    keyP["light_sensitive_status"] = bit.rshift(bit.band(messageBytes[cursor + 67], 0x80), 7)
                end
                if messageBytes[cursor + 3] > 65 then
                    keyP["remove_allergy_filter_use_time"] = messageBytes[cursor + 69] * 256 + messageBytes[cursor + 68]
                end
                if messageBytes[cursor + 3] > 62 then
                    keyP["air_filter_use_time"] = messageBytes[cursor + 66] * 256 + messageBytes[cursor + 65]
                end
                ...
                if messageBytes[cursor + 3] > 70 then
                    keyP["room_select"] = bit.band(messageBytes[cursor + 74], 0x03)
                    keyP["nobody_energy_save_tag"] = bit.rshift(bit.band(messageBytes[cursor + 74], 0x04), 2)
                    keyP["nobody_power_off_tag"] = bit.rshift(bit.band(messageBytes[cursor + 74], 0x08), 3)
                    keyP["cool_nobody_energy_save"] = bit.rshift(bit.band(messageBytes[cursor + 74], 0xF0), 4)
                end
                if messageBytes[cursor + 3] > 71 then
                    keyP["heat_nobody_energy_save"] = bit.band(messageBytes[cursor + 75], 0x0F)
                    keyP["nobody_power_off_status"] = bit.rshift(bit.band(messageBytes[cursor + 75], 0x10), 4)
                    keyP["nobody_energy_save_status"] = bit.rshift(bit.band(messageBytes[cursor + 75], 0x20), 5)
                    keyP["auto_wind_straight_avoid_status"] = bit.rshift(bit.band(messageBytes[cursor + 75], 0x40), 6)
                    keyP["sense_energy_save_time"] = bit.rshift(bit.band(messageBytes[cursor + 75], 0x80), 7)
                end
                if messageBytes[cursor + 3] > 72 then
                    keyP["forget_auto_power_off"] = bit.band(messageBytes[cursor + 76], 0x01)
                    keyP["has_forget_door_window"] = bit.rshift(bit.band(messageBytes[cursor + 76], 0x02), 1)
                    keyP["one_key_auto"] = bit.rshift(bit.band(messageBytes[cursor + 76], 0x08), 3)
                end
                if messageBytes[cursor + 3] > 76 then
                    keyP["enter_nobody_energy_save_time"] = messageBytes[cursor + 80]
                end
                if messageBytes[cursor + 3] > 77 then
                    keyP["enter_nobody_power_off_time"] = messageBytes[cursor + 81]
                end
    ...
    if (dataType == 0x02 and messageBytes[0] == 0xB0) or (dataType == 0x03 and messageBytes[0] == 0xB1) then
        ...
        for i = 1, keyP["propertyNumber"] do
            ...
            if messageBytes[cursor + 0] == 0x18 and messageBytes[cursor + 1] == 0x00 then
                if
                    messageBytes[cursor + 2] == 0x11
                    or messageBytes[cursor + 2] == 0x10
                    or messageBytes[cursor + 3] == 0x00
                then
            ...
            if messageBytes[cursor + 0] == 0x2B and messageBytes[cursor + 1] == 0x02 then
                keyP["offline_operating_time"] =
                    bit.bor(bit.lshift(messageBytes[cursor + 5], 8), messageBytes[cursor + 4])
                cursor = cursor + 6
            end
            if messageBytes[cursor + 0] == 0x28 and messageBytes[cursor + 1] == 0x02 then
                keyP["operating_time"] = bit.bor(
            ...
            if messageBytes[cursor + 0] == 0x69 and messageBytes[cursor + 1] == 0x00 then
                ...
                then
                    ...
                    keyP["arom_time_total"] =
                        bit.bor(bit.lshift(messageBytes[cursor + 10], 8), messageBytes[cursor + 9])
                    cursor = cursor + 11
                end
            end
            ...
            if messageBytes[cursor + 0] == 0xB2 and messageBytes[cursor + 1] == 0x00 then
                if messageBytes[cursor + 2] ~= 0x00 or messageBytes[cursor + 3] == 0x00 then
            ...
            if messageBytes[cursor + 0] == 0x1E and messageBytes[cursor + 1] == 0x00 then
                if
                    messageBytes[cursor + 2] == 0x11
                    or messageBytes[cursor + 2] == 0x10
                    or messageBytes[cursor + 3] == 0x00
            ...
            if messageBytes[cursor + 0] == 0xF8 and messageBytes[cursor + 1] == 0x00 then
                keyP["background_animation_switch"] = bit.band(messageBytes[cursor + 4], 0x01)
                keyP["festival_push_switch"] = bit.rshift(bit.band(messageBytes[cursor + 4], 0x02), 1)
                keyP["birthday_push_switch"] = bit.rshift(bit.band(messageBytes[cursor + 4], 0x04), 2)
                ...
                keyP["animation_quit_time"] = messageBytes[cursor + 10] * 256 + messageBytes[cursor + 9]
                cursor = cursor + messageBytes[cursor + 3] + 4
            end
            if messageBytes[cursor + 0] == 0x0B and messageBytes[cursor + 1] == 0x01 then
                keyP["power_on_background_animation_switch"] = bit.band(messageBytes[cursor + 4], 0x01)
                keyP["power_on_festival_push_switch"] = bit.rshift(bit.band(messageBytes[cursor + 4], 0x02), 1)
                keyP["power_on_birthday_push_switch"] = bit.rshift(bit.band(messageBytes[cursor + 4], 0x04), 2)
                ...
                keyP["power_on_animation_quit_time"] = messageBytes[cursor + 10] * 256 + messageBytes[cursor + 9]
                cursor = cursor + messageBytes[cursor + 3] + 4
            end
            if messageBytes[cursor + 0] == 0x3A and messageBytes[cursor + 1] == 0x02 then
            ...
            if messageBytes[cursor + 0] == 0xDE and messageBytes[cursor + 1] == 0x00 then
                ...
                if messageBytes[cursor + 3] > 6 then
                    keyP["wet_film_filter_total_time"] = messageBytes[cursor + 11] * 256 + messageBytes[cursor + 10]
                end
                cursor = cursor + messageBytes[cursor + 3] + 4
            end
            if messageBytes[cursor + 0] == 0xFA and messageBytes[cursor + 1] == 0x00 then
                keyP["nobody_energy_save_tag"] = messageBytes[cursor + 4]
                cursor = cursor + messageBytes[cursor + 3] + 4
            end
            if messageBytes[cursor + 0] == 0xFB and messageBytes[cursor + 1] == 0x00 then
                keyP["nobody_power_off_tag"] = messageBytes[cursor + 4]
                cursor = cursor + messageBytes[cursor + 3] + 4
            end
            if messageBytes[cursor + 0] == 0xFC and messageBytes[cursor + 1] == 0x00 then
            ...
            if messageBytes[cursor + 0] == 0xFD and messageBytes[cursor + 1] == 0x00 then
                keyP["enter_nobody_power_off_time"] = messageBytes[cursor + 4]
                keyP["forget_auto_power_off"] = messageBytes[cursor + 5]
                cursor = cursor + messageBytes[cursor + 3] + 4
            end
            if messageBytes[cursor + 0] == 0xFE and messageBytes[cursor + 1] == 0x00 then
...
function jsonToData(jsonCmd)
    ...
    if query then
        ...
        if queryType == "group_data_zero" or queryType == "group_data_four" or queryType == "group_data_one" then
            ...
            for v in values(queryList) do
                ...
                if
                    queryType == "cool_temp_down"
                    or queryType == "cool_temp_up"
                    or queryType == "auto_temp_down"
                    or queryType == "auto_temp_up"
                    or queryType == "heat_temp_down"
                    or queryType == "heat_temp_up"
                then
                ...
                if
                    queryType == "main_horizontal_guide_strip_1"
                    or queryType == "main_horizontal_guide_strip_2"
                    or queryType == "main_horizontal_guide_strip_3"
                    or queryType == "main_horizontal_guide_strip_4"
                then
                    bodyBytes[1 + propertyNum * 2 + 1] = 0x30
                    bodyBytes[1 + propertyNum * 2 + 2] = 0x02
                    propertyNum = propertyNum + 1
                ...
                if
                    queryType == "wind_swing_ud_angle_up"
                    or queryType == "wind_swing_ud_angle_down"
                    or queryType == "app_control_remember_ud"
                then
                ...
                if
                    queryType == "wind_swing_lr_angle_up"
                    or queryType == "wind_swing_lr_angle_down"
                    or queryType == "app_control_remember_lr"
                then
                ...
                if queryType == "standby_display" or queryType == "animation_display" then
                    bodyBytes[1 + propertyNum * 2 + 1] = 0xF8
                    bodyBytes[1 + propertyNum * 2 + 2] = 0x00
                    propertyNum = propertyNum + 1
                end
                if queryType == "power_on_standby_display" or queryType == "animation_display" then
                    bodyBytes[1 + propertyNum * 2 + 1] = 0x0B
    ...
    elseif control then
        ...
        if control then
            if control["ilinkId"] ~= nil and control["ticket"] ~= nil then
                ...
                for i = 0, #control["ticket"] - 1 do
                    bodyBytes[16 + count + i] = string.byte(string.sub(control["ticket"], i + 1, i + 1))
                end
        ...
        if keyP["propertyNumber"] == 0 then
            ...
            if
                keyP["cool_temp_down"] ~= nil
                or keyP["cool_temp_up"] ~= nil
                or keyP["auto_temp_down"] ~= nil
                or keyP["auto_temp_up"] ~= nil
                or keyP["heat_temp_down"] ~= nil
                or keyP["heat_temp_up"] ~= nil
            then
            ...
            if keyP["ieco_status"] == 1 then
                ...
                bodyBytes[cursor + 18] =
                    bit.rshift(bit.band(keyP["frequency_compensation"] * 100 + 65535 + 1, 0xff00), 8)
                cursor = cursor + 19
            end
            ...
            if keyP["radar_control"] ~= nil then
                ...
                if keyP["radar_clear"] ~= nil then bodyBytes[cursor + 8] = keyP["radar_clear"] end
            ...
            if keyP["power_off_display_control"] ~= nil then
                ...
                bodyBytes[cursor + 2] = 0x07
                bodyBytes[cursor + 3] = 0
                bodyBytes[cursor + 3] = bit.bor(keyP["background_animation_switch"], bodyBytes[cursor + 3])
                bodyBytes[cursor + 3] = bit.bor(bit.lshift(keyP["festival_push_switch"], 1), bodyBytes[cursor + 3])
                bodyBytes[cursor + 3] = bit.bor(bit.lshift(keyP["birthday_push_switch"], 2), bodyBytes[cursor + 3])
                ...
                bodyBytes[cursor + 8] = bit.band(keyP["animation_quit_time"], 0xFF)
                bodyBytes[cursor + 9] = bit.band(bit.rshift(keyP["animation_quit_time"], 8), 0xFF)
                cursor = cursor + 10
            end
            if keyP["power_on_display_control"] ~= nil then
                ...
                bodyBytes[cursor + 2] = 0x07
                bodyBytes[cursor + 3] = 0
                bodyBytes[cursor + 3] = bit.bor(keyP["power_on_background_animation_switch"], bodyBytes[cursor + 3])
                bodyBytes[cursor + 3] =
                    bit.bor(bit.lshift(keyP["power_on_festival_push_switch"], 1), bodyBytes[cursor + 3])
                bodyBytes[cursor + 3] =
                    bit.bor(bit.lshift(keyP["power_on_birthday_push_switch"], 2), bodyBytes[cursor + 3])
                ...
                bodyBytes[cursor + 8] = bit.band(keyP["power_on_animation_quit_time"], 0xFF)
                bodyBytes[cursor + 9] = bit.band(bit.rshift(keyP["power_on_animation_quit_time"], 8), 0xFF)
                cursor = cursor + 10
            end
            ...
            if keyP["material_len"] ~= nil then
                ...
                bodyBytes[cursor + 4] = bit.band(bit.rshift(keyP["material_len"], 8), 0xFF)
...
function dataToJson(jsonCmd)
    ...
    if (keyP["outdoorTemperatureValue"] ~= nil) and (keyP["smallOutdoorTemperatureValue"] ~= nil) then
        ...
        if keyP["outdoorTemperatureValue"] < 0 then
            streams[keyV["VALUE_OUTDOOR_TEMPERATURE"]] = t1 - keyP["smallOutdoorTemperatureValue"] / 10
        else
            streams[keyV["VALUE_OUTDOOR_TEMPERATURE"]] = t1 + keyP["smallOutdoorTemperatureValue"] / 10
        end
    end
    ...
    if (keyP["indoorTemperatureValue"] ~= nil) and (keyP["smallIndoorTemperatureValue"] ~= nil) then
        ...
        if keyP["indoorTemperatureValue"] < 0 then
            streams[keyV["VALUE_INDOOR_TEMPERATURE"]] = t1 - keyP["smallIndoorTemperatureValue"] / 10
        else
            streams[keyV["VALUE_INDOOR_TEMPERATURE"]] = t1 + keyP["smallIndoorTemperatureValue"] / 10
        end
    end
    ...
    if keyP["swingLRValueUnder"] == keyB["BYTE_SWING_LR_UNDER_ON"] or keyP["swingLRValueUnder"] == 0x40 then
    ...
    if keyP["total_operating_time_second"] ~= nil then
        streams["total_operating_time_second"] = keyP["total_operating_time_second"]
    end
    if keyP["current_operating_time_day"] ~= nil then
        streams["current_operating_time_day"] = keyP["current_operating_time_day"]
    end
    if keyP["current_operating_time_hour"] ~= nil then
        streams["current_operating_time_hour"] = keyP["current_operating_time_hour"]
    end
    if keyP["current_operating_time_min"] ~= nil then
        streams["current_operating_time_min"] = keyP["current_operating_time_min"]
    end
    if keyP["current_operating_time_second"] ~= nil then
        streams["current_operating_time_second"] = keyP["current_operating_time_second"]
    end
    ...
    if keyP["total_operating_consumption"] ~= nil then
        streams["total_operating_consumption"] = keyP["total_operating_consumption"]
    end
    if keyP["current_operating_consumption"] ~= nil then
        streams["current_operating_consumption"] = keyP["current_operating_consumption"]
    end
    ...
    if keyP["high_temp_remove_odor_alone"] ~= nil then
        streams["high_temp_remove_odor_alone"] = keyP["high_temp_remove_odor_alone"]
    end
    if keyP["power_lock"] ~= nil then
    ...
    if keyP["has_wind_swing_ud_angle_diy"] ~= nil then
        streams["has_wind_swing_ud_angle_diy"] = keyP["has_wind_swing_ud_angle_diy"]
    end
    if keyP["has_wind_swing_lr_angle_diy"] ~= nil then
        streams["has_wind_swing_lr_angle_diy"] = keyP["has_wind_swing_lr_angle_diy"]
    end
    if keyP["has_left_down_real_wind_speed"] ~= nil then
        streams["has_left_down_real_wind_speed"] = keyP["has_left_down_real_wind_speed"]
    end
    ...
    if keyP["has_no_wind_sense_judge_param"] ~= nil then
        streams["has_no_wind_sense_judge_param"] = keyP["has_no_wind_sense_judge_param"]
    end
    ...
    if keyP["linkage_2_fresh_air_auto"] ~= nil then
        ...
        streams["linkage_2_fresh_air_control_type"] = keyP["linkage_2_fresh_air_auto"]
    end
    ...
    if keyP["linkage_2_purifier_auto"] ~= nil then
        ...
        streams["linkage_2_purifier_control_type"] = keyP["linkage_2_purifier_auto"]
    end
    ...
    if keyP["prevent_straight_wind_distance"] ~= nil then
        streams["prevent_straight_wind_distance"] = keyP["prevent_straight_wind_distance"]
    end
    if keyP["auto_prevent_cold_wind_memory"] ~= nil then
        streams["auto_prevent_cold_wind_memory"] = keyP["auto_prevent_cold_wind_memory"]
    end
    if keyP["has_auto_prevent_cold_wind_memory"] ~= nil then
        streams["has_auto_prevent_cold_wind_memory"] = keyP["has_auto_prevent_cold_wind_memory"]
    end
    ...
    if keyP["linkage_2_dehumidity_auto"] ~= nil then
        ...
        streams["linkage_2_dehumidity_control_type"] = keyP["linkage_2_dehumidity_auto"]
    end
    if keyP["linkage_2_remove_arofene_auto"] ~= nil then
        streams["linkage_2_remove_arofene_auto"] = keyP["linkage_2_remove_arofene_auto"]
        streams["linkage_2_remove_arofene_control_type"] = keyP["linkage_2_remove_arofene_auto"]
    end
    if keyP["linkage_2_air_remove_odor_auto"] ~= nil then
        streams["linkage_2_air_remove_odor_auto"] = keyP["linkage_2_air_remove_odor_auto"]
        streams["linkage_2_air_remove_odor_control_type"] = keyP["linkage_2_air_remove_odor_auto"]
    end
    if keyP["linkage_2_remove_allergy_auto"] ~= nil then
        streams["linkage_2_remove_allergy_auto"] = keyP["linkage_2_remove_allergy_auto"]
        streams["linkage_2_remove_allergy_control_type"] = keyP["linkage_2_remove_allergy_auto"]
    end
    if keyP["pm25_value"] ~= nil then streams["pm25_value"] = keyP["pm25_value"] end
    ...
    if keyP["prevent_super_cool_mode_select"] ~= nil then
        streams["prevent_super_cool_mode_select"] = keyP["prevent_super_cool_mode_select"]
    end
    if keyP["has_prevent_super_cool_mode_select"] ~= nil then
        streams["has_prevent_super_cool_mode_select"] = keyP["has_prevent_super_cool_mode_select"]
    end
    ...
    if keyP["millimeter_wave_model_fault"] ~= nil then
        streams["millimeter_wave_model_fault"] = keyP["millimeter_wave_model_fault"]
    end
    ...
    if keyP["radar_model_control_status"] ~= nil then
        streams["radar_model_control_status"] = keyP["radar_model_control_status"]
    end
    if keyP["dynamic_distance_check_status"] ~= nil then
        streams["dynamic_distance_check_status"] = keyP["dynamic_distance_check_status"]
    end
    if keyP["static_distance_check_status"] ~= nil then
        streams["static_distance_check_status"] = keyP["static_distance_check_status"]
    end
    if keyP["detection_sense_level_status"] ~= nil then
        streams["detection_sense_level_status"] = keyP["detection_sense_level_status"]
    end
    ...
    if keyP["remove_allergy_filter_use_time"] ~= nil then
        streams["remove_allergy_filter_use_time"] = keyP["remove_allergy_filter_use_time"]
    end
    ...
    if keyP["fresh_air_filter_total_time"] ~= nil then
        streams["fresh_air_filter_total_time"] = keyP["fresh_air_filter_total_time"]
    end
    if keyP["remove_allergy_filter_total_time"] ~= nil then
        streams["remove_allergy_filter_total_time"] = keyP["remove_allergy_filter_total_time"]
    end
    if keyP["remove_arofene_filter_total_time"] ~= nil then
        streams["remove_arofene_filter_total_time"] = keyP["remove_arofene_filter_total_time"]
    end
    if keyP["wet_film_filter_total_time"] ~= nil then
        streams["wet_film_filter_total_time"] = keyP["wet_film_filter_total_time"]
    end
    if keyP["exit_time_set"] ~= nil then streams["exit_time_set"] = keyP["exit_time_set"] end
    if keyP["control_source"] ~= nil then streams["control_source"] = keyP["control_source"] end
    if keyP["light_sensitive_status"] ~= nil then streams["light_sensitive_status"] = keyP["light_sensitive_status"] end
    ...
    if keyP["room_select"] ~= nil then streams["room_select"] = keyP["room_select"] end
    if keyP["auto_wind_straight_avoid_status"] ~= nil then
        streams["auto_wind_straight_avoid_status"] = keyP["auto_wind_straight_avoid_status"]
    end
    if keyP["sense_energy_save_time"] ~= nil then streams["sense_energy_save_time"] = keyP["sense_energy_save_time"] end
    if keyP["nobody_energy_save_tag"] ~= nil then streams["nobody_energy_save_tag"] = keyP["nobody_energy_save_tag"] end
    if keyP["nobody_power_off_tag"] ~= nil then streams["nobody_power_off_tag"] = keyP["nobody_power_off_tag"] end
    ...
    if keyP["enter_nobody_energy_save_time"] ~= nil then
        streams["enter_nobody_energy_save_time"] = keyP["enter_nobody_energy_save_time"]
    end
    if keyP["enter_nobody_power_off_time"] ~= nil then
        streams["enter_nobody_power_off_time"] = keyP["enter_nobody_power_off_time"]
    end
    if keyP["forget_auto_power_off"] ~= nil then streams["forget_auto_power_off"] = keyP["forget_auto_power_off"] end
    if keyP["has_forget_door_window"] ~= nil then streams["has_forget_door_window"] = keyP["has_forget_door_window"] end
    ...
    if keyP["standby_func_select"] ~= nil then streams["standby_func_select"] = keyP["standby_func_select"] end
    if keyP["standby_background_animation"] ~= nil then
        streams["standby_background_animation"] = keyP["standby_background_animation"]
    end
    if keyP["tip_animation_1"] ~= nil then streams["tip_animation_1"] = keyP["tip_animation_1"] end
    if keyP["tip_animation_2"] ~= nil then streams["tip_animation_2"] = keyP["tip_animation_2"] end
    if keyP["tip_animation_3"] ~= nil then streams["tip_animation_3"] = keyP["tip_animation_3"] end
    if keyP["tip_animation_4"] ~= nil then streams["tip_animation_4"] = keyP["tip_animation_4"] end
    if keyP["tip_animation_5"] ~= nil then streams["tip_animation_5"] = keyP["tip_animation_5"] end
    if keyP["animation_quit_time"] ~= nil then streams["animation_quit_time"] = keyP["animation_quit_time"] end
    if keyP["wind_swing_lr_max"] ~= nil then streams["wind_swing_lr_max"] = keyP["wind_swing_lr_max"] end
    if keyP["wind_swing_lr_min"] ~= nil then streams["wind_swing_lr_min"] = keyP["wind_swing_lr_min"] end
    if keyP["wind_swing_ud_max"] ~= nil then streams["wind_swing_ud_max"] = keyP["wind_swing_ud_max"] end
    if keyP["wind_swing_ud_min"] ~= nil then streams["wind_swing_ud_min"] = keyP["wind_swing_ud_min"] end
    if keyP["background_animation_switch"] ~= nil then
        streams["background_animation_switch"] = keyP["background_animation_switch"]
    end
    if keyP["festival_push_switch"] ~= nil then streams["festival_push_switch"] = keyP["festival_push_switch"] end
    if keyP["birthday_push_switch"] ~= nil then streams["birthday_push_switch"] = keyP["birthday_push_switch"] end
    if keyP["preview_animation"] ~= nil then streams["preview_animation"] = keyP["preview_animation"] end
    if keyP["background_animation"] ~= nil then streams["background_animation"] = keyP["background_animation"] end
    if keyP["festival_animation"] ~= nil then streams["festival_animation"] = keyP["festival_animation"] end
    if keyP["birthday_animation"] ~= nil then streams["birthday_animation"] = keyP["birthday_animation"] end
    if keyP["animation_quit_time"] ~= nil then streams["animation_quit_time"] = keyP["animation_quit_time"] end
    if keyP["power_on_background_animation_switch"] ~= nil then
        streams["power_on_background_animation_switch"] = keyP["power_on_background_animation_switch"]
    end
    if keyP["power_on_festival_push_switch"] ~= nil then
        streams["power_on_festival_push_switch"] = keyP["power_on_festival_push_switch"]
    end
    if keyP["power_on_birthday_push_switch"] ~= nil then
        streams["power_on_birthday_push_switch"] = keyP["power_on_birthday_push_switch"]
    end
    if keyP["power_on_preview_animation"] ~= nil then
        streams["power_on_preview_animation"] = keyP["power_on_preview_animation"]
    end
    if keyP["power_on_background_animation"] ~= nil then
        streams["power_on_background_animation"] = keyP["power_on_background_animation"]
    end
    if keyP["power_on_festival_animation"] ~= nil then
        streams["power_on_festival_animation"] = keyP["power_on_festival_animation"]
    end
    if keyP["power_on_birthday_animation"] ~= nil then
        streams["power_on_birthday_animation"] = keyP["power_on_birthday_animation"]
    end
    if keyP["power_on_animation_quit_time"] ~= nil then
        streams["power_on_animation_quit_time"] = keyP["power_on_animation_quit_time"]
    end
    if keyP["one_key_auto"] ~= nil then streams["one_key_auto"] = keyP["one_key_auto"] end
    keyP["propertyNumber"] = 0
    keyP["prevent_super_cool"] = nil
    keyP["prevent_straight_wind"] = nil
    keyP["auto_prevent_straight_wind"] = nil
