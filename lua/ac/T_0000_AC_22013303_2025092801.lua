...
local function jsonToModel(jsonCmd, jsonType)
    ...
    if (jsonType == "control" and
        (streams["background_animation_switch"] ~= nil or
            ...
            streams["birthday_push_switch"] ~= nil or
            streams["preview_animation"] ~= nil or
            streams["background_animation"] ~= nil or
            streams["festival_animation"] ~= nil or
            streams["birthday_animation"] ~= nil or
            streams["animation_quit_time"] ~= nil)) then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
    ...
    if (jsonType == "control" and
        (streams["power_on_background_animation_switch"] ~= nil or
            ...
            streams["power_on_birthday_push_switch"] ~= nil or
            streams["power_on_preview_animation"] ~= nil or
            streams["power_on_background_animation"] ~= nil or
            streams["power_on_festival_animation"] ~= nil or
            streams["power_on_birthday_animation"] ~= nil or
            streams["power_on_animation_quit_time"] ~= nil)) then
        keyP["propertyNumber"] = keyP["propertyNumber"] + 1
