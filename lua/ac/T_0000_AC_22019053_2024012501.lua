    ...
    then
        ...
        if dataType == 0x05 then
            ...
            if #binData >= 33 then
                ...
                keyP["fresh_air_mode_two"] = bit.rshift(bit.band(messageBytes[33], 0x30), 4)
        ...
        for i = 1, keyP["propertyNumber"] do
            ...
            if messageBytes[cursor + 0] == 0x7E and messageBytes[cursor + 1] == 0x00 then
                ...
                if messageBytes[cursor + 3] >= 44 then
                    ...
                    keyP["quick_fry_center_point"] = bit.band(messageBytes[cursor + 49], 0x0F)
                    if keyP["quick_fry_center_point"] == 2 then
                        keyP["quick_fry_center_point"] = 13
                    elseif keyP["quick_fry_center_point"] == 3 then
                        keyP["quick_fry_center_point"] = 25
                    elseif keyP["quick_fry_center_point"] == 4 then
                        keyP["quick_fry_center_point"] = 38
                    elseif keyP["quick_fry_center_point"] == 5 then
                        keyP["quick_fry_center_point"] = 50
                    elseif keyP["quick_fry_center_point"] == 6 then
                        keyP["quick_fry_center_point"] = 62
                    elseif keyP["quick_fry_center_point"] == 7 then
                        keyP["quick_fry_center_point"] = 75
                    elseif keyP["quick_fry_center_point"] == 8 then
                        keyP["quick_fry_center_point"] = 88
                    elseif keyP["quick_fry_center_point"] == 9 then
                        keyP["quick_fry_center_point"] = 100
                    end
                end
