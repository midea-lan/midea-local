...
local function io_debug(data)
    if test >= 3 then io.write(data) end
end
...
local function io_err(data)
    if test >= 1 then io.write(data) end
end
...
local key_maps = {
    ...
    },
    {
        ...
        value = { 2 },
        size = 1,
        path = "wind_speed_level",
        value_map = { [2] = "1", [3] = "2", [4] = "3", [5] = "4", [6] = "5", [7] = "6", [8] = "7", [9] = "auto" },
    },
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "swing_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 28,
        ...
        value = { 3 },
        size = 1,
        path = "swing_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "swing_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 30,
        ...
        value = { 1 },
        size = 1,
        path = "swing_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "wind_feeling_current",
        value_map = { [1] = "close", [2] = "follow", [3] = "avoid", [4] = "soft", [5] = "strong" },
    },
...

    {
        ...
        size = 1,
        path = "back_up_code",
        value_map = { [1] = "0", [2] = "T1", [3] = "T2", [5] = "T2B", [9] = "T2A" },
    },
    {
        idx = 36,
        changed = 0,
    ...
    --/*人感节能*/
    {
        ...
        value = { 1 },
        size = 1,
        path = "energy_saving_human_type",
        value_map = { [1] = "nobody_off", [2] = "nobody_temp", [3] = "none" },
    },
    {
        idx = 49,
        changed = 0,
        value = { 15 },
        size = 1,
        path = "energy_saving_nobody_off_delay",
        value_map = { [1] = "15", [2] = "30", [3] = "45", [4] = "60", [5] = "90", [6] = "120" },
    },
    {
        idx = 50,
        changed = 0,
        value = { 3 },
        size = 1,
        path = "energy_nobody_temp_time_interval",
        value_map = { [1] = "15", [2] = "30", [3] = "45", [4] = "60", [5] = "90", [6] = "120" },
    },
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "sterilize_status",
        value_map = { [1] = "auto", [2] = "on", [3] = "off" },
    },
    --/*性能衰减等级*/
    {
        idx = 59,
    ...
    },
    {
        ...
        size = 4,
        path = "ptc_supported",
        value_map = { [1] = "auto", [2] = "on", [3] = "off", [4] = "separate" },
    },
    {
        idx = 67,
        changed = 0,
    ...
    --/*气流群控*/
    {
        ...
        value = { 1 },
        size = 1,
        path = "airflow_group_control_type",
        value_map = { [1] = "custom1", [2] = "custom2", [3] = "soft", [4] = "whole_house", [5] = "close" },
    },
    {
        idx = 69,
        changed = 0,
        value = { 1 },
        size = 1,
        path = "airflow_group_control_custom1_type",
        value_map = { [1] = "type1", [2] = "type2", [3] = "none" },
    },
    {
        idx = 70,
        changed = 0,
        value = { 1 },
        size = 1,
        path = "airflow_group_custom1_type2_updown",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "airflow_group_custom1_type2_leftright",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "airflow_group_control_custom2_type",
        value_map = { [1] = "type1", [2] = "type2", [3] = "none" },
    },
    {
        idx = 73,
        ...
        value = { 1 },
        size = 1,
        path = "airflow_group_custom2_type2_updown",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "airflow_group_custom2_type2_leftright",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    --/*滤网提醒*/
    {
        ...
        value = { 1 },
        size = 1,
        path = "filter_notification_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 85,
        ...
        value = { 1 },
        size = 1,
        path = "filter_notification_status",
        value_map = { [1] = "off", [2] = "on" },
    },
    --/*日期与时间设置*/
    ...
    --/*周定时-延时关机*/
    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_override_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 92,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_override_time",
        value_map = { [1] = 30, [2] = 60, [3] = 90, [4] = 120, [5] = 180, [6] = 240 },
    },
    {
        idx = 93,
        changed = 0,
        value = { 0 },
        size = 1,
        path = "schedule_week_override_left",
        value_type = "uint8_t",
    },
    --/*周定时1*/
    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template0_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 95,
        ...
        value = { 0 },
        size = 2,
        path = "schedule_week_template0_weekday",
        value_type = "weekday",
    },
    {
        idx = 96,
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template0_action0_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 97,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template0_action0_min",
        value_type = "min",
    },
    {
        idx = 98,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template0_action0_hour",
        value_type = "hour",
    },
    {
        idx = 99,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template0_action0_temp",
        value_type = "temp",
    },
    {
        idx = 100,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template0_action0_temp_heat",
        value_type = "temp",
    },
    {
        idx = 101,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template0_action0_fan",
        value_map = key_map_value["wind_speed"],
    },
    {
        idx = 102,
        changed = 0,
        value = { 2 },
        size = 1,
        path = "schedule_week_template0_action0_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template0_action1_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 104,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template0_action1_min",
        value_type = "min",
    },
    {
        idx = 105,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template0_action1_hour",
        value_type = "hour",
    },
    {
        idx = 106,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template0_action1_temp",
        value_type = "temp",
    },
    {
        idx = 107,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template0_action1_temp_heat",
        value_type = "temp",
    },
    {
        idx = 108,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template0_action1_fan",
        value_map = key_map_value["wind_speed"],
    },
    {
        idx = 109,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template0_action1_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template0_action2_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 111,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template0_action2_min",
        value_type = "min",
    },
    {
        idx = 112,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template0_action2_hour",
        value_type = "hour",
    },
    {
        idx = 113,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template0_action2_temp",
        value_type = "temp",
    },
    {
        idx = 114,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template0_action2_temp_heat",
        value_type = "temp",
    },
    {
        idx = 115,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template0_action2_fan",
        value_map = key_map_value["wind_speed"],
    },
    {
        idx = 116,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template0_action2_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template0_action3_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 118,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template0_action3_min",
        value_type = "min",
    },
    {
        idx = 119,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template0_action3_hour",
        value_type = "hour",
    },
    {
        idx = 120,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template0_action3_temp",
        value_type = "temp",
    },
    {
        idx = 121,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template0_action3_temp_heat",
        value_type = "temp",
    },
    {
        idx = 122,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template0_action3_fan",
        value_map = key_map_value["wind_speed"],
    },
    {
        idx = 123,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template0_action3_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template0_action4_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 125,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template0_action4_min",
        value_type = "min",
    },
    {
        idx = 126,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template0_action4_hour",
        value_type = "hour",
    },
    {
        idx = 127,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template0_action4_temp",
        value_type = "temp",
    },
    {
        idx = 128,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template0_action4_temp_heat",
        value_type = "temp",
    },
    {
        idx = 129,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template0_action4_fan",
        value_map = key_map_value["wind_speed"],
    },
    {
        idx = 130,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template0_action4_mode",
        value_map = key_map_value["sche_mode"],
    },
    ...
    --/*周定时2*/
    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template1_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 132,
        ...
        value = { 0 },
        size = 2,
        path = "schedule_week_template1_weekday",
        value_type = "weekday",
    },
    {
        idx = 133,
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template1_action0_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 134,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template1_action0_min",
        value_type = "min",
    },
    {
        idx = 135,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template1_action0_hour",
        value_type = "hour",
    },
    {
        idx = 136,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template1_action0_temp",
        value_type = "temp",
    },
    {
        idx = 137,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template1_action0_temp_heat",
        value_type = "temp",
    },
    {
        idx = 138,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template1_action0_fan",
        value_map = key_map_value["wind_speed"],
    },
    {
        idx = 139,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template1_action0_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template1_action1_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 141,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template1_action1_min",
        value_type = "min",
    },
    {
        idx = 142,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template1_action1_hour",
        value_type = "hour",
    },
    {
        idx = 143,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template1_action1_temp",
        value_type = "temp",
    },
    {
        idx = 144,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template1_action1_temp_heat",
        value_type = "temp",
    },
    {
        idx = 145,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template1_action1_fan",
        value_map = key_map_value["wind_speed"],
    },
    {
        idx = 146,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template1_action1_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template1_action2_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 148,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template1_action2_min",
        value_type = "min",
    },
    {
        idx = 149,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template1_action2_hour",
        value_type = "hour",
    },
    {
        idx = 150,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template1_action2_temp",
        value_type = "temp",
    },
    {
        idx = 151,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template1_action2_temp_heat",
        value_type = "temp",
    },
    {
        idx = 152,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template1_action2_fan",
        value_map = key_map_value["wind_speed"],
    },
    {
        idx = 153,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template1_action2_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template1_action3_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 155,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template1_action3_min",
        value_type = "min",
    },
    {
        idx = 156,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template1_action3_hour",
        value_type = "hour",
    },
    {
        idx = 157,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template1_action3_temp",
        value_type = "temp",
    },
    {
        idx = 158,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template1_action3_temp_heat",
        value_type = "temp",
    },
    {
        idx = 159,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template1_action3_fan",
        value_map = key_map_value["wind_speed"],
    },
    {
        idx = 160,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template1_action3_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template1_action4_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 162,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template1_action4_min",
        value_type = "min",
    },
    {
        idx = 163,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template1_action4_hour",
        value_type = "hour",
    },
    {
        idx = 164,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template1_action4_temp",
        value_type = "temp",
    },
    {
        idx = 165,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template1_action4_temp_heat",
        value_type = "temp",
    },
    {
        idx = 166,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template1_action4_fan",
        value_map = key_map_value["wind_speed"],
    },
    {
        idx = 167,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template1_action4_mode",
        value_map = key_map_value["sche_mode"],
    },
    ...
    --/*周定时3*/
    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template2_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 169,
        ...
        value = { 0 },
        size = 2,
        path = "schedule_week_template2_weekday",
        value_type = "weekday",
    },
    {
        idx = 170,
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template2_action0_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 171,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template2_action0_min",
        value_type = "min",
    },
    {
        idx = 172,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template2_action0_hour",
        value_type = "hour",
    },
    {
        idx = 173,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template2_action0_temp",
        value_type = "temp",
    },
    {
        idx = 174,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template2_action0_temp_heat",
        value_type = "temp",
    },
    {
        idx = 175,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template2_action0_fan",
        value_map = key_map_value["wind_speed"],
    },
    {
        idx = 176,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template2_action0_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template2_action1_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 178,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template2_action1_min",
        value_type = "min",
    },
    {
        idx = 179,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template2_action1_hour",
        value_type = "hour",
    },
    {
        idx = 180,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template2_action1_temp",
        value_type = "temp",
    },
    {
        idx = 181,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template2_action1_temp_heat",
        value_type = "temp",
    },
    {
        idx = 182,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template2_action1_fan",
        value_map = key_map_value["wind_speed"],
    },
    {
        idx = 183,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template2_action1_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template2_action2_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 185,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template2_action2_min",
        value_type = "min",
    },
    {
        idx = 186,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template2_action2_hour",
        value_type = "hour",
    },
    {
        idx = 187,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template2_action2_temp",
        value_type = "temp",
    },
    {
        idx = 188,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template2_action2_temp_heat",
        value_type = "temp",
    },
    {
        idx = 189,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template2_action2_fan",
        value_map = key_map_value["wind_speed"],
    },
    {
        idx = 190,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template2_action2_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template2_action3_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 192,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template2_action3_min",
        value_type = "min",
    },
    {
        idx = 193,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template2_action3_hour",
        value_type = "hour",
    },
    {
        idx = 194,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template2_action3_temp",
        value_type = "temp",
    },
    {
        idx = 195,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template2_action3_temp_heat",
        value_type = "temp",
    },
    {
        idx = 196,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template2_action3_fan",
        value_map = key_map_value["wind_speed"],
    },
    {
        idx = 197,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template2_action3_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template2_action4_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 199,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template2_action4_min",
        value_type = "min",
    },
    {
        idx = 200,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template2_action4_hour",
        value_type = "hour",
    },
    {
        idx = 201,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template2_action4_temp",
        value_type = "temp",
    },
    {
        idx = 202,
        ...
        value = { 132 },
        size = 1,
        path = "schedule_week_template2_action4_temp_heat",
        value_type = "temp",
    },
    {
        idx = 203,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template2_action4_fan",
        value_map = key_map_value["wind_speed"],
    },
    {
        idx = 204,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template2_action4_mode",
        value_map = key_map_value["sche_mode"],
    },
    ...
    --/*简易周定时*/
    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template_simple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 206,
        ...
        value = { 0 },
        size = 2,
        path = "schedule_week_template_simple_weekday",
        value_type = "weekday",
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template_simple_action0_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 208,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template_simple_action0_min",
        value_type = "min",
    },
    {
        idx = 209,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template_simple_action0_hour",
        value_type = "hour",
    },
    {
        idx = 210,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template_simple_action0_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template_simple_action1_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 212,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template_simple_action1_min",
        value_type = "min",
    },
    {
        idx = 213,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template_simple_action1_hour",
        value_type = "hour",
    },
    {
        idx = 214,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template_simple_action1_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template_simple_action2_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 216,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template_simple_action2_min",
        value_type = "min",
    },
    {
        idx = 217,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template_simple_action2_hour",
        value_type = "hour",
    },
    {
        idx = 218,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template_simple_action2_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template_simple_action3_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 220,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template_simple_action3_min",
        value_type = "min",
    },
    {
        idx = 221,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template_simple_action3_hour",
        value_type = "hour",
    },
    {
        idx = 222,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template_simple_action3_mode",
        value_map = key_map_value["sche_mode"],
    },

    {
        ...
        value = { 1 },
        size = 1,
        path = "schedule_week_template_simple_action4_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 224,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template_simple_action4_min",
        value_type = "min",
    },
    {
        idx = 225,
        ...
        value = { 0 },
        size = 1,
        path = "schedule_week_template_simple_action4_hour",
        value_type = "hour",
    },
    {
        idx = 226,
        ...
        value = { 2 },
        size = 1,
        path = "schedule_week_template_simple_action4_mode",
        value_map = key_map_value["sche_mode"],
    },
    ...
    { idx = 228, changed = 0, value = { 0 }, size = 2, path = "holiday_template0_start_year", value_type = "year" },
    {
        ...
        value = { 0 },
        size = 1,
        path = "holiday_template0_start_month",
        value_type = "month",
    },
    ...
    { idx = 231, changed = 0, value = { 0 }, size = 2, path = "holiday_template0_end_year", value_type = "year" },
    {
        ...
        value = { 0 },
        size = 1,
        path = "holiday_template0_end_month",
        value_type = "month",
    },
    ...
    },
    {
        ...
        value = { 0 },
        size = 2,
        path = "holiday_template1_start_year",
        value_type = "year",
    },
    {
        idx = 236,
        ...
        value = { 0 },
        size = 1,
        path = "holiday_template1_start_month",
        value_type = "month",
    },
    ...
    { idx = 238, changed = 0, value = { 0 }, size = 2, path = "holiday_template1_end_year", value_type = "year" },
    {
        ...
        value = { 0 },
        size = 1,
        path = "holiday_template1_end_month",
        value_type = "month",
    },
    ...
    },
    {
        ...
        value = { 0 },
        size = 2,
        path = "holiday_template2_start_year",
        value_type = "year",
    },
    {
        idx = 243,
        ...
        value = { 0 },
        size = 1,
        path = "holiday_template2_start_month",
        value_type = "month",
    },
    {
        idx = 244,
        ...
        value = { 0 },
        size = 1,
        path = "holiday_template2_start_day",
        value_type = "date",
    },
    { idx = 245, changed = 0, value = { 0 }, size = 2, path = "holiday_template2_end_year", value_type = "year" },
    {
        ...
        value = { 0 },
        size = 1,
        path = "holiday_template2_end_month",
        value_type = "month",
    },
    ...
    },
    {
        ...
        value = { 0 },
        size = 2,
        path = "holiday_template3_start_year",
        value_type = "year",
    },
    {
        idx = 250,
        ...
        value = { 0 },
        size = 1,
        path = "holiday_template3_start_month",
        value_type = "month",
    },
    ...
    { idx = 252, changed = 0, value = { 0 }, size = 2, path = "holiday_template3_end_year", value_type = "year" },
    {
        ...
        value = { 0 },
        size = 1,
        path = "holiday_template3_end_month",
        value_type = "month",
    },
    ...
    },
    {
        ...
        value = { 0 },
        size = 2,
        path = "holiday_template4_start_year",
        value_type = "year",
    },
    {
        idx = 257,
        ...
        value = { 0 },
        size = 1,
        path = "holiday_template4_start_month",
        value_type = "month",
    },
    {
        idx = 258,
        ...
        value = { 0 },
        size = 1,
        path = "holiday_template4_start_day",
        value_type = "date",
    },
    {
        idx = 259,
        ...
        value = { 0 },
        size = 2,
        path = "holiday_template4_end_year",
        value_type = "year",
    },
    {
        idx = 260,
        ...
        value = { 0 },
        size = 1,
        path = "holiday_template4_end_month",
        value_type = "month",
    },
    ...
    -- /****************区域命名/内机命名*******************/
    {
        ...
        size = 1,
        path = "name_area",
        value_map = key_map_value["area_name"],
    },
    ...
    },
    {
        ...
        value = { 2 },
        size = 1,
        path = "name_idx0_part1",
        value_map = key_map_value["direction_name"],
    },
    {
        idx = 266,
        changed = 0,
        value = { 2 },
        size = 1,
        path = "name_idx0_part2_number0",
        value_map = key_map_value["serial_name"],
    },
    {
        idx = 267,
        changed = 0,
    ...
    { idx = 385, changed = 0, value = { 140 }, size = 1, path = "mcs_idx0_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx0_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 387,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx0_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx0_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 389,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx0_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx0_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 391,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx0_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx0_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx0_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx0_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    { idx = 404, changed = 0, value = { 140 }, size = 1, path = "mcs_idx1_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx1_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 406,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx1_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx1_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 408,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx1_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx1_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 410,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx1_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx1_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx1_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx1_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    { idx = 423, changed = 0, value = { 140 }, size = 1, path = "mcs_idx2_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx2_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 425,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx2_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx2_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 427,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx2_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx2_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 429,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx2_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx2_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx2_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx2_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    { idx = 442, changed = 0, value = { 140 }, size = 1, path = "mcs_idx3_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx3_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 444,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx3_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx3_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 446,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx3_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx3_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 448,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx3_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx3_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx3_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx3_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    { idx = 461, changed = 0, value = { 140 }, size = 1, path = "mcs_idx4_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx4_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 463,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx4_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx4_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 465,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx4_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx4_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 467,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx4_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx4_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx4_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx4_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    { idx = 480, changed = 0, value = { 140 }, size = 1, path = "mcs_idx5_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx5_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 482,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx5_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx5_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 484,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx5_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx5_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 486,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx5_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx5_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx5_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx5_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    { idx = 499, changed = 0, value = { 140 }, size = 1, path = "mcs_idx6_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx6_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 501,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx6_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx6_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 503,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx6_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx6_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 505,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx6_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx6_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx6_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx6_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    { idx = 518, changed = 0, value = { 140 }, size = 1, path = "mcs_idx7_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx7_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 520,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx7_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx7_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 522,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx7_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx7_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 524,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx7_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx7_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx7_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx7_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    { idx = 537, changed = 0, value = { 140 }, size = 1, path = "mcs_idx8_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx8_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 539,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx8_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx8_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 541,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx8_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx8_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 543,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx8_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx8_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx8_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx8_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    { idx = 556, changed = 0, value = { 140 }, size = 1, path = "mcs_idx9_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx9_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 558,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx9_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx9_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 560,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx9_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx9_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 562,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx9_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx9_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx9_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx9_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    { idx = 575, changed = 0, value = { 140 }, size = 1, path = "mcs_idx10_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx10_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 577,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx10_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx10_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 579,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx10_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx10_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 581,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx10_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx10_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx10_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx10_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    { idx = 594, changed = 0, value = { 140 }, size = 1, path = "mcs_idx11_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx11_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 596,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx11_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx11_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 598,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx11_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx11_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 600,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx11_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx11_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx11_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx11_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    { idx = 613, changed = 0, value = { 140 }, size = 1, path = "mcs_idx12_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx12_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 615,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx12_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx12_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 617,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx12_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx12_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 619,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx12_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx12_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx12_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx12_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    { idx = 632, changed = 0, value = { 140 }, size = 1, path = "mcs_idx13_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx13_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 634,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx13_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx13_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 636,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx13_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx13_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 638,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx13_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx13_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx13_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx13_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    { idx = 651, changed = 0, value = { 140 }, size = 1, path = "mcs_idx14_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx14_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 653,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx14_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx14_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 655,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx14_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx14_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 657,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx14_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx14_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx14_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx14_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    { idx = 670, changed = 0, value = { 140 }, size = 1, path = "mcs_idx15_auto_max", value_type = "temp" },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx15_louver_horizontal_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 672,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx15_louver_horizontal_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx15_louver_vertical_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 674,
        ...
        value = { 3 },
        size = 1,
        path = "mcs_idx15_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx15_swing_multiple_enable",
        value_map = { [1] = "false", [2] = "true" },
    },
    {
        idx = 676,
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx15_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx15_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx15_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 1,
        path = "mcs_idx15_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 3 },
        size = 2,
        path = "ctrl_louver_vertical_level",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 2,
        path = "ctrl_swing_multiple_louver1",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 2,
        path = "ctrl_swing_multiple_louver2",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 2,
        path = "ctrl_swing_multiple_louver3",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
    ...
    },
    {
        ...
        value = { 1 },
        size = 2,
        path = "ctrl_swing_multiple_louver4",
        value_map = {
            [13] = "close",
            [1] = "close",
            [2] = "1",
...
local function general_bin_section_without_key_map(key_map)
    ...
    elseif key_map.value_type == "uint32_t" or key_map.value_type == "uint32_t_100" then
        value_section_len = 4
...
local function update_data_without_key_map_by_json(key_map, value)
    ...
    elseif key_map.value_type == "year" then
        year = tonumber(value)
        if year > 2099 then year = 2099 end
...
local function update_data_by_json_single(key_map, json)
    ...
    if #new_value > 0 then
        ...
        if key_map.changed ~= nil then key_map.changed = 1 end
    ...
    if type(data) == "string" then
        ...
        elseif key_map.value_type == "version" then
            ...
            for i, v in string_split(data, ",") do
                if string2Int(v) ~= 0xFF then table.insert(new_value, string2Int(v)) end
            end
        ...
        elseif
            ...
            or key_map.value_type == "uint16_t_100"
            or key_map.value_type == "year"
            or key_map.value_type == "uint16_t_1/8"
        then
...
local function get_weekday_by_bits(data)
    ...
    for i = 1, 7 do --add xwb 2024-02-21
        if 0 ~= bit.band(bit.lshift(1, i - 1), data) then cnt = cnt + 1 end
    end
...
local function get_query_cmd(json)
    ...
    local binData = string.char(query_cmd)
        .. string.char(query_cmd)
        .. string.char(query_index1)
        .. string.char(query_index2)
        .. string.char(query_index3)
        .. string.char(query_cmd)
...
local function check_lua_header(binData)
    ...
    if
        data[1] ~= BYTE_PROTOCOL_HEAD
        or data[3] ~= 0xCC
        --or data[10] ~= BYTE_CONTROL_REQUEST
        or data[len] ~= makeSum(data, 2, len - 1)
    then
        io_err "format error\n"
        return 0
    end
...
local function check_hmiversion(hmiversion, dest)
    ...
    if hmiversion_major >= dest_major and hmiversion_minor >= dest_minor and hmiversion_patch >= dest_patch then
        return true
    end
    return false
end
...
function dataToJson(jsonStr)
    ...
    if json_data["status"]["error_code_str"] ~= nil and json_data["status"]["error_code_str"] ~= "/" then
    ...
    -- 处理控制应答
    if cmd_type[1] == 0x04 then json_data["msg_up_type"] = string.format("%X", cmd_type[2]) end
...
if test >= 1 then
    ...
    local function recv_and_handle_socket(data_handle)
        ...
        while 1 do
            if control == nil then control = socket_get_ctrl(server) end
            ...
            if status == "closed" then
                ...
                if data ~= nil then data_handle(data) end
            end
        end
    end
