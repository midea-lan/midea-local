...
function jsonToModel(jsonCmd)
    ...
    if streams[KEY_CODE_ID] ~= nil then codeID = checkBoundary(streams[KEY_CODE_ID], 0, 255) end
    ...
    if streams[KEY_RESERVE_SPEED] ~= nil then curWorkSpeed = checkBoundary(streams[KEY_RESERVE_SPEED], 0, 8) end
end
