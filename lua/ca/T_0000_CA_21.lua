...
uptable["quickBeverageContinuing"] = 0
...
local function getTotalMsg(bodyData, cType)
    ...
    msgBytes[3] = bit.bxor((bodyLength + uptable["BYTE_PROTOCOL_HEAD_LENGTH"] +
                               1), uptable["BYTE_DEVICE_TYPE"])
    msgBytes[9] = cType
...
local function jsonToModel(jsonCmd)
    ...
    if (streams["storage_temperature"] ~= nil) then
        uptable["refrigerationTemperature"] = checkBoundary(
                                                  streams["storage_temperature"],
                                                  -2, 10)
    end
    if (streams["freezing_temperature"] ~= nil) then
        uptable["freezingTemperature"] = checkBoundary(
                                             streams["freezing_temperature"],
                                             -30, -10)
        uptable["freezingTemperature"] =
            uptable["freezingTemperature"] +
                (((-15 - uptable["freezingTemperature"]) * 2) + 18)
    end
    if (streams["left_flexzone_temperature"] ~= nil) then
        uptable["lVariableTemperature"] = checkBoundary(
                                              streams["left_flexzone_temperature"],
                                              -30, 20)
        if ((uptable["lVariableTemperature"] >= -18) and
            (uptable["lVariableTemperature"] <= 10)) then
            uptable["lVariableTemperature"] =
                uptable["lVariableTemperature"] + 19
        elseif ((uptable["lVariableTemperature"] >= -24) and
            (uptable["lVariableTemperature"] <= -19)) then
            uptable["lVariableTemperature"] =
                uptable["lVariableTemperature"] + 30
        else
            uptable["lVariableTemperature"] = 0
        end
    end
    if (streams["right_flexzone_temperature"] ~= nil) then
        uptable["rVariableTemperature"] = checkBoundary(
                                              streams["right_flexzone_temperature"],
                                              -30, 20)
        if ((uptable["rVariableTemperature"] >= -18) and
            (uptable["rVariableTemperature"] <= 10)) then
            uptable["rVariableTemperature"] =
                uptable["rVariableTemperature"] + 19
        elseif ((uptable["rVariableTemperature"] >= -24) and
            (uptable["rVariableTemperature"] <= -19)) then
            uptable["rVariableTemperature"] =
                uptable["rVariableTemperature"] + 30
        else
            uptable["rVariableTemperature"] = 0
        end
    end
    ...
    if (streams["interval_room_humidity_level"] ~= nil) then
        uptable["intervalRoomHumidityLevel"] = checkBoundary(
                                                   streams["interval_room_humidity_level"],
                                                   0, 127)
    end
    ...
    if (streams["normal_zone_level"] ~= nil) then
        uptable["normalTemperatureLevel"] = checkBoundary(
                                                streams["normal_zone_level"], 1,
                                                10)
    end
    if (streams["function_zone_level"] ~= nil) then
        uptable["functionZoneLevel"] = checkBoundary(
                                           streams["function_zone_level"], 1, 10)
    end
    if (streams["humidify_setting"] ~= nil) then
        uptable["humiditySetting"] = checkBoundary(streams["humidify_setting"],
                                                   1, 99)
    end
    ...
    if (streams["storage_F_temperature"] ~= nil) then
        uptable["storageFTemperature"] = checkBoundary(
                                             streams["storage_F_temperature"],
                                             10, 50)
    end
    if (streams["freezing_F_temperature"] ~= nil) then
        uptable["freezingFTemperature"] = checkBoundary(
                                              streams["freezing_F_temperature"],
                                              -20, 20)
        uptable["freezingFTemperature"] = 11 - uptable["freezingFTemperature"]
    end
    if (streams["left_flexzone_F_temperature"] ~= nil) then
        uptable["leftFlexzoneFTemperature"] = checkBoundary(
                                                  streams["left_flexzone_F_temperature"],
                                                  10, 50) + 1
    end
    ...
    if (streams["quick_beverage_time"] ~= nil) then
        uptable["quickBeverageTime"] = checkBoundary(
                                           streams["quick_beverage_time"], 0,
                                           127)
    end
    ...
    if (streams["storage_light_level"] ~= nil) then
        uptable["storageLightLevel"] = checkBoundary(
                                           streams["storage_light_level"], -5,
                                           30)
    end
    ...
    if (streams["beverage_vial_number"] ~= nil) then
        uptable["beverageVialNumber"] = checkBoundary(
                                            streams["beverage_vial_number"], -5,
                                            300)
    end
    if (streams["beverage_mid_number"] ~= nil) then
        uptable["beverageMidNumber"] = checkBoundary(
                                           streams["beverage_mid_number"], -5,
                                           300)
    end
    if (streams["beverage_big_number"] ~= nil) then
        uptable["beverageBigNumber"] = checkBoundary(
                                           streams["beverage_big_number"], -5,
                                           300)
    end
    if (streams["beverage_quick_time"] ~= nil) then
        uptable["beverageQuickTime"] = checkBoundary(
                                           streams["beverage_quick_time"], -5,
                                           100)
    end
end
local function binToModel(binData)
    ...
    if ((uptable["dataType"] == 0x02 and messageBytes[0] == 0x00) or
        (uptable["dataType"] == 0x03 and messageBytes[0] == 0x00) or
        (uptable["dataType"] == 0x04 and messageBytes[0] == 0x02)) then
        ...
        uptable["freezingTemperature"] = bit.rshift(
                                             bit.band(messageBytes[2], 0xF0), 4)
        ...
        uptable["freezingIceMachineWaterStatus"] =
            bit.band(messageBytes[14], 0x04)
        ...
        if (#messageBytes > 25) then
            ...
            uptable["eradicatePesticideResidue"] =
            ...
            if (#messageBytes > 30) then
                ...
                if (#messageBytes > 31) then
                    uptable["storageLeftDoorAuto"] =
                        bit.band(messageBytes[31], 0x03)
                    uptable["storageRightDoorAuto"] =
                        bit.band(messageBytes[31], 0x0C)
                    uptable["freezerDoorAuto"] =
                        bit.band(messageBytes[31], 0x30)
                    uptable["freezerDoorAutoControl"] = bit.band(
                                                            messageBytes[31],
                                                            0x40)
                    uptable["storageDoorAutoControl"] = bit.band(
                                                            messageBytes[31],
                                                            0x80)
                    uptable["eradicatePesticideResidueProgress"] = bit.band(
                                                                       messageBytes[32],
                                                                       0x7F)
                    uptable["eradicatePesticideResidueCompletion"] = bit.band(
                                                                         messageBytes[32],
                                                                         0x80)
                    if (#messageBytes > 33) then
                        uptable["storageIceMachinePower"] = bit.band(
                                                                messageBytes[33],
                                                                0x01)
                        uptable["storageMotorResetStatus"] = bit.band(
                                                                 messageBytes[33],
                                                                 0x02)
                        uptable["storageMotorResetStatus"] = bit.band(
                                                                 messageBytes[33],
                                                                 0x04)
                        uptable["storageIceMachineWaterStatus"] = bit.band(
                                                                      messageBytes[33],
                                                                      0x08)
                        uptable["storageAllIceStatus"] = bit.band(
                                                             messageBytes[33],
                                                             0x10)
                        uptable["filterExpiresMildWarning"] = bit.band(
                                                                  messageBytes[33],
                                                                  0x20)
                        uptable["filterExpiresSevereWarning"] = bit.band(
                                                                    messageBytes[33],
                                                                    0x40)
                        ...
                        if (#messageBytes > 35) then
                            ...
                            uptable["leftFlexzoneFTemperature"] =
                                messageBytes[37]
                            if (#messageBytes > 38) then
                                uptable["electronicCleanStrong"] = bit.band(
                                                                       messageBytes[38],
                                                                       0x01)
                                uptable["electronicCleanTimeout"] = bit.band(
                                                                        messageBytes[38],
                                                                        0xFE)
                                if (uptable["electronicCleanTimeout"] ~= 0) then
                                    uptable["electronicCleanTimeout"] =
                                        bit.rshift(
                                            uptable["electronicCleanTimeout"], 1)
                                end
                                if (#messageBytes > 39) then
                                    uptable["quickBeverageTime"] = bit.band(
                                                                       messageBytes[39],
                                                                       0x7F)
                                    uptable["quickBeverage"] = bit.band(
                                                                   messageBytes[39],
                                                                   0x80)
                                    if (#messageBytes > 40) then
                                        uptable["aquaticProduct"] = bit.band(
                                                                        messageBytes[40],
                                                                        0x01)
                                        uptable["blueRayMode"] = bit.band(
                                                                     messageBytes[40],
                                                                     0x02)
                                        uptable["silentNightMode"] = bit.band(
                                                                         messageBytes[40],
                                                                         0x04)
                                        if (#messageBytes > 42) then
                                            uptable["storageLightLevel"] =
                                                bit.band(messageBytes[42], 0x1F)
                                            uptable["nightMode"] = bit.band(
                                                                       messageBytes[42],
                                                                       0x20)
                                            uptable["quickBeverageCompleted"] =
                                                bit.band(messageBytes[42], 0x40)
                                            uptable["quickBeverageContinuing"] =
                                                bit.band(messageBytes[42], 0x80)
                                            uptable["voiceDoorAuto"] = bit.band(
                                                                           messageBytes[43],
                                                                           0x01)
                                            uptable["touchDoorAuto"] = bit.band(
                                                                           messageBytes[43],
                                                                           0x02)
                                            uptable["helpDoorAuto"] = bit.band(
                                                                          messageBytes[43],
                                                                          0x04)
                                            uptable["speedDoorOpen"] = bit.band(
                                                                           messageBytes[43],
                                                                           0x08)
                                            uptable["angleDoorOpen"] = bit.band(
                                                                           messageBytes[43],
                                                                           0x30)
                                            uptable["voiceAssistant"] =
                                                bit.band(messageBytes[43], 0x40)
                                            uptable["noActionDoorClose"] =
                                                bit.band(messageBytes[43], 0x80)
                                            if (#messageBytes > 45) then
                                                uptable["filterNaturalTimeHigh"] =
                                                    messageBytes[45]
                                                uptable["filterNaturalTimeLow"] =
                                                    messageBytes[46]
                                                if (#messageBytes > 47) then
                                                    uptable["beverageVialNumber"] =
                                                        messageBytes[47]
                                                    uptable["beverageMidNumber"] =
                                                        messageBytes[48]
                                                    uptable["beverageBigNumber"] =
                                                        messageBytes[49]
                                                    uptable["beverageQuickTime"] =
                                                        messageBytes[50]
                                                    if (#messageBytes > 51) then
                                                        uptable["localTimeHour"] =
                                                            messageBytes[51]
                                                        uptable["localTimeMinute"] =
                                                            messageBytes[52]
                                                        uptable["localTimeSecond"] =
                                                            messageBytes[53]
                                                        uptable["timeZone"] =
                                                            messageBytes[54]
                                                        uptable["week"] =
                                                        ...
                                                        if (#messageBytes > 59) then
                                                            uptable["eCleaningPercentage"] =
                                                                messageBytes[59]
                                                            uptable["drinkValveEqualOpenHigh"] =
                                                                messageBytes[60]
                                                            uptable["drinkValveEqualOpenLow"] =
                                                                messageBytes[61]
                                                            uptable["inletValveEqualOpenHigh"] =
                                                                messageBytes[62]
                                                            uptable["inletValveEqualOpenLow"] =
                                                                messageBytes[63]
                                                            uptable["filterElementUsePercentage"] =
                                                                messageBytes[64]
                                                            uptable["iceMakerTimesHigh"] =
                                                                messageBytes[65]
                                                            uptable["iceMakerTimesLow"] =
                                                                messageBytes[66]
                                                        end
                                                    end
                                                end
    ...
    elseif ((uptable["dataType"] == 0x04 and messageBytes[0] == 0x01) or
        (uptable["dataType"] == 0x03 and messageBytes[0] == 0x01)) then
        ...
        if (#messageBytes > 54) then
            ...
            if (#messageBytes > 57) then
                uptable["electronicCleanStrong"] =
                    bit.band(messageBytes[66], 0x01)
                uptable["electronicCleanTimeout"] =
                    bit.band(messageBytes[66], 0xFE)
                if (uptable["electronicCleanTimeout"] ~= 0) then
                    uptable["electronicCleanTimeout"] = bit.rshift(
                                                            uptable["electronicCleanTimeout"],
                                                            1)
                end
            end
    ...
    elseif ((uptable["dataType"] == 0x06 and messageBytes[0] == 0x01) or
        (uptable["dataType"] == 0x03 and messageBytes[0] == 0x02)) then
        if (messageBytes[1] ~= 0x00 or messageBytes[2] ~= 0x00 or
            messageBytes[3] ~= 0x00 or messageBytes[4] ~= 0x00 or
            messageBytes[5] ~= 0x00 or messageBytes[6] ~= 0x00 or
            messageBytes[7] ~= 0x00) then
        ...
        uptable["refrigerationDefrostingSensorError"] = bit.band(
                                                            messageBytes[2],
                                                            0x02)
        ...
        uptable["freezingDefrostingSensorError"] =
            bit.band(messageBytes[2], 0x80)
        uptable["iceElectricalMachineryError"] = bit.band(messageBytes[3], 0x01)
        uptable["refrigerationDefrostingOvertime"] =
            bit.band(messageBytes[3], 0x02)
        ...
        uptable["flexzoneDefrostingSensorError"] =
            bit.band(messageBytes[4], 0x02)
        uptable["flexzoneDefrostingSensor2Error"] =
            bit.band(messageBytes[4], 0x04)
        uptable["yogurtMachineSensorError"] = bit.band(messageBytes[4], 0x08)
        uptable["iceMachineFrettingSwitchError"] =
            bit.band(messageBytes[4], 0x10)
        uptable["iceMachinePipeFilterOvertime"] =
            bit.band(messageBytes[4], 0x20)
        ...
        uptable["functionZoneTemperatureSensorError"] = bit.band(
                                                            messageBytes[5],
                                                            0x20)
        uptable["normalZoneTemperatureSensorError"] =
            bit.band(messageBytes[5], 0x40)
        ...
        uptable["storageDoorAloneOpenFrequently"] =
            bit.band(messageBytes[6], 0x02)
        uptable["freezingDoorAloneOpenFrequently"] =
        ...
        uptable["storageTemperatureOverheating"] =
            bit.band(messageBytes[6], 0x40)
        uptable["storageTemperatureTooLow"] = bit.band(messageBytes[6], 0x80)
        uptable["storageHeatingWireSensorError"] =
            bit.band(messageBytes[7], 0x01)
        ...
        uptable["storageIceMachineSensorError"] =
            bit.band(messageBytes[8], 0x08)
...
function jsonToData(jsonCmd)
    ...
    elseif (control) then
        ...
        for i = 0, 60 do bodyBytes[i] = 0 end
        bodyBytes[0] = 0x00
        bodyBytes[1] = bit.bor(bit.bor(bit.bor(bit.bor(
                                                   bit.bor(bit.bor(bit.bor(
                                                                       bit.band(
                                                                           uptable["codeMode"],
                                                                           0x01),
                                                                       bit.band(
                                                                           uptable["freezingMode"],
                                                                           0x02)),
                                                                   bit.band(
                                                                       uptable["smartMode"],
                                                                       0x04)),
                                                           bit.band(
                                                               uptable["energySavingMode"],
                                                               0x08)), bit.band(
                                                       uptable["holidayMode"],
                                                       0x10)), bit.band(
                                                   uptable["moisturizeMode"],
                                                   0x20)), bit.band(
                                           uptable["preservationMode"], 0x40)),
                               bit.band(uptable["acmeFreezingMode"], 0x80))
        bodyBytes[2] = bit.bor(bit.lshift(bit.band(
                                              uptable["freezingTemperature"],
                                              0x0F), 4), bit.band(
                                   uptable["refrigerationTemperature"], 0x0F))
        bodyBytes[3] = uptable["lVariableTemperature"]
        bodyBytes[4] = uptable["rVariableTemperature"]
        bodyBytes[5] = uptable["variableModeValue"]
        bodyBytes[6] = bit.bor(bit.bor(bit.bor(
                                           bit.bor(bit.bor(bit.bor(bit.band(
                                                                       uptable["refrigerationPowerValue"],
                                                                       0x01),
                                                                   bit.band(
                                                                       uptable["lVariablePowerValue"],
                                                                       0x04)),
                                                           bit.band(
                                                               uptable["rVariablePowerValue"],
                                                               0x08)), bit.band(
                                                       uptable["freezingPowerValue"],
                                                       0x10)), bit.band(
                                               uptable["crossPeakElectricityEnter"],
                                               0x20)), bit.band(
                                           uptable["crossPeakElectricity"], 0x40)),
                               bit.band(uptable["allRefrigerationPower"], 0x80))
        bodyBytes[7] = bit.bor(bit.bor(bit.bor(
                                           bit.bor(bit.bor(bit.band(
                                                               uptable["removeDew"],
                                                               0x01), bit.band(
                                                               uptable["humidify"],
                                                               0x02)), bit.band(
                                                       uptable["unfreeze"], 0x04)),
                                           bit.band(uptable["temperatureUnit"],
                                                    0x08)),
                                       bit.band(uptable["floodlight"], 0x10)),
                               bit.band(uptable["functionSwitch"], 0xC0))
        bodyBytes[8] = bit.bor(bit.bor(bit.bor(bit.bor(
                                                   bit.bor(bit.bor(bit.bor(
                                                                       bit.band(
                                                                           uptable["radarMode"],
                                                                           0x01),
                                                                   ...
                                                                   bit.band(
                                                                       ...
                                                                       0x04)),
                                                           bit.band(
                                                               uptable["plasmaAsepticMode"],
                                                               0x08)), bit.band(
                                                       uptable["acquireIceaMode"],
                                                       0x10)), bit.band(
                                                   uptable["brashIceaMode"],
                                                   0x20)), bit.band(
                                           uptable["acquireWaterMode"], 0x40)),
                               bit.band(uptable["freezingIceMachinePower"], 0x80))
        bodyBytes[14] = bit.band(uptable["humanInduction"], 0x10)
        ...
        if (uptable["microcrystalFresh"] ~= nil and uptable["dryZone"] ~= nil and
            uptable["performanceMode"] ~= nil and uptable["electronicSmell"] ~=
            nil and uptable["eradicatePesticideResidue"] ~= nil) then
            bodyBytes[27] = bit.bor(bit.bor(bit.bor(
                                                bit.bor(bit.bor(bit.band(
                                                                    uptable["microcrystalFresh"],
                                                                    0x01),
                                                                bit.band(
                                                                    uptable["dryZone"],
                                                                    0x02)),
                                                        bit.band(
                                                            uptable["electronicSmell"],
                                                            0x04)), bit.band(
                                                    uptable["eradicatePesticideResidue"],
                                                    0x08)),
        ...
        if (uptable["humiditySetting"] ~= nil and uptable["smartHumidity"] ~=
            nil) then
            bodyBytes[30] = bit.bor(bit.band(uptable["humiditySetting"], 0x7F),
                                    bit.band(uptable["smartHumidity"], 0x80))
        end
        if (uptable["storageLeftDoorAuto"] ~= nil and
            uptable["storageRightDoorAuto"] ~= nil and
            uptable["freezerDoorAuto"] ~= nil and
            uptable["freezerDoorAutoControl"] ~= nil and
            uptable["storageDoorAutoControl"] ~= nil) then
            bodyBytes[31] = bit.bor(bit.bor(
                                        bit.bor(bit.bor(bit.band(
                                                            uptable["storageLeftDoorAuto"],
                                                            0x03), bit.band(
                                                            uptable["storageRightDoorAuto"],
                                                    ...
                                                    uptable["freezerDoorAuto"],
                                                    0x30)), bit.band(
                                            uptable["freezerDoorAutoControl"],
                                            0x40)), bit.band(
                                        uptable["storageDoorAutoControl"], 0x80))
        end
        if (uptable["storageIceMachinePower"] ~= nil and
            uptable["filterReplacementWarningElimination"] ~= nil) then
            bodyBytes[33] = bit.bor(bit.band(uptable["storageIceMachinePower"],
                                             0x01), bit.band(
                                        uptable["filterReplacementWarningElimination"],
                                        0x80))
        end
        ...
        if (uptable["quickBeverageTime"] ~= nil and uptable["quickBeverage"] ~=
            nil) then
            bodyBytes[39] = bit.bor(
                                bit.band(uptable["quickBeverageTime"], 0x7F),
                                bit.band(uptable["quickBeverage"], 0x80))
        end
        if (uptable["aquaticProduct"] ~= nil and uptable["silentNightMode"] ~=
            nil) then
            bodyBytes[40] = bit.bor(bit.band(uptable["aquaticProduct"], 0x01),
                                    bit.band(uptable["silentNightMode"], 0x04))
        end
        bodyBytes[42] = bit.bor(bit.band(uptable["storageLightLevel"], 0x1F),
                                bit.band(uptable["nightMode"], 0x20))
        if (uptable["voiceDoorAuto"] ~= nil and uptable["touchDoorAuto"] ~= nil and
            uptable["helpDoorAuto"] ~= nil and uptable["speedDoorOpen"] ~= nil and
            uptable["angleDoorOpen"] ~= nil and uptable["voiceAssistant"] ~= nil and
            uptable["noActionDoorClose"] ~= nil) then
            bodyBytes[43] = bit.bor(bit.bor(bit.bor(
                                                bit.bor(bit.bor(bit.bor(
                                                                    bit.band(
                                                                        uptable["voiceDoorAuto"],
                                                                        0x01),
                                                                    bit.band(
                                                                        uptable["touchDoorAuto"],
                                                                        0x02)),
                                                                bit.band(
                                                                    uptable["helpDoorAuto"],
                                                                    0x04)),
                                                        bit.band(
                                                            uptable["speedDoorOpen"],
                                                            0x08)), bit.band(
                                                    uptable["angleDoorOpen"],
                                                    0x30)), bit.band(
                                                uptable["voiceAssistant"], 0x40)),
...
function dataToJson(jsonCmd)
    ...
    if ((uptable["dataType"] == 0x02 and bodyBytes[0] == 0x00) or
        (uptable["dataType"] == 0x03 and bodyBytes[0] == 0x00) or
        (uptable["dataType"] == 0x04 and bodyBytes[0] == 0x02)) then
        ...
        streams["storage_temperature"] = int2String(
                                             uptable["refrigerationTemperature"])
        streams["freezing_temperature"] = int2String(-12 -
                                                         uptable["freezingTemperature"])
        if ((uptable["lVariableTemperature"] >= 1) and
            (uptable["lVariableTemperature"] <= 29)) then
            streams["left_flexzone_temperature"] = int2String(
                                                       uptable["lVariableTemperature"] -
                                                           19)
        elseif ((uptable["lVariableTemperature"] >= 49) and
            (uptable["lVariableTemperature"] <= 54)) then
            streams["left_flexzone_temperature"] = int2String(30 -
                                                                  uptable["lVariableTemperature"])
        else
            streams["left_flexzone_temperature"] = "0"
        end
        if ((uptable["rVariableTemperature"]) and
            (uptable["rVariableTemperature"] <= 29)) then
            streams["right_flexzone_temperature"] = int2String(
                                                        uptable["rVariableTemperature"] -
                                                            19)
        elseif ((uptable["rVariableTemperature"] >= 49) and
            (uptable["rVariableTemperature"] <= 54)) then
            streams["right_flexzone_temperature"] = int2String(30 -
                                                                   uptable["rVariableTemperature"])
        else
        ...
        streams["freeze_fahrenheit_level"] = int2String(
                                                 uptable["freezingFahrenheit"])
        streams["refrigeration_fahrenheit_level"] = int2String(
                                                        uptable["refrigerationFahrenheit"])
        streams["leach_expire_day"] = int2String(uptable["leachExpireDay"])
        streams["power_consumption_low"] = int2String(
                                               uptable["powerConsumptionLow"])
        streams["power_consumption_high"] = int2String(
                                                uptable["powerConsumptionHigh"])
        ...
        streams["interval_room_humidity_level"] = int2String(
                                                      uptable["intervalRoomHumidityLevel"])
        streams["refrigeration_real_temperature"] =
            int2String(math.floor((uptable["refrigerationRealTemperature"] - 100) /
                                      2))
        streams["freezing_real_temperature"] =
            int2String(math.floor((uptable["freezingRealTemperature"] - 100) / 2))
        streams["left_variable_real_temperature"] =
            int2String(math.floor((uptable["lVariableRealTemperature"] - 100) /
                                      2))
        streams["right_variable_real_temperature"] =
            int2String(math.floor((uptable["rVariableRealTemperature"] - 100) /
                                      2))
        streams["fast_cold_minute"] = int2String(256 *
                                                     uptable["fastColdMinuteHigh"] +
                                                     uptable["fastColdMinuteLow"])
        streams["fast_freeze_minute"] = int2String(256 *
                                                       uptable["fastFreezeMinuteLow"] +
        ...
        if (bodyLength > 25) then
            ...
            streams["normal_zone_level"] = int2String(
                                               uptable["normalTemperatureLevel"])
            streams["function_zone_level"] = int2String(
                                                 uptable["functionZoneLevel"])
            if (bodyLength > 30) then
                streams["humidify_setting"] = int2String(
                                                  uptable["humiditySetting"])
                ...
                if (bodyLength > 31) then
                    ...
                    if (uptable["eradicatePesticideResidueCompletion"] == 0x80) then
                        streams["eradicate_pesticide_residue_completion"] =
                            "yes"
                    elseif (uptable["eradicatePesticideResidueCompletion"] ==
                        0x00) then
                    ...
                    if (bodyLength > 33) then
                        ...
                        if (uptable["storageIceMachineWaterStatus"] == 0x08) then
                            streams["storage_ice_machine_water_status"] =
                                "valid"
                        ...
                        streams["ice_room_real_temperature"] = int2String(
                                                                   math.floor(
                                                                       (uptable["iceRoomRealTemperature"] -
                                                                           100) /
                                                                           2))
                        if (bodyLength > 35) then
                            streams["storage_F_temperature"] = int2String(
                                                                   uptable["storageFTemperature"])
                            streams["freezing_F_temperature"] = int2String(11 -
                                                                               uptable["freezingFTemperature"])
                            streams["left_flexzone_F_temperature"] = int2String(
                                                                         uptable["leftFlexzoneFTemperature"] -
                                                                             1)
                            if (bodyLength > 38) then
                                ...
                                streams["electronic_clean_timeout"] =
                                    int2String(uptable["electronicCleanTimeout"])
                                if (bodyLength > 39) then
                                    streams["quick_beverage_time"] = int2String(
                                                                         uptable["quickBeverageTime"])
                                    ...
                                    if (bodyLength > 40) then
                                        ...
                                        if (bodyLength > 42) then
                                            ...
                                            if (uptable["quickBeverageCompleted"] ==
                                                0x40) then
                                                streams["quick_beverage_completed"] =
                                                    "yes"
                                            elseif (uptable["quickBeverageCompleted"] ==
                                                0x00) then
                                                streams["quick_beverage_completed"] =
                                                    "no"
                                            end
                                            if (uptable["quickBeverageContinuing"] ==
                                                0x80) then
                                                streams["quick_beverage_continuing"] =
                                                    "yes"
                                            elseif (uptable["quickBeverageContinuing"] ==
                                                0x00) then
                                                streams["quick_beverage_continuing"] =
                                                    "no"
                                            end
                                            if (uptable["voiceDoorAuto"] == 0x01) then
                                                streams["voice_door_auto"] =
                                                    "on"
                                            elseif (uptable["voiceDoorAuto"] ==
                                                0x00) then
                                                streams["voice_door_auto"] =
                                                    "off"
                                            end
                                            if (uptable["touchDoorAuto"] == 0x02) then
                                                streams["touch_door_auto"] =
                                                    "on"
                                            elseif (uptable["touchDoorAuto"] ==
                                                0x00) then
                                                streams["touch_door_auto"] =
                                                    "off"
                                            end
                                            ...
                                            elseif (uptable["helpDoorAuto"] ==
                                                0x00) then
                                                streams["help_door_auto"] =
                                                    "off"
                                            end
                                            if (uptable["speedDoorOpen"] == 0x08) then
                                                streams["speed_door_open"] =
                                                    "fast"
                                            elseif (uptable["speedDoorOpen"] ==
                                                0x00) then
                                                streams["speed_door_open"] =
                                                    "slow"
                                            end
                                            if (uptable["angleDoorOpen"] == 0x20) then
                                                streams["angle_door_open"] =
                                                    int2String("110")
                                            elseif (uptable["angleDoorOpen"] ==
                                                0x10) then
                                                streams["angle_door_open"] =
                                                    int2String("90")
                                            elseif (uptable["angleDoorOpen"] ==
                                            ...
                                            if (uptable["voiceAssistant"] ==
                                                0x40) then
                                                streams["voice_assistant"] =
                                                    "on"
                                            elseif (uptable["voiceAssistant"] ==
                                                0x00) then
                                                streams["voice_assistant"] =
                                                    "off"
                                            end
                                            if (uptable["noActionDoorClose"] ==
                                                0x80) then
                                                streams["no_action_door_close"] =
                                                    "on"
                                            elseif (uptable["noActionDoorClose"] ==
                                                0x00) then
                                                streams["no_action_door_close"] =
                                                    "off"
                                            end
    ...
    elseif ((uptable["dataType"] == 0x04 and bodyBytes[0] == 0x01) or
        (uptable["dataType"] == 0x03 and bodyBytes[0] == 0x01)) then
        if (uptable["codeMode"] == 0x01) then
            streams["storage_mode"] = "on"
        elseif (uptable["codeMode"] == 0x00) then
            streams["storage_mode"] = "off"
        ...
        streams["normal_zone_level"] = int2String(
                                           uptable["normalTemperatureLevel"])
        streams["function_zone_level"] =
            int2String(uptable["functionZoneLevel"])
        if (uptable["microcrystalFresh"] == 0x01) then
            streams["microcrystal_fresh"] = "on"
        elseif (uptable["microcrystalFresh"] == 0x00) then
            streams["microcrystal_fresh"] = "off"
        ...
        streams["electronic_clean_timeout"] = int2String(
                                                  uptable["electronicCleanTimeout"])
        streams["quick_beverage_time"] =
            int2String(uptable["quickBeverageTime"])
        if (uptable["quickBeverage"] == 0x80) then
            streams["quick_beverage"] = "on"
        elseif (uptable["quickBeverage"] == 0x00) then
            streams["quick_beverage"] = "off"
    ...
    elseif ((uptable["dataType"] == 0x06 and bodyBytes[0] == 0x01) or
        (uptable["dataType"] == 0x03 and bodyBytes[0] == 0x02)) then
        if (uptable["isError"] == 0x01) then
            streams["is_error"] = "yes"
        elseif (uptable["isError"] == 0x00) then
            streams["is_error"] = "no"
