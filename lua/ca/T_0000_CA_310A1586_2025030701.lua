...
uptable["defrostModeSelection"] = 0
uptable["defrostTimeEstimateState"] = 0
uptable["defrostFoodCategory"] = 0
uptable["defrostRunningState"] = 0
...
local function jsonToModel(jsonCmd)
    ...
    if streams["defrost_time_user_defined"] ~= nil then
        uptable["defrostTimeUserDefined"] = checkBoundary(streams["defrost_time_user_defined"], -1, 30)
    end
    if streams["defrost_mode_selection"] == "custom" then
        uptable["defrostModeSelection"] = 0x20
    elseif streams["defrost_mode_selection"] == "nutrient" then
        uptable["defrostModeSelection"] = 0x00
    end
    if streams["defrost_time_estimate_state"] == "running" then
        uptable["defrostTimeEstimateState"] = 0x40
    elseif streams["defrost_time_estimate_state"] == "end" then
        uptable["defrostTimeEstimateState"] = 0x00
    end
    if streams["defrost_food_category"] ~= nil then
        uptable["defrostFoodCategory"] = checkBoundary(streams["defrost_food_category"], -1, 64)
    end
    if streams["defrost_running_state"] ~= nil then
        uptable["defrostRunningState"] = checkBoundary(streams["defrost_running_state"], -1, 4)
    end
    if streams["defrost_remain_time"] ~= nil then
        uptable["defrostRemainTime"] = checkBoundary(streams["defrost_remain_time"], -1, 30)
    end
                                                                                            ...
                                                                                            if #messageBytes >= 86 then
                                                                                                ...
                                                                                                then
                                                                                                    ...
                                                                                                    then
                                                                                                        ...
                                                                                                        uptable["defrostModeSelection"] =
                                                                                                            bit.band(
                                                                                                                messageBytes[110],
                                                                                                                0x20
                                                                                                            )
                                                                                                        uptable["defrostTimeEstimateState"] =
                                                                                                            bit.band(
                                                                                                                messageBytes[110],
                                                                                                                0x40
                                                                                                            )
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        >= 111
                                                                                                    then
                                                                                                        uptable["defrostFoodCategory"] =
                                                                                                            bit.band(
                                                                                                                messageBytes[111],
                                                                                                                0x3F
                                                                                                            )
                                                                                                        uptable["defrostRunningState"] =
                                                                                                            bit.rshift(
                                                                                                                bit.band(
                                                                                                                    messageBytes[111],
                                                                                                                    0xC0
...
function jsonToData(jsonCmd)
    ...
    elseif control then
        ...
        then
            bodyBytes[27] = bit.bor(
                bit.bor(
                    bit.bor(
                        bit.bor(
                            bit.bor(bit.band(uptable["microcrystalFresh"], 0x01), bit.band(uptable["dryZone"], 0x02)),
        ...
        if num >= 71 then
            bodyBytes[71] = bit.bor(
                ...
                bit.bor(
                    bit.bor(
                        bit.bor(
                            bit.bor(bit.band(uptable["turnOffLight"], 0x01), bit.band(uptable["lightBrightness"], 0x02)),
        ...
        if num >= 74 then
            bodyBytes[74] = bit.bor(bit.band(uptable["sabbathExitTime"], 0x1F), bit.band(uptable["sabbathMode"], 0xC0))
        end
        if num >= 77 then bodyBytes[77] = uptable["handleReturnTime"] end
        if num >= 78 then bodyBytes[78] = bit.band(uptable["iceClean"], 0x08) end
        if num >= 80 then
            bodyBytes[80] =
                bit.bor(bit.band(uptable["telstarSavingMode"], 0x01), bit.band(uptable["panelDisplayGear"], 0x02))
        end
        ...
        if num >= 89 then
            bodyBytes[89] = bit.bor(
                bit.bor(bit.band(uptable["aiFruitBoxGear"], 0x07), bit.band(uptable["smartAiToSelfSelect"], 0x08)),
        ...
        if num >= 105 then bodyBytes[105] = uptable["tmfCoolFreezeMode"] end
        if num >= 110 then
            bodyBytes[110] = bit.bor(
                bit.bor(
                    bit.band(uptable["defrostTimeUserDefined"], 0x1F),
                    bit.band(uptable["defrostModeSelection"], 0x20)
                ),
                bit.band(uptable["defrostTimeEstimateState"], 0x40)
            )
        end
        if num >= 111 then
            bodyBytes[111] = bit.bor(
                bit.band(uptable["defrostFoodCategory"], 0x3F),
                bit.lshift(bit.band(uptable["defrostRunningState"], 0x03), 6)
            )
        end
        if num >= 112 then bodyBytes[112] = bit.band(uptable["defrostRemainTime"], 0x1F) end
                                                                ...
                                                                if bodyLength >= 72 then
                                                                    ...
                                                                    if bodyLength >= 73 then
                                                                        ...
                                                                        if bodyLength >= 74 then
                                                                            ...
                                                                            streams["sabbath_mode"] =
                                                                                int2String(uptable["sabbathMode"])
                                                                                            ...
                                                                                            if bodyLength >= 87 then
                                                                                                ...
                                                                                                then
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x20
                                                                                                    then
                                                                                                        streams["defrost_mode_selection"] =
                                                                                                            "custom"
                                                                                                    elseif
                                                                                                        uptable["defrostModeSelection"]
                                                                                                        == 0x00
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x40
                                                                                                    then
                                                                                                        streams["defrost_time_estimate_state"] =
                                                                                                            "running"
                                                                                                    elseif
                                                                                                        uptable["defrostTimeEstimateState"]
                                                                                                        == 0x00
                                                                                                    ...
                                                                                                    streams["defrost_food_category"] =
                                                                                                        int2String(
                                                                                                            uptable["defrostFoodCategory"]
                                                                                                        )
                                                                                                    streams["defrost_running_state"] =
                                                                                                        int2String(
                                                                                                            uptable["defrostRunningState"]
                                                                                                        )
