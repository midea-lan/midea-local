...
local function updateGlobalPropertyValueByJson(luaTable)
    ...
    if luaTable[KEY_TIME_YEAR] ~= nil then propertyTable["timeYear"] = string2Int(luaTable[KEY_TIME_YEAR]) end
    if luaTable[KEY_TIME_MONTH] ~= nil then propertyTable["timeMonth"] = string2Int(luaTable[KEY_TIME_MONTH]) end
    if luaTable[KEY_TIME_DAY] ~= nil then propertyTable["timeDay"] = string2Int(luaTable[KEY_TIME_DAY]) end
    if luaTable[KEY_TIME_HOUR] ~= nil then propertyTable["timeHour"] = string2Int(luaTable[KEY_TIME_HOUR]) end
    if luaTable[KEY_TIME_MIN] ~= nil then propertyTable["timeMin"] = string2Int(luaTable[KEY_TIME_MIN]) end
    ...
    propertyTable["powerSaving"] = onOffToInteger1byte(luaTable[KEY_POWER_SAVING])
    propertyTable["powerSavingOut"] = onOffToInteger1byte(luaTable[KEY_POWER_SAVING_OUT])
    propertyTable["powerLowTemp"] = onOffToInteger1byte(luaTable[KEY_POWER_LOW_TEMP])
    propertyTable["vegetableSterilization"] = onOffToInteger1byte(luaTable[KEY_VEGETABLE_STERILIZATION])
    propertyTable["powerSavingAuto"] = onOffToInteger1byte(luaTable[KEY_POWER_SAVING_AUTO])
    propertyTable["uvBlueLed"] = onOffToInteger1byte(luaTable[KEY_UV_BLUE_LED])
    propertyTable["powerSavingAutoPlus"] = onOffToInteger1byte(luaTable[KEY_POWER_SAVING_AUTO_PLUS])
    propertyTable["lowPowerCooling"] = onOffToInteger1byte(luaTable[KEY_LOW_POWER_COOLING])
    ...
    propertyTable["autoOpenDoor"] = onOffToInteger1byte(luaTable[KEY_AUTO_OPEN_DOOR])
    propertyTable["demoMode"] = onOffToInteger1byte(luaTable[KEY_DEMO_MODE])
    propertyTable["forceDefrost"] = onOffToInteger1byte(luaTable[KEY_FORCE_DEFROST])
    propertyTable["iceTrayCleaning"] = onOffToInteger1byte(luaTable[KEY_ICE_TRAY_CLEANING])
    propertyTable["settingInitialization"] = onOffToInteger1byte(luaTable[KEY_SETTING_INITIALIZATION])
...
local function messageByteToPropertyTableForFunctionTypeBase(thePropertyTable, theMessageBytes)
    ...
    thePropertyTable["powerSavingOut"] = bit.rshift(bit.band(theMessageBytes[1], 0x02), 1)
    thePropertyTable["powerLowTemp"] = bit.rshift(bit.band(theMessageBytes[1], 0x04), 2)
    thePropertyTable["vegetableSterilization"] = bit.rshift(bit.band(theMessageBytes[1], 0x08), 3)
    thePropertyTable["powerSavingAuto"] = bit.rshift(bit.band(theMessageBytes[1], 0x10), 4)
    thePropertyTable["uvBlueLed"] = bit.rshift(bit.band(theMessageBytes[1], 0x20), 5)
    thePropertyTable["powerSavingAutoPlus"] = bit.rshift(bit.band(theMessageBytes[1], 0x40), 6)
    thePropertyTable["lowPowerCooling"] = bit.rshift(bit.band(theMessageBytes[1], 0x80), 7)
    ...
    thePropertyTable["iceMakingStatus"] = bit.rshift(bit.band(theMessageBytes[5], 0xf0), 4)
    thePropertyTable["lock"] = bit.band(theMessageBytes[6], 0x01)
    thePropertyTable["eco"] = bit.rshift(bit.band(theMessageBytes[6], 0x02), 1)
    thePropertyTable["autoOpenDoor"] = bit.rshift(bit.band(theMessageBytes[6], 0x04), 2)
    thePropertyTable["demoMode"] = bit.rshift(bit.band(theMessageBytes[6], 0x08), 3)
    thePropertyTable["forceDefrost"] = bit.rshift(bit.band(theMessageBytes[6], 0x10), 4)
    thePropertyTable["iceTrayCleaning"] = bit.rshift(bit.band(theMessageBytes[6], 0x20), 5)
    thePropertyTable["settingInitialization"] = bit.rshift(bit.band(theMessageBytes[6], 0x40), 6)
    thePropertyTable["defrostStatus"] = theMessageBytes[7]
    thePropertyTable["chillingDoorStatus"] = bit.band(theMessageBytes[8], 0x01)
    thePropertyTable["freezingDoorStatus"] = bit.rshift(bit.band(theMessageBytes[8], 0x02), 1)
    thePropertyTable["iceDoorStatus"] = bit.rshift(bit.band(theMessageBytes[8], 0x04), 2)
    thePropertyTable["vegetableDoorStatus"] = bit.rshift(bit.band(theMessageBytes[8], 0x08), 3)
    thePropertyTable["instantaneousPower"] = bit.lshift(theMessageBytes[10], 8) + theMessageBytes[9]
    thePropertyTable["dailyEnergy"] = bit.lshift(theMessageBytes[12], 8) + theMessageBytes[11]
    if (theMessageBytes[13] ~= nil) and (theMessageBytes[14] ~= nil) then
        if (theMessageBytes[13] ~= 0xFF) or (theMessageBytes[14] ~= 0xFF) then
            thePropertyTable["errorCode"] = bit.lshift(theMessageBytes[14], 8) + theMessageBytes[13]
        end
    end
    if (theMessageBytes[15] ~= nil) and (theMessageBytes[16] ~= nil) then
        thePropertyTable["outRoomTemp"] = bit.lshift(theMessageBytes[16], 8) + theMessageBytes[15]
    else
...
local function messageByteToPropertyTableForFunctionTypeRunningInfo(thePropertyTable, theMessageBytes)
    thePropertyTable["functionType"] = 0x03
    thePropertyTable["rt_sensor"] = bit.lshift(theMessageBytes[2], 8) + theMessageBytes[1]
    thePropertyTable["r_sensor"] = bit.lshift(theMessageBytes[4], 8) + theMessageBytes[3]
    thePropertyTable["rd_sensor"] = bit.lshift(theMessageBytes[6], 8) + theMessageBytes[5]
    thePropertyTable["rd2_sensor"] = bit.lshift(theMessageBytes[8], 8) + theMessageBytes[7]
    thePropertyTable["f_sensor"] = bit.lshift(theMessageBytes[10], 8) + theMessageBytes[9]
    thePropertyTable["fd_sensor"] = bit.lshift(theMessageBytes[12], 8) + theMessageBytes[11]
    thePropertyTable["i_sensor"] = bit.lshift(theMessageBytes[14], 8) + theMessageBytes[13]
    thePropertyTable["rh_sensor"] = bit.lshift(theMessageBytes[16], 8) + theMessageBytes[15]
    ...
    if theMessageBytes[23] ~= nil and theMessageBytes[24] ~= nil then
        thePropertyTable["cSensor"] = bit.lshift(theMessageBytes[24], 8) + theMessageBytes[23]
    end
end
local function messageByteToPropertyTableForFunctionTypeCustomSetting(thePropertyTable, theMessageBytes)
    thePropertyTable["functionType"] = 0x07
    thePropertyTable["nightMode"] = bit.band(theMessageBytes[1], 0x03)
    thePropertyTable["autoDoorLeft"] = bit.rshift(bit.band(theMessageBytes[1], 0x04), 2)
    thePropertyTable["autoDoorRight"] = bit.rshift(bit.band(theMessageBytes[1], 0x08), 3)
...
local function messageByteToPropertyTableForFunctionTypeWeeklyReminder(thePropertyTable, theMessageBytes)
...
local function updateGlobalPropertyValueByByte(messageBytes)
    ...
    if dataType == 0x02 then
        if messageBytes[0] == 0x00 then
            ...
            propertyTable["powerSavingOut"] = bit.rshift(bit.band(messageBytes[1], 0x02), 1)
            propertyTable["powerLowTemp"] = bit.rshift(bit.band(messageBytes[1], 0x04), 2)
            propertyTable["vegetableSterilization"] = bit.rshift(bit.band(messageBytes[1], 0x08), 3)
            propertyTable["powerSavingAuto"] = bit.rshift(bit.band(messageBytes[1], 0x10), 4)
            propertyTable["uvBlueLed"] = bit.rshift(bit.band(messageBytes[1], 0x20), 5)
            propertyTable["powerSavingAutoPlus"] = bit.rshift(bit.band(messageBytes[1], 0x40), 6)
            propertyTable["lowPowerCooling"] = bit.rshift(bit.band(messageBytes[1], 0x80), 7)
            ...
            propertyTable["iceMakingStatus"] = bit.rshift(bit.band(messageBytes[5], 0xf0), 4)
            propertyTable["lock"] = bit.band(messageBytes[6], 0x01)
            propertyTable["eco"] = bit.rshift(bit.band(messageBytes[6], 0x02), 1)
            propertyTable["autoOpenDoor"] = bit.rshift(bit.band(messageBytes[6], 0x04), 2)
            propertyTable["demoMode"] = bit.rshift(bit.band(messageBytes[6], 0x08), 3)
            propertyTable["forceDefrost"] = bit.rshift(bit.band(messageBytes[6], 0x10), 4)
            propertyTable["iceTrayCleaning"] = bit.rshift(bit.band(messageBytes[6], 0x20), 5)
            propertyTable["settingInitialization"] = bit.rshift(bit.band(messageBytes[6], 0x40), 6)
            if messageBytes[13] ~= nil and messageBytes[14] ~= nil then
                if messageBytes[13] ~= 0xFF or messageBytes[14] ~= 0xFF then
                    propertyTable["errorCode"] = bit.lshift(messageBytes[14], 8) + messageBytes[13]
                end
            end
            if messageBytes[15] ~= nil and messageBytes[16] ~= nil then
                propertyTable["outRoomTemp"] = bit.lshift(messageBytes[16], 8) + messageBytes[15]
            else
        ...
        elseif messageBytes[0] == 0x01 then
            ...
            propertyTable["timeYear"] = bit.lshift(messageBytes[6], 8) + messageBytes[5]
    ...
    elseif dataType == 0x03 then
        ...
        elseif messageBytes[0] == 0x03 then
            messageByteToPropertyTableForFunctionTypeRunningInfo(propertyTable, messageBytes)
        elseif messageBytes[0] == 0x07 then
            messageByteToPropertyTableForFunctionTypeCustomSetting(propertyTable, messageBytes)
        elseif messageBytes[0] == 0x08 then
            messageByteToPropertyTableForFunctionTypeWeeklyReminder(propertyTable, messageBytes)
...
local function propertyTableToStreamTableForFunctionTypeCustomSetting(theStreamTable, thePropertyTable)
    theStreamTable[KEY_FUNCTION_TYPE] = "custom_setting"
    theStreamTable[KEY_NIGHT_MODE] = integerToOnOff(thePropertyTable["nightMode"])
    theStreamTable[KEY_AUTO_DOOR_LEFT] = integerToOnOff(thePropertyTable["autoDoorLeft"])
    theStreamTable[KEY_AUTO_DOOR_RIGHT] = integerToOnOff(thePropertyTable["autoDoorRight"])
    theStreamTable[KEY_CEILING_LIGHT_NORMAL] = int2String(thePropertyTable["ceilingLightNormal"])
    theStreamTable[KEY_DOOR_LIGHT_NORMAL] = int2String(thePropertyTable["doorLightNormal"])
    theStreamTable[KEY_CEILING_LIGHT_NIGHT] = int2String(thePropertyTable["ceilingLightNight"])
    theStreamTable[KEY_DOOR_LIGHT_NIGHT] = int2String(thePropertyTable["doorLightNight"])
    theStreamTable[KEY_NIGHT_START_MIN] = int2String(thePropertyTable["nightStartMin"])
    theStreamTable[KEY_NIGHT_START_HOUR] = int2String(thePropertyTable["nightStartHour"])
    theStreamTable[KEY_NIGHT_END_MIN] = int2String(thePropertyTable["nightEndMin"])
    theStreamTable[KEY_NIGHT_END_HOUR] = int2String(thePropertyTable["nightEndHour"])
    theStreamTable[KEY_DOOR_LEFT_FOR_OPEN] = int2String(thePropertyTable["doorLeftForOpen"])
    theStreamTable[KEY_DOOR_LEFT_FOR_PRESSURE_HIGH] = int2String(thePropertyTable["doorLeftForPressureHigh"])
    theStreamTable[KEY_DOOR_LEFT_FOR_PRESSURE_LOW] = int2String(thePropertyTable["doorLeftForPressureLow"])
    theStreamTable[KEY_DOOR_RIGHT_FOR_OPEN] = int2String(thePropertyTable["doorRightForOpen"])
    theStreamTable[KEY_DOOR_RIGHT_FOR_PRESSURE_HIGH] = int2String(thePropertyTable["doorRightForPressureHigh"])
    theStreamTable[KEY_DOOR_RIGHT_FOR_PRESSURE_LOW] = int2String(thePropertyTable["doorRightForPressureLow"])
end
local function propertyTableToStreamTableForFunctionTypeWeeklyReminder(theStreamTable, thePropertyTable)
    theStreamTable[KEY_FUNCTION_TYPE] = "weekly_reminder"
    theStreamTable[KEY_WEEKLY_REMINDER] = integerToOnOff(thePropertyTable["weeklyReminder"])
    theStreamTable[KEY_WEEKLY_REMINDER_MIN] = int2String(thePropertyTable["weeklyReminderMin"])
    theStreamTable[KEY_WEEKLY_REMINDER_HOUR] = int2String(thePropertyTable["weeklyReminderHour"])
    ...
    theStreamTable[KEY_WEDNESDAY_1] = int2String(thePropertyTable["wednesday_1"])
    ...
    theStreamTable[KEY_WEDNESDAY_2] = int2String(thePropertyTable["wednesday_2"])
...
local function assembleJsonByGlobalProperty()
    ...
    if propertyTable["functionType"] == 0x00 then
        ...
        streams[KEY_AUTO_OPEN_DOOR] = integerToOnOff(propertyTable["autoOpenDoor"])
        streams[KEY_DEMO_MODE] = integerToOnOff(propertyTable["demoMode"])
        streams[KEY_FORCE_DEFROST] = integerToOnOff(propertyTable["forceDefrost"])
        streams[KEY_ICE_TRAY_CLEANING] = integerToOnOff(propertyTable["iceTrayCleaning"])
        streams[KEY_SETTING_INITIALIZATION] = integerToOnOff(propertyTable["settingInitialization"])
    ...
    elseif propertyTable["functionType"] == 0x02 then
        ...
        streams[KEY_CAMERA_SHOOTING] = int2String(propertyTable["cameraShooting"])
    elseif propertyTable["functionType"] == 0x03 then
        ...
        streams["three_way_valve_pulse"] = propertyTable["three_way_valve_pulse"]
        if propertyTable["cSensor"] ~= nil then streams["c_sensor"] = buma(propertyTable["cSensor"]) / 10 end
    ...
    elseif propertyTable["functionType"] == 0x07 then
        propertyTableToStreamTableForFunctionTypeCustomSetting(streams, propertyTable)
    elseif propertyTable["functionType"] == 0x08 then
        propertyTableToStreamTableForFunctionTypeWeeklyReminder(streams, propertyTable)
    ...
    if control then
        ...
        if propertyTable["functionType"] == 0x00 then
            ...
            if
                ...
                and propertyTable["powerSaving"] == 0xFF
                and propertyTable["powerLowTemp"] == 0xFF
                and propertyTable["vegetableSterilization"] == 0xFF
                and propertyTable["powerSavingAuto"] == 0xFF
                and propertyTable["uvBlueLed"] == 0xFF
                and propertyTable["powerSavingAutoPlus"] == 0xFF
                and propertyTable["lowPowerCooling"] == 0xFF
            then
                data1 = 0xFF
            else
                if propertyTable["lowPowerCooling"] ~= 0xFF then
                    data1 = bit.bor(data1, bit.lshift(propertyTable["lowPowerCooling"], 7))
                end
                if propertyTable["powerSavingAutoPlus"] ~= 0xFF then
                    data1 = bit.bor(data1, bit.lshift(propertyTable["powerSavingAutoPlus"], 6))
                end
                if propertyTable["uvBlueLed"] ~= 0xFF then
                    data1 = bit.bor(data1, bit.lshift(propertyTable["uvBlueLed"], 5))
                end
                if propertyTable["powerSavingAuto"] ~= 0xFF then
                    data1 = bit.bor(data1, bit.lshift(propertyTable["powerSavingAuto"], 4))
                end
                if propertyTable["vegetableSterilization"] ~= 0xFF then
                    data1 = bit.bor(data1, bit.lshift(propertyTable["vegetableSterilization"], 3))
                end
                if propertyTable["powerLowTemp"] ~= 0xFF then
                    data1 = bit.bor(data1, bit.lshift(propertyTable["powerLowTemp"], 2))
                end
                if propertyTable["powerSavingOut"] ~= 0xFF then
                    data1 = bit.bor(data1, bit.lshift(propertyTable["powerSavingOut"], 1))
                end
                if propertyTable["powerSaving"] ~= 0xFF then data1 = bit.bor(data1, propertyTable["powerSaving"]) end
            end
            bodyBytes[1] = data1
            ...
            if
                ...
                and (propertyTable["eco"] == 0xFF)
                and (propertyTable["autoOpenDoor"] == 0xFF)
                and (propertyTable["demoMode"] == 0xFF)
                and (propertyTable["forceDefrost"] == 0xFF)
                and (propertyTable["iceTrayCleaning"] == 0xFF)
                and (propertyTable["settingInitialization"] == 0xFF)
            then
                data6 = 0xFF
            else
                if propertyTable["lock"] ~= 0xFF then data6 = bit.bor(bit.lshift(propertyTable["lock"], 0), data6) end
                if propertyTable["eco"] ~= 0xFF then data6 = bit.bor(bit.lshift(propertyTable["eco"], 1), data6) end
                if propertyTable["autoOpenDoor"] ~= 0xFF then
                    data6 = bit.bor(bit.lshift(propertyTable["autoOpenDoor"], 2), data6)
                end
                if propertyTable["demoMode"] ~= 0xFF then
                    data6 = bit.bor(bit.lshift(propertyTable["demoMode"], 3), data6)
                end
                if propertyTable["forceDefrost"] ~= 0xFF then
                    data6 = bit.bor(bit.lshift(propertyTable["forceDefrost"], 4), data6)
                end
                if propertyTable["iceTrayCleaning"] ~= 0xFF then
                    data6 = bit.bor(bit.lshift(propertyTable["iceTrayCleaning"], 5), data6)
                end
                if propertyTable["settingInitialization"] ~= 0xFF then
                    data6 = bit.bor(bit.lshift(propertyTable["settingInitialization"], 6), data6)
                end
            end
            bodyBytes[6] = data6
            if propertyTable["timer"] ~= nil then bodyBytes[17] = propertyTable["timer"] end
        elseif propertyTable["functionType"] == 0x01 then
            bodyBytes[0] = 0x01
            ...
            bodyBytes[6] = bit.band(bit.rshift(propertyTable["timeYear"], 8), 0xff)
        elseif propertyTable["functionType"] == 0x02 then
            bodyBytes[0] = 0x02
        ...
        elseif propertyTable["functionType"] == 0x07 then
            ...
            then
                ...
                if propertyTable["nightMode"] ~= 0xFF then
                    data1 = bit.bor(data1, bit.lshift(propertyTable["nightMode"], 0))
                end
                if propertyTable["autoDoorLeft"] ~= 0xFF then
                    data1 = bit.bor(data1, bit.lshift(propertyTable["autoDoorLeft"], 2))
                end
                if propertyTable["autoDoorRight"] ~= 0xFF then
                    data1 = bit.bor(data1, bit.lshift(propertyTable["autoDoorRight"], 3))
                end
            end
            bodyBytes[0] = 0x07
            bodyBytes[1] = data1
