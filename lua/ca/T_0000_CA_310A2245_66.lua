...
local function jsonToModel(jsonCmd)
    ...
    if streams["defrost_time_user_defined"] ~= nil then
        uptable["defrostTimeUserDefined"] = checkBoundary(streams["defrost_time_user_defined"], -1, 240)
    end
...
function jsonToData(jsonCmd)
    ...
    if query then
        if query["query_type"] == "temperature" then uptable["isTemperatureQuery"] = true end
        bodyBytes[0] = 0x00
...
function dataToJson(jsonCmd)
    ...
    elseif
        (uptable["dataType"] == 0x04 and bodyBytes[0] == 0x01) or (uptable["dataType"] == 0x03 and bodyBytes[0] == 0x01)
    then
        if uptable["codeMode"] == 0x01 then
            streams["storage_mode"] = "on"
        elseif uptable["codeMode"] == 0x00 then
    ...
    elseif
        (uptable["dataType"] == 0x06 and bodyBytes[0] == 0x01) or (uptable["dataType"] == 0x03 and bodyBytes[0] == 0x02)
    then
        if uptable["isError"] == 0x01 then
            streams["is_error"] = "yes"
        elseif uptable["isError"] == 0x00 then
