...
local function jsonToModel(jsonCmd)
    ...
    if (streams["storage_temperature"] ~= nil) then uptable["refrigerationTemperature"] = checkBoundary(
    ...
    if (streams["right_flexzone_temperature"] ~= nil) then
        ...
        if ((uptable["rVariableTemperature"] >= -18) and (uptable["rVariableTemperature"] <= 10)) then uptable["rVariableTemperature"] =
    ...
    if (streams["electronic_smell"] == "on") then uptable["electronicSmell"] = 0x04 elseif (streams["electronic_smell"] == "off") then uptable["electronicSmell"] = 0x04 end
    ...
    if (streams["bcd_location_number"] ~= nil) then uptable["bcdLocationNumber"] = checkBoundary(
        streams["bcd_location_number"], -5, 100) end
    if (streams["marquee_flashes"] == "on") then uptable["marqueeFlashes"] = 0x80 elseif (streams["marquee_flashes"] == "off") then uptable["marqueeFlashes"] = 0x00 end
    ...
    if (streams["freezing_light_open"] ~= nuil) then uptable["freezingLightOpen"] = checkBoundary(
    ...
    if (streams["ai_fruit_box_gear"] ~= nil) then uptable["aiFruitBoxGear"] = checkBoundary(streams["ai_fruit_box_gear"],
            -1, 100) end
    if (streams["ai_fruit_flag"] == "on") then uptable["aiFruitFlag"] = 0x80 elseif (streams["ai_fruit_flag"] == "off") then uptable["aiFruitFlag"] = 0x00 end
    ...
    if (streams["ai_purine_box_gear"] ~= nil) then uptable["aiPurineBoxGear"] = checkBoundary(
        streams["ai_purine_box_gear"], -1, 100) end
    ...
    if (streams["smart_selection_execute_result"] == "yes") then uptable["smartSelectionExecuteResult"] = 0x02 elseif (streams["smart_selection_execute_result"] == "no") then uptable["smartSelectionExecuteResult"] = 0x00 end
    if (streams["smart_selection_gear_change"] == "yes") then uptable["smartSelectionGearChange"] = 0x04 elseif (streams["smart_selection_gear_change"] == "no") then uptable["smartSelectionGearChange"] = 0x00 end
    if (streams["smart_selection_handle_store"] == "handle") then uptable["smartSelectionHandleStore"] = 0x08 elseif (streams["smart_selection_handle_store"] == "store") then uptable["smartSelectionHandleStore"] = 0x00 end
    if (streams["smart_selection_handle_time"] ~= nil) then uptable["smartSelectionHandleTime"] = tonumber(streams
        ["smart_selection_handle_time"]) end
    if (streams["smart_selection_preset_temp"] ~= nil) then
        ...
        if ((uptable["smartSelectionPresetTemp"] >= -18) and (uptable["smartSelectionPresetTemp"] <= 10)) then uptable["smartSelectionPresetTemp"] =
            uptable["smartSelectionPresetTemp"] + 19 elseif ((uptable["smartSelectionPresetTemp"] >= -24) and (uptable["smartSelectionPresetTemp"] <= -19)) then uptable["smartSelectionPresetTemp"] = 30 -
            uptable["smartSelectionPresetTemp"] else uptable["smartSelectionPresetTemp"] = 99 end
    end
end
                                                        ...
                                                        if (#messageBytes >= 59) then
                                                            ...
                                                            if (#messageBytes >= 67) then
                                                                ...
                                                                if (#messageBytes >= 72) then
                                                                    uptable["bcdLocationNumber"] = bit.band(
                                                                    messageBytes[72], 0x7F)
                                                                    uptable["marqueeFlashes"] = bit.band(
                                                                    messageBytes[72], 0x80)
                                                                    if (#messageBytes >= 73) then
                                                                        ...
                                                                        if (#messageBytes >= 75) then
                                                                            uptable["controlSugarTimeLow"] = messageBytes
                                                                            [75]
                                                                            ...
                                                                            if (#messageBytes >= 77) then
                                                                                ...
                                                                                messageBytes[77]
                                                                                if (#messageBytes >= 78) then uptable["iceClean"] =
                                                                                    bit.band(messageBytes[78], 0x08) end
                                                                                if (#messageBytes >= 80) then
                                                                                    uptable["telstarSavingMode"] = bit
                                                                                    .band(messageBytes[80], 0x01)
                                                                                    ...
                                                                                    if (#messageBytes >= 85) then
                                                                                        ...
                                                                                        bit.band(messageBytes[85], 0x0F)
                                                                                        uptable["storageRightDoorAutoOpenAngle"] =
                                                                                        bit.rshift(
                                                                                        bit.band(messageBytes[85], 0xF0),
                                                                                            4)
                                                                                        if (#messageBytes >= 86) then
                                                                                            ...
                                                                                            if (#messageBytes >= 87) then
                                                                                                ...
                                                                                                if (#messageBytes >= 103) then
                                                                                                    ...
                                                                                                    messageBytes[103],
                                                                                                        0x08)
                                                                                                    if (uptable["smartSelectionPresetTemp"] == 0x0 or messageBytes[104] == 0) then uptable["smartSelectionPresetTemp"] = 99 else uptable["smartSelectionPresetTemp"] =
                                                                                                        messageBytes[104] end
                                                                                                end
                                                                                                if (#messageBytes >= 105) then uptable["tmfCoolFreezeMode"] =
                                                                                                    messageBytes[105] end
                                                                                                if (#messageBytes >= 106) then uptable["smartSelectionHandleTime"] =
                                                                                                    messageBytes[106] end
                                                                                            end
                                                                                        end
                                                                                    end
                                                                                end
...
function jsonToData(jsonCmd)
    ...
    elseif (control) then
        ...
        for i = 0, 108 do bodyBytes[i] = 0 end
        bodyBytes[0] = 0x00
        bodyBytes[1] = bit.bor(
        bit.bor(
        bit.bor(
        ...
        if (uptable["microcrystalFresh"] ~= nil and uptable["dryZone"] ~= nil and uptable["performanceMode"] ~= nil and uptable["electronicSmell"] ~= nil and uptable["eradicatePesticideResidue"] ~= nil) then bodyBytes[27] =
            bit.bor(
            bit.bor(
            bit.bor(
            bit.bor(bit.bor(bit.band(uptable["microcrystalFresh"], 0x01), bit.band(uptable["dryZone"], 0x02)),
                bit.bor(uptable["electronicSmell"], 0x04)), bit.band(uptable["eradicatePesticideResidue"], 0x08)),
                bit.band(uptable["humidity"], 0x70)), bit.band(uptable["performanceMode"], 0x80)) end
        ...
        if (uptable["humiditySetting"] ~= nil and uptable["smartHumidity"] ~= nil) then bodyBytes[30] = bit.bor(
            bit.band(uptable["humiditySetting"], 0x7F), bit.band(uptable["smartHumidity"], 0x80)) end
        if (uptable["storageLeftDoorAuto"] ~= nil and uptable["storageRightDoorAuto"] ~= nil and uptable["freezerDoorAuto"] ~= nil and uptable["freezerDoorAutoControl"] ~= nil and uptable["storageDoorAutoControl"] ~= nil) then bodyBytes[31] =
            bit.bor(
            bit.bor(
            bit.bor(
            bit.bor(bit.band(uptable["storageLeftDoorAuto"], 0x03), bit.band(uptable["storageRightDoorAuto"], 0x0C)),
                ...
                bit.band(uptable["storageDoorAutoControl"], 0x80)) end
        if (uptable["storageIceMachinePower"] ~= nil and uptable["filterReplacementWarningElimination"] ~= nil) then bodyBytes[33] =
            bit.bor(bit.band(uptable["storageIceMachinePower"], 0x01),
                bit.band(uptable["filterReplacementWarningElimination"], 0x80)) end
        ...
        if (uptable["electronicCleanStrong"] ~= nil) then bodyBytes[38] = bit.band(uptable["electronicCleanStrong"], 0x01) end
        if (uptable["quickBeverageTime"] ~= nil and uptable["quickBeverage"] ~= nil) then bodyBytes[39] = bit.bor(
            bit.band(uptable["quickBeverageTime"], 0x7F), bit.band(uptable["quickBeverage"], 0x80)) end
        if (uptable["aquaticProduct"] ~= nil and uptable["silentNightMode"] ~= nil and uptable["deepColdMode"] ~= nil) then bodyBytes[40] =
            bit.bor(bit.bor(bit.band(uptable["aquaticProduct"], 0x01), bit.band(uptable["silentNightMode"], 0x04)),
                bit.band(uptable["deepColdMode"], 0x08)) end
        bodyBytes[42] = bit.bor(bit.band(uptable["storageLightLevel"], 0x1F), bit.band(uptable["nightMode"], 0x20))
        if (uptable["voiceDoorAuto"] ~= nil and uptable["touchDoorAuto"] ~= nil and uptable["helpDoorAuto"] ~= nil and uptable["speedDoorOpen"] ~= nil and uptable["angleDoorOpen"] ~= nil and uptable["voiceAssistant"] ~= nil and uptable["noActionDoorClose"] ~= nil) then bodyBytes[43] =
            bit.bor(
            bit.bor(
            bit.bor(
            bit.bor(
            bit.bor(bit.bor(bit.band(uptable["voiceDoorAuto"], 0x01), bit.band(uptable["touchDoorAuto"], 0x02)),
                ...
                bit.band(uptable["noActionDoorClose"], 0x80)) end
        bodyBytes[44] = bit.bor(
        bit.bor(bit.bor(bit.band(uptable["foodExpireLight"], 0x08), bit.band(uptable["levelMsgLight"], 0x10)),
            bit.band(uptable["quickIceMode"], 0x20)), bit.band(uptable["noActionDoorCloseTime"], 0xC0))
        ...
        bodyBytes[71] = bit.bor(bit.lshift(uptable["freezingLightOpen"], 6),
            bit.bor(
            bit.bor(
            bit.bor(bit.bor(bit.band(uptable["turnOffLight"], 0x01), bit.band(uptable["lightBrightness"], 0x02)),
                bit.band(uptable["sunnyForSevenDays"], 0x04)), bit.band(uptable["quickFreezing"], 0x10)),
        ...
        bit.bor(bit.band(uptable["teslaHandleSwitchMode"], 0x01), bit.band(uptable["fivePreservationMode"], 0x02)),
            ...
            bit.band(uptable["pulseSwitch"], 0x40)), bit.band(uptable["deliveryMode"], 0x80))
        bodyBytes[77] = uptable["handleReturnTime"]
        bodyBytes[78] = bit.band(uptable["iceClean"], 0x08)
        bodyBytes[80] = bit.bor(bit.band(uptable["telstarSavingMode"], 0x01), bit.band(uptable["panelDisplayGear"], 0x02))
        ...
        bodyBytes[85] = bit.bor(bit.lshift(bit.band(uptable["storageRightDoorAutoOpenAngle"], 0x0F), 4),
        ...
        bit.bor(bit.band(uptable["aiFruitDisplayControl"], 0x0F),
            bit.lshift(bit.band(uptable["aiFruitBoxGear"], 0x07), 4)), bit.band(uptable["aiFruitFlag"], 0x80))
        bodyBytes[89] = bit.bor(
        bit.bor(bit.band(uptable["aiPurineDisplayControl"], 0x0F),
            bit.lshift(bit.band(uptable["aiPurineBoxGear"], 0x07), 4)), bit.band(uptable["aiPurineFlag"], 0x80))
        ...
        bit.bor(bit.bor(bit.band(uptable["storageDoorAutoOpen"], 0x01), bit.band(uptable["tapTap"], 0x02)),
            ...
            bit.band(uptable["offlineVoiceSwitch"], 0x10)), bit.band(uptable["cameraSwitch"], 0x80))
        bodyBytes[91] = bit.bor(bit.band(uptable["ledPwmDuty"], 0x7F), bit.band(uptable["sleepMode"], 0x80))
        bodyBytes[92] = bit.bor(
        bit.bor(bit.bor(bit.band(uptable["sleepModeStartHour"], 0x1F), bit.band(uptable["roomLedDimmingFlag"], 0x20)),
        ...
        bit.bor(bit.bor(bit.band(uptable["iceWaterMode"], 0x01), bit.band(uptable["smartRecommend"], 0x02)),
            bit.band(uptable["iceWaterMixType"], 0x08)), bit.lshift(bit.band(uptable["iceWaterMixProportion"], 0x03), 4))
        ...
        bodyBytes[102] = bit.bor(bit.band(uptable["gpsReportSwitch"], 0x01),
            bit.band(uptable["freezerLightOneMinuteFlag"], 0x02))
        bodyBytes[103] = bit.bor(
        bit.bor(bit.band(uptable["appSmartSelectionMode"], 0x01), bit.band(uptable["smartSelectionExecuteResult"], 0x02)),
            bit.bor(bit.band(uptable["smartSelectionGearChange"], 0x04),
                bit.band(uptable["smartSelectionHandleStore"], 0x08)))
        if uptable["smartSelectionPresetTemp"] == 99 then bodyBytes[104] = 0 else bodyBytes[104] = uptable
            ["smartSelectionPresetTemp"] end
...
function dataToJson(jsonCmd)
    ...
    uptable["dataType"] = info[10]; for i = 1, #info do msgBytes[i - 1] = info[i] end
    ...
    elseif ((uptable["dataType"] == 0x02 and bodyBytes[0] == 0x00) or (uptable["dataType"] == 0x03 and bodyBytes[0] == 0x00) or (uptable["dataType"] == 0x04 and bodyBytes[0] == 0x02)) then
        ...
        if ((uptable["rVariableTemperature"]) and (uptable["rVariableTemperature"] <= 29)) then streams["right_flexzone_temperature"] =
        ...
        streams["fast_freeze_minute"] = int2String(256 * uptable["fastFreezeMinuteLow"] + uptable
        ["fastFreezeMinuteHigh"])
                                                        ...
                                                        if (bodyLength >= 59) then
                                                            ...
                                                            if (bodyLength >= 67) then
                                                                ...
                                                                if (bodyLength >= 72) then
                                                                    streams["bcd_location_number"] = int2String(uptable
                                                                    ["bcdLocationNumber"])
                                                                    if (uptable["marqueeFlashes"] == 0x80) then streams["marquee_flashes"] =
                                                                        "on" elseif (uptable["marqueeFlashes"] == 0x00) then streams["marquee_flashes"] =
                                                                        "off" end
                                                                    if (bodyLength >= 73) then
                                                                        ...
                                                                        if (bodyLength >= 75) then
                                                                            ...
                                                                            int2String(uptable["controlSugarTimeLow"])
                                                                            streams["control_sugar_time_high"] =
                                                                            int2String(uptable["controlSugarTimeHigh"])
                                                                            if (bodyLength >= 77) then
                                                                                streams["handle_return_time"] =
                                                                                int2String(uptable["handleReturnTime"])
                                                                                if (bodyLength >= 78) then if (uptable["iceClean"] == 0x08) then streams["ice_clean"] =
                                                                                    ...
                                                                                    if (bodyLength >= 86) then
                                                                                        ...
                                                                                        if (bodyLength >= 87) then
                                                                                            ...
                                                                                            if (bodyLength >= 88) then
                                                                                                ...
                                                                                                int2String(uptable
                                                                                                ["aiFruitBoxGear"])
                                                                                                if (uptable["aiFruitFlag"] == 0x80) then streams["ai_fruit_flag"] =
                                                                                            ...
                                                                                            if (bodyLength >= 103) then
                                                                                                if (uptable["appSmartSelectionMode"] == 0x01) then streams["app_smart_selection_mode"] =
                                                                                                    ...
                                                                                                    "off" end
                                                                                                if (uptable["smartSelectionExecuteResult"] == 0x02) then streams["smart_selection_execute_result"] =
                                                                                                    "yes" elseif (uptable["smartSelectionExecuteResult"] == 0x00) then streams["smart_selection_execute_result"] =
                                                                                                    "no" end
                                                                                                if (uptable["smartSelectionGearChange"] == 0x04) then streams["smart_selection_gear_change"] =
                                                                                                    "yes" elseif (uptable["smartSelectionGearChange"] == 0x00) then streams["smart_selection_gear_change"] =
                                                                                                    "no" end
                                                                                                if (uptable["smartSelectionHandleStore"] == 0x08) then streams["smart_selection_handle_store"] =
                                                                                                    "handle" elseif (uptable["smartSelectionHandleStore"] == 0x00) then streams["smart_selection_handle_store"] =
                                                                                                    "store" end
                                                                                                if ((uptable["smartSelectionPresetTemp"] >= 1) and (uptable["smartSelectionPresetTemp"] <= 29)) then streams["smart_selection_preset_temp"] =
                                                                                                    int2String(uptable
                                                                                                    ["smartSelectionPresetTemp"] -
                                                                                                    19) elseif ((uptable["smartSelectionPresetTemp"] >= 49) and (uptable["smartSelectionPresetTemp"] <= 54)) then streams["smart_selection_preset_temp"] =
                                                                                                    int2String(30 -
                                                                                                    uptable["smartSelectionPresetTemp"]) else streams["smart_selection_preset_temp"] =
                                                                                                    "99" end
                                                                                            end
                                                                                            if (bodyLength >= 105) then streams["tmf_cool_freeze_mode"] =
                                                                                                int2String(uptable
                                                                                                ["tmfCoolFreezeMode"]) end
                                                                                            if (bodyLength >= 106) then streams["smart_selection_handle_time"] =
                                                                                                int2String(uptable
                                                                                                ["smartSelectionHandleTime"]) end
                                                                                        end
                                                                                    end
                                                                                end
                                                                            end
