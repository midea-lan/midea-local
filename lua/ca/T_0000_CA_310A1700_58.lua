...
uptable["bcdLocationNumber"] = 0
uptable["marqueeFlashes"] = 0
...
uptable["smartSelectionPresetTemp"] = 99
uptable["smartSelectionExecuteResult"] = 0
uptable["tmfCoolFreezeMode"] = 0
uptable["smartSelectionGearChange"] = 0
uptable["smartSelectionHandleStore"] = 0
uptable["smartSelectionHandleTime"] = 0
...
local function jsonToModel(jsonCmd)
    ...
    if streams["bcd_location_number"] ~= nil then
        uptable["bcdLocationNumber"] = checkBoundary(streams["bcd_location_number"], -5, 100)
    end
    if streams["marquee_flashes"] == "on" then
        uptable["marqueeFlashes"] = 0x80
    elseif streams["marquee_flashes"] == "off" then
        uptable["marqueeFlashes"] = 0x00
    end
    ...
    if streams["freezing_light_open"] ~= nuil then
    ...
    if streams["ai_purine_box_gear"] ~= nil then
        uptable["aiPurineBoxGear"] = checkBoundary(streams["ai_purine_box_gear"], -1, 100)
    end
    ...
    if streams["smart_selection_execute_result"] == "yes" then
        uptable["smartSelectionExecuteResult"] = 0x02
    elseif streams["smart_selection_execute_result"] == "no" then
        uptable["smartSelectionExecuteResult"] = 0x00
    end
    if streams["smart_selection_gear_change"] == "yes" then
        uptable["smartSelectionGearChange"] = 0x04
    elseif streams["smart_selection_gear_change"] == "no" then
        uptable["smartSelectionGearChange"] = 0x00
    end
    if streams["smart_selection_handle_store"] == "handle" then
        uptable["smartSelectionHandleStore"] = 0x08
    elseif streams["smart_selection_handle_store"] == "store" then
        uptable["smartSelectionHandleStore"] = 0x00
    end
    if streams["smart_selection_handle_time"] ~= nil then
        uptable["smartSelectionHandleTime"] = tonumber(streams["smart_selection_handle_time"])
    end
    if streams["smart_selection_preset_temp"] ~= nil then
        uptable["smartSelectionPresetTemp"] = tonumber(streams["smart_selection_preset_temp"])
        if (uptable["smartSelectionPresetTemp"] >= -18) and (uptable["smartSelectionPresetTemp"] <= 10) then
            uptable["smartSelectionPresetTemp"] = uptable["smartSelectionPresetTemp"] + 19
        elseif (uptable["smartSelectionPresetTemp"] >= -24) and (uptable["smartSelectionPresetTemp"] <= -19) then
            uptable["smartSelectionPresetTemp"] = 30 - uptable["smartSelectionPresetTemp"]
        else
            uptable["smartSelectionPresetTemp"] = 99
        end
    end
                                                        ...
                                                        if #messageBytes >= 59 then
                                                            ...
                                                            if #messageBytes >= 67 then
                                                                ...
                                                                if #messageBytes >= 72 then
                                                                    uptable["bcdLocationNumber"] =
                                                                        bit.band(messageBytes[72], 0x7F)
                                                                    uptable["marqueeFlashes"] =
                                                                        bit.band(messageBytes[72], 0x80)
                                                                                        ...
                                                                                        if #messageBytes >= 86 then
                                                                                            ...
                                                                                            if #messageBytes >= 87 then
                                                                                                ...
                                                                                                then
                                                                                                    ...
                                                                                                    uptable["smartSelectionExecuteResult"] =
                                                                                                        bit.band(
                                                                                                            messageBytes[103],
                                                                                                            0x02
                                                                                                        )
                                                                                                    ...
                                                                                                    uptable["smartSelectionHandleStore"] =
                                                                                                        bit.band(
                                                                                                            messageBytes[103],
                                                                                                            0x08
                                                                                                        )
                                                                                                    if
                                                                                                        uptable["smartSelectionPresetTemp"]
                                                                                                            == 0x0
                                                                                                        or messageBytes[104]
                                                                                                            == 0
                                                                                                    then
                                                                                                ...
                                                                                                if
                                                                                                    #messageBytes >= 106
                                                                                                then
                                                                                                    uptable["smartSelectionHandleTime"] =
                                                                                                        messageBytes[106]
                                                                                                end
                                                                                            end
                                                                                        end
...
function jsonToData(jsonCmd)
    ...
    elseif control then
                ...
                bit.bor(
                    bit.bor(
                        bit.bor(
                            ...
                            bit.bor(uptable["electronicSmell"], 0x04)
                        ),
        ...
        bodyBytes[67] =
            bit.bor(bit.band(uptable["lightingEffect"], 0x07), bit.band(bit.lshift(uptable["lightingColor"], 3), 0xF8))
        ...
        bodyBytes[72] = bit.bor(bit.band(uptable["bcdLocationNumber"], 0x7F), bit.band(uptable["marqueeFlashes"], 0x80))
        ...
        bodyBytes[77] = uptable["handleReturnTime"]
        bodyBytes[78] = bit.band(uptable["iceClean"], 0x08)
        bodyBytes[80] =
            bit.bor(bit.band(uptable["telstarSavingMode"], 0x01), bit.band(uptable["panelDisplayGear"], 0x02))
        bodyBytes[81] = uptable["coolingTimeStartHour"]
        bodyBytes[82] = uptable["coolingTimeStartMinutes"]
        bodyBytes[83] = uptable["riseTimeStartHour"]
        bodyBytes[84] = uptable["riseTimeStartMinutes"]
        ...
        bodyBytes[86] = uptable["globalFlexTemperature"]
        ...
        bodyBytes[88] = bit.bor(
            bit.bor(
                bit.band(uptable["aiFruitDisplayControl"], 0x0F),
                bit.lshift(bit.band(uptable["aiFruitBoxGear"], 0x07), 4)
            ),
            bit.band(uptable["aiFruitFlag"], 0x80)
        )
        bodyBytes[89] = bit.bor(
            bit.bor(
                bit.band(uptable["aiPurineDisplayControl"], 0x0F),
                bit.lshift(bit.band(uptable["aiPurineBoxGear"], 0x07), 4)
            ),
            bit.band(uptable["aiPurineFlag"], 0x80)
        )
        ...
        bodyBytes[93] = bit.band(uptable["sleepModeStartMinute"], 0x3F)
        ...
        bodyBytes[103] = bit.bor(
            bit.bor(
                ...
                bit.band(uptable["smartSelectionExecuteResult"], 0x02)
            ),
            bit.bor(
                bit.band(uptable["smartSelectionGearChange"], 0x04),
                bit.band(uptable["smartSelectionHandleStore"], 0x08)
            )
        )
        if uptable["smartSelectionPresetTemp"] == 99 then
            bodyBytes[104] = 0
        else
            bodyBytes[104] = uptable["smartSelectionPresetTemp"]
        end
        bodyBytes[105] = uptable["tmfCoolFreezeMode"]
        bodyBytes[106] = uptable["smartSelectionHandleTime"]
                                                        ...
                                                        if bodyLength >= 59 then
                                                            ...
                                                            if bodyLength >= 67 then
                                                                ...
                                                                if bodyLength >= 72 then
                                                                    streams["bcd_location_number"] =
                                                                        int2String(uptable["bcdLocationNumber"])
                                                                    if uptable["marqueeFlashes"] == 0x80 then
                                                                        streams["marquee_flashes"] = "on"
                                                                    elseif uptable["marqueeFlashes"] == 0x00 then
                                                                        streams["marquee_flashes"] = "off"
                                                                    end
                                                                                        ...
                                                                                        if bodyLength >= 87 then
                                                                                            ...
                                                                                            if bodyLength >= 103 then
                                                                                                ...
                                                                                                if
                                                                                                    ...
                                                                                                    == 0x02
                                                                                                then
                                                                                                    streams["smart_selection_execute_result"] =
                                                                                                        "yes"
                                                                                                elseif
                                                                                                    uptable["smartSelectionExecuteResult"]
                                                                                                    == 0x00
                                                                                                ...
                                                                                                if
                                                                                                    ...
                                                                                                    == 0x08
                                                                                                then
                                                                                                    streams["smart_selection_handle_store"] =
                                                                                                        "handle"
                                                                                                elseif
                                                                                                    uptable["smartSelectionHandleStore"]
                                                                                                    == 0x00
                                                                                                ...
                                                                                                then
                                                                                                    streams["smart_selection_preset_temp"] =
                                                                                                        int2String(
                                                                                                            uptable["smartSelectionPresetTemp"]
                                                                                                                - 19
                                                                                                        )
                                                                                            ...
                                                                                            if bodyLength >= 106 then
                                                                                                streams["smart_selection_handle_time"] =
                                                                                                    int2String(
                                                                                                        uptable["smartSelectionHandleTime"]
                                                                                                    )
                                                                                            end
