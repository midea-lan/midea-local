...
uptable["atomizationFuncSwitch"] = 0
...
uptable["sphericalIceModeSelect"] = 0
uptable["iceMakerShapeOpention"] = 0
...
uptable["doorOpenOvertimeAlarmSwitch"] = 0
...
local function jsonToModel(jsonCmd)
    ...
    if
        streams["storage_temperature"] ~= nil
        and (streams["colmo_cool_freeze_mode"] == "2" or uptable["colmoCoolFreezeMode"] == 0x02)
    then
    ...
    elseif streams["storage_temperature"] ~= nil then
        uptable["refrigerationTemperature"] = checkBoundary(streams["storage_temperature"], -2, 20)
    end
    if
        streams["freezing_temperature"] ~= nil
        and (streams["colmo_cool_freeze_mode"] == "1" or uptable["colmoCoolFreezeMode"] == 0x01)
    then
    ...
    if streams["left_flexzone_temperature"] ~= nil then
        ...
        elseif (uptable["lVariableTemperature"] >= -24) and (uptable["lVariableTemperature"] <= -19) then
            uptable["lVariableTemperature"] = 30 - uptable["lVariableTemperature"]
        else
            uptable["lVariableTemperature"] = 0
        end
    end
    if streams["right_flexzone_temperature"] ~= nil then
        ...
        if uptable["rVariableTemperature"] == 0 then
            uptable["rVariableTemperature"] = 0
        elseif (uptable["rVariableTemperature"] >= -18) and (uptable["rVariableTemperature"] <= 10) then
        ...
        elseif (uptable["rVariableTemperature"] >= -24) and (uptable["rVariableTemperature"] <= -19) then
            uptable["rVariableTemperature"] = 30 - uptable["rVariableTemperature"]
        else
            uptable["rVariableTemperature"] = 0
        end
    end
    ...
    if streams["cross_peak_electricity_enter"] == "enter" then
        uptable["crossPeakElectricityEnter"] = 0x20
    elseif streams["cross_peak_electricity_enter"] == "quit" then
        uptable["crossPeakElectricityEnter"] = 0x00
    end
    ...
    if streams["atomization_func_switch"] == "on" then
        uptable["atomizationFuncSwitch"] = 0x01
    elseif streams["atomization_func_switch"] == "off" then
        uptable["atomizationFuncSwitch"] = 0x00
    end
    if streams["human_induction_status"] == "valid" then
        uptable["humanInduction"] = 0x10
    elseif streams["human_induction_status"] == "invalid" then
        uptable["humanInduction"] = 0x00
    end
    if streams["human_induction_light_switch"] == "on" then
        uptable["humanInductionLightSwitch"] = 0x40
    elseif streams["human_induction_light_switch"] == "off" then
        uptable["humanInductionLightSwitch"] = 0x00
    end
    ...
    if streams["flex_door_auto"] == "on" then
        uptable["flexDoorAuto"] = 0x10
    elseif streams["flex_door_auto"] == "off" then
        uptable["flexDoorAuto"] = 0x20
    elseif streams["flex_door_auto"] == "invalid" then
        uptable["flexDoorAuto"] = 0x00
    end
    if streams["freezer_down_door_auto"] == "on" then
        uptable["freezerDownDoorAuto"] = 0x40
    elseif streams["freezer_down_door_auto"] == "off" then
        uptable["freezerDownDoorAuto"] = 0x80
    elseif streams["freezer_down_door_auto"] == "invalid" then
        uptable["freezerDownDoorAuto"] = 0x00
    end
    ...
    if streams["aquatic_product"] == "on" then
        uptable["aquaticProduct"] = 0x01
    elseif streams["aquatic_product"] == "off" then
        uptable["aquaticProduct"] = 0x00
    end
    if streams["silent_night_mode"] == "on" then
        uptable["silentNightMode"] = 0x04
    elseif streams["silent_night_mode"] == "off" then
        uptable["silentNightMode"] = 0x00
    end
    if streams["silent_mode"] == "on" then
        uptable["silentMode"] = 0x08
    elseif streams["silent_mode"] == "off" then
        uptable["silentMode"] = 0x00
    end
    if streams["deep_cold_mode"] == "on" then
        uptable["deepColdMode"] = 0x08
    elseif streams["deep_cold_mode"] == "off" then
        uptable["deepColdMode"] = 0x00
    end
    if streams["vacuum_mode"] == "on" then
        uptable["vacuumMode"] = 0x10
    elseif streams["vacuum_mode"] == "off" then
        uptable["vacuumMode"] = 0x00
    end
    if streams["vacuum_completed"] == "yes" then
        uptable["vacuumCompleted"] = 0x20
    elseif streams["vacuum_completed"] == "no" then
        uptable["vacuumCompleted"] = 0x00
    end
    if streams["night_mode"] == "on" then
        uptable["nightMode"] = 0x20
    elseif streams["night_mode"] == "off" then
        uptable["nightMode"] = 0x00
    end
    if streams["storage_light_level"] ~= nil then
        uptable["storageLightLevel"] = checkBoundary(streams["storage_light_level"], -5, 30)
    end
    if streams["voice_door_auto"] == "on" then
        uptable["voiceDoorAuto"] = 0x01
    elseif streams["voice_door_auto"] == "off" then
        uptable["voiceDoorAuto"] = 0x00
    end
    if streams["touch_door_auto"] == "on" then
        uptable["touchDoorAuto"] = 0x02
    elseif streams["touch_door_auto"] == "off" then
        uptable["touchDoorAuto"] = 0x00
    end
    if streams["help_door_auto"] == "on" then
        uptable["helpDoorAuto"] = 0x04
    elseif streams["help_door_auto"] == "off" then
        uptable["helpDoorAuto"] = 0x00
    end
    if streams["speed_door_open"] == "fast" then
        uptable["speedDoorOpen"] = 0x08
    elseif streams["speed_door_open"] == "slow" then
        uptable["speedDoorOpen"] = 0x00
    end
    if streams["angle_door_open"] == "90" then
        uptable["angleDoorOpen"] = 0x10
    elseif streams["angle_door_open"] == "110" then
        uptable["angleDoorOpen"] = 0x20
    elseif streams["angle_door_open"] == "135" then
        uptable["angleDoorOpen"] = 0x30
    end
    if streams["voice_assistant"] == "on" then
        uptable["voiceAssistant"] = 0x40
    elseif streams["voice_assistant"] == "off" then
        uptable["voiceAssistant"] = 0x00
    end
    if streams["no_action_door_close"] == "on" then
        uptable["noActionDoorClose"] = 0x80
    elseif streams["no_action_door_close"] == "off" then
        uptable["noActionDoorClose"] = 0x00
    end
    if streams["food_expire_light"] == "on" then
        uptable["foodExpireLight"] = 0x08
    elseif streams["food_expire_light"] == "off" then
        uptable["foodExpireLight"] = 0x00
    end
    if streams["level_msg_light"] == "on" then
        uptable["levelMsgLight"] = 0x10
    elseif streams["level_msg_light"] == "off" then
        uptable["levelMsgLight"] = 0x00
    end
    if streams["level_msg_light"] == "on" then
        uptable["levelMsgLight"] = 0x10
    elseif streams["level_msg_light"] == "off" then
    ...
    if streams["rapid_ice_making"] == "on" then
        uptable["quickIceMode"] = 0x20
    elseif streams["rapid_ice_making"] == "off" then
        uptable["quickIceMode"] = 0x00
    end
    if streams["no_action_door_close_time"] == "60" then
        uptable["noActionDoorCloseTime"] = 0x00
    elseif streams["no_action_door_close_time"] == "45" then
        uptable["noActionDoorCloseTime"] = 0x40
    elseif streams["no_action_door_close_time"] == "30" then
        uptable["noActionDoorCloseTime"] = 0x80
    end
    if streams["beverage_vial_number"] ~= nil then
        uptable["beverageVialNumber"] = checkBoundary(streams["beverage_vial_number"], -5, 300)
    end
    if streams["beverage_mid_number"] ~= nil then
        uptable["beverageMidNumber"] = checkBoundary(streams["beverage_mid_number"], -5, 300)
    end
    if streams["beverage_big_number"] ~= nil then
        uptable["beverageBigNumber"] = checkBoundary(streams["beverage_big_number"], -5, 300)
    end
    if streams["beverage_quick_time"] ~= nil then
        uptable["beverageQuickTime"] = checkBoundary(streams["beverage_quick_time"], -5, 100)
    end
    if streams["lighting_effect"] ~= nil then
        uptable["lightingEffect"] = checkBoundary(streams["lighting_effect"], -5, 100)
    end
    if streams["lighting_color"] ~= nil then
        uptable["lightingColor"] = checkBoundary(streams["lighting_color"], -5, 100)
    end
    if streams["custom_color_R"] ~= nil then
        uptable["customColorR"] = checkBoundary(streams["custom_color_R"], -5, 300)
    end
    if streams["custom_color_G"] ~= nil then
        uptable["customColorG"] = checkBoundary(streams["custom_color_G"], -5, 300)
    end
    if streams["custom_color_B"] ~= nil then
        uptable["customColorB"] = checkBoundary(streams["custom_color_B"], -5, 300)
    end
    if streams["turn_off_light"] == "on" then
        uptable["turnOffLight"] = 0x00
    elseif streams["turn_off_light"] == "off" then
        uptable["turnOffLight"] = 0x01
    end
    if streams["light_brightness"] == "low" then
        uptable["lightBrightness"] = 0x02
    elseif streams["light_brightness"] == "high" then
        uptable["lightBrightness"] = 0x00
    end
    if streams["sunny_for_seven_days"] == "on" then
        uptable["sunnyForSevenDays"] = 0x04
    elseif streams["sunny_for_seven_days"] == "off" then
        uptable["sunnyForSevenDays"] = 0x00
    end
    if streams["tesla_handle_switch_mode"] == "on" then
        uptable["teslaHandleSwitchMode"] = 0x01
    elseif streams["tesla_handle_switch_mode"] == "off" then
        uptable["teslaHandleSwitchMode"] = 0x00
    end
    if streams["five_preservation_mode"] == "on" then
        uptable["fivePreservationMode"] = 0x02
    elseif streams["five_preservation_mode"] == "off" then
        uptable["fivePreservationMode"] = 0x00
    end
    if streams["night_light_switch"] == "on" then
        uptable["nightLightSwitch"] = 0x10
    elseif streams["night_light_switch"] == "off" then
        uptable["nightLightSwitch"] = 0x00
    end
    if streams["open_door_tips_switch"] == "on" then
        uptable["openDoorTipsSwitch"] = 0x20
    elseif streams["open_door_tips_switch"] == "off" then
        uptable["openDoorTipsSwitch"] = 0x00
    end
    if streams["pulse_switch"] == "on" then
        uptable["pulseSwitch"] = 0x40
    elseif streams["pulse_switch"] == "off" then
        uptable["pulseSwitch"] = 0x00
    end
    if streams["delivery_mode"] == "on" then
        uptable["deliveryMode"] = 0x80
    elseif streams["delivery_mode"] == "off" then
        uptable["deliveryMode"] = 0x00
    end
    if streams["sabbath_exit_time"] ~= nil then
        uptable["sabbathExitTime"] = checkBoundary(streams["sabbath_exit_time"], -1, 60)
    end
    if streams["sabbath_mode"] == "on" then
        uptable["sabbathMode"] = 0x40
    elseif streams["sabbath_mode"] == "off" then
        uptable["sabbathMode"] = 0x80
    elseif streams["sabbath_mode"] == "hold" then
        uptable["sabbathMode"] = 0x00
    end
    if streams["control_sugar_flag"] == "on" then
        uptable["controlSugarFlag"] = 0x04
    elseif streams["control_sugar_flag"] == "off" then
        uptable["controlSugarFlag"] = 0x00
    end
    if streams["strong_control_sugar_flag"] == "on" then
        uptable["strongControlSugarFlag"] = 0x08
    elseif streams["strong_control_sugar_flag"] == "off" then
        uptable["strongControlSugarFlag"] = 0x00
    end
    if streams["handle_return_time"] ~= nil then
        uptable["handleReturnTime"] = checkBoundary(streams["handle_return_time"], -5, 300)
    end
    if streams["delay_defrost_switch"] == "on" then
        uptable["delayDefrostSwitch"] = 0x01
    elseif streams["delay_defrost_switch"] == "off" then
        uptable["delayDefrostSwitch"] = 0x00
    end
    if streams["demand_response_switch"] == "on" then
        uptable["demandResponseSwitch"] = 0x02
    elseif streams["demand_response_switch"] == "off" then
        uptable["demandResponseSwitch"] = 0x00
    end
    if streams["temporary_deloading_switch"] == "on" then
        uptable["temporaryDeloadingSwitch"] = 0x04
    elseif streams["temporary_deloading_switch"] == "off" then
        uptable["temporaryDeloadingSwitch"] = 0x00
    end
    ...
    if streams["internal_deloading_maximum_exit_time"] ~= nil then
        uptable["internalDeloadingMaximumExitTime"] =
            checkBoundary(streams["internal_deloading_maximum_exit_time"], 0, 30)
    ...
    if streams["off_peak_defrost_switch"] == "on" then
        uptable["offPeakDefrostSwitch"] = 0x08
    elseif streams["off_peak_defrost_switch"] == "off" then
        uptable["offPeakDefrostSwitch"] = 0x00
    end
    ...
    if streams["ice_clean"] == "on" then
        uptable["iceClean"] = 0x08
    elseif streams["ice_clean"] == "off" then
        uptable["iceClean"] = 0x00
    end
    if streams["telstar_saving_mode"] == "on" then
        uptable["telstarSavingMode"] = 0x01
    elseif streams["telstar_saving_mode"] == "off" then
        uptable["telstarSavingMode"] = 0x00
    end
    if streams["panel_display_gear"] == "on" then
        uptable["panelDisplayGear"] = 0x02
    elseif streams["panel_display_gear"] == "off" then
        uptable["panelDisplayGear"] = 0x00
    end
    if streams["cooling_time_start_hour"] ~= nil then
        uptable["coolingTimeStartHour"] = checkBoundary(streams["cooling_time_start_hour"], -5, 300)
    end
    if streams["cooling_time_start_minutes"] ~= nil then
        uptable["coolingTimeStartMinutes"] = checkBoundary(streams["cooling_time_start_minutes"], -5, 300)
    end
    if streams["rise_time_start_hour"] ~= nil then
        uptable["riseTimeStartHour"] = checkBoundary(streams["rise_time_start_hour"], -5, 300)
    end
    if streams["rise_time_start_minutes"] ~= nil then
        uptable["riseTimeStartMinutes"] = checkBoundary(streams["rise_time_start_minutes"], -5, 300)
    end
    if streams["storage_left_door_auto_open_angle"] ~= nil then
        uptable["storageLeftDoorAutoOpenAngle"] = checkBoundary(streams["storage_left_door_auto_open_angle"], -5, 30)
    end
    if streams["storage_right_door_auto_open_angle"] ~= nil then
        uptable["storageRightDoorAutoOpenAngle"] = checkBoundary(streams["storage_right_door_auto_open_angle"], -5, 30)
    end
    ...
    if streams["quick_freezing"] == "on" then
        uptable["quickFreezing"] = 0x10
    elseif streams["quick_freezing"] == "off" then
        uptable["quickFreezing"] = 0x00
    end
    if streams["standby_mode"] == "on" then
        uptable["standbyMode"] = 0x08
    elseif streams["standby_mode"] == "off" then
        uptable["standbyMode"] = 0x00
    end
    if streams["freezing_light_open"] ~= nil then
        uptable["freezingLightOpen"] = checkBoundary(streams["freezing_light_open"], 0, 100)
    end
    if streams["storage_glass_door_light"] ~= nil then
        uptable["storageGlassDoorLight"] = checkBoundary(streams["storage_glass_door_light"], 0, 100)
    end
    if streams["storage_glass_door_light_open"] ~= nil then
        uptable["storageGlassDoorLightOpen"] = checkBoundary(streams["storage_glass_door_light_open"], 0, 100)
    end
    if streams["vegetable_freezing"] == "on" then
        uptable["vegetableFreezing"] = 0x40
    elseif streams["vegetable_freezing"] == "off" then
        uptable["vegetableFreezing"] = 0x00
    end
    if streams["vegetable_freezing_dry"] == "on" then
        uptable["vegetableFreezingDry"] = 0x80
    elseif streams["vegetable_freezing_dry"] == "off" then
        uptable["vegetableFreezingDry"] = 0x00
    end
    if streams["storage_door_auto_open"] == "full" then
        uptable["storageDoorAutoOpen"] = 0x01
    elseif streams["storage_door_auto_open"] == "single" then
        uptable["storageDoorAutoOpen"] = 0x00
    end
    if streams["freezing_light_open_chose"] == "on" then
        uptable["freezingLightOpenChose"] = 0x20
    elseif streams["freezing_light_open_chose"] == "off" then
        uptable["freezingLightOpenChose"] = 0x00
    end
    if streams["storage_light_open_chose"] == "on" then
        uptable["storageLightOpenChose"] = 0x08
    elseif streams["storage_light_open_chose"] == "off" then
        uptable["storageLightOpenChose"] = 0x00
    end
    if streams["smart_ai_to_self_select"] == "yes" then
        uptable["smartAiToSelfSelect"] = 0x08
    elseif streams["smart_ai_to_self_select"] == "no" then
        uptable["smartAiToSelfSelect"] = 0x00
    end
    if streams["ai_purine_2nd_estimate"] == "process" then
        uptable["aiPurine2ndEstimate"] = 0x10
    elseif streams["ai_purine_2nd_estimate"] == "finish" then
        uptable["aiPurine2ndEstimate"] = 0x00
    end
    if streams["surface_light_mode_select"] == "manual" then
        uptable["surfaceLightModeSelect"] = 0x20
    elseif streams["surface_light_mode_select"] == "automatic" then
        uptable["surfaceLightModeSelect"] = 0x00
    end
    if streams["atmosphere_lamp_mode_select"] == "manual" then
        uptable["atmosphereLampModeSelect"] = 0x40
    elseif streams["atmosphere_lamp_mode_select"] == "automatic" then
        uptable["atmosphereLampModeSelect"] = 0x00
    end
    if streams["tap_tap"] == "on" then
        uptable["tapTap"] = 0x02
    elseif streams["tap_tap"] == "off" then
        uptable["tapTap"] = 0x00
    end
    if streams["wine_type"] ~= nil then uptable["wineType"] = checkBoundary(streams["wine_type"], -1, 100) end
    if streams["ai_fruit_display_control"] ~= nil then
        uptable["aiFruitDisplayControl"] = checkBoundary(streams["ai_fruit_display_control"], -1, 100)
    end
    if streams["ai_fruit_flag"] == "on" then
        uptable["aiFruitFlag"] = 0x08
    elseif streams["ai_fruit_flag"] == "off" then
        uptable["aiFruitFlag"] = 0x00
    end
    if streams["ai_purine_display_control"] ~= nil then
        uptable["aiPurineDisplayControl"] = checkBoundary(streams["ai_purine_display_control"], -1, 100)
    end
    if streams["ai_purine_flag"] == "on" then
        uptable["aiPurineFlag"] = 0x80
    elseif streams["ai_purine_flag"] == "off" then
        uptable["aiPurineFlag"] = 0x00
    end
    if streams["ai_fruit_box_gear"] ~= nil then
        uptable["aiFruitBoxGear"] = checkBoundary(streams["ai_fruit_box_gear"], -1, 100)
    end
    if streams["offline_voice_switch"] == "on" then
        uptable["offlineVoiceSwitch"] = 0x10
    elseif streams["offline_voice_switch"] == "off" then
        uptable["offlineVoiceSwitch"] = 0x00
    end
    if streams["offline_voice_sensitivity"] ~= nil then
        uptable["offlineVoiceSensitivity"] = checkBoundary(streams["offline_voice_sensitivity"], -1, 100)
    end
    if streams["led_pwm_duty"] ~= nil then uptable["ledPwmDuty"] = checkBoundary(streams["led_pwm_duty"], -1, 110) end
    if streams["sleep_mode"] == "on" then
        uptable["sleepMode"] = 0x80
    elseif streams["sleep_mode"] == "off" then
        uptable["sleepMode"] = 0x00
    end
    if streams["sleep_mode_start_hour"] ~= nil then
        uptable["sleepModeStartHour"] = checkBoundary(streams["sleep_mode_start_hour"], -1, 30)
    end
    if streams["sleep_mode_start_minute"] ~= nil then
        uptable["sleepModeStartMinute"] = checkBoundary(streams["sleep_mode_start_minute"], -1, 70)
    end
    if streams["sleep_mode_end_hour"] ~= nil then
        uptable["sleepModeEndHour"] = checkBoundary(streams["sleep_mode_end_hour"], -1, 30)
    end
    if streams["sleep_mode_end_minute"] ~= nil then
        uptable["sleepModeEndMinute"] = checkBoundary(streams["sleep_mode_end_minute"], -1, 70)
    end
    if streams["ice_water_mode"] == "on" then
        uptable["iceWaterMode"] = 0x01
    elseif streams["ice_water_mode"] == "off" then
        uptable["iceWaterMode"] = 0x00
    end
    if streams["smart_recommend"] == "on" then
        uptable["smartRecommend"] = 0x02
    elseif streams["smart_recommend"] == "off" then
        uptable["smartRecommend"] = 0x00
    end
    if streams["divider_support_auto_fill"] == "yes" then
        uptable["dividerSupportAutoFill"] = 0x80
    elseif streams["divider_support_auto_fill"] == "no" then
        uptable["dividerSupportAutoFill"] = 0x00
    end
    if streams["ice_water_mix_type"] == "full" then
        uptable["iceWaterMixType"] = 0x00
    elseif streams["ice_water_mix_type"] == "smash" then
        uptable["iceWaterMixType"] = 0x08
    end
    if streams["ice_water_mix_proportion"] ~= nil then
        uptable["iceWaterMixProportion"] = checkBoundary(streams["ice_water_mix_proportion"], -1, 10)
    end
    if streams["ice_water_mix_type_morning"] == "full" then
        uptable["iceWaterMixTypeMorning"] = 0x00
    elseif streams["ice_water_mix_type_morning"] == "smash" then
        uptable["iceWaterMixTypeMorning"] = 0x10
    end
    if streams["ice_water_mix_proportion_morning"] ~= nil then
        uptable["iceWaterMixProportionMorning"] = checkBoundary(streams["ice_water_mix_proportion_morning"], -1, 10)
    end
    if streams["smart_noon_start_hour"] ~= nil then
        uptable["smartNoonStartHour"] = checkBoundary(streams["smart_noon_start_hour"], -1, 30)
    end
    if streams["ice_water_mix_type_noon"] == "full" then
        uptable["iceWaterMixTypeNoon"] = 0x00
    elseif streams["ice_water_mix_type_noon"] == "smash" then
        uptable["iceWaterMixTypeNoon"] = 0x10
    end
    if streams["ice_water_mix_proportion_noon"] ~= nil then
        uptable["iceWaterMixProportionNoon"] = checkBoundary(streams["ice_water_mix_proportion_noon"], -1, 10)
    end
    if streams["smart_night_start_hour"] ~= nil then
        uptable["smartNightStartHour"] = checkBoundary(streams["smart_night_start_hour"], -1, 30)
    end
    if streams["ice_water_mix_type_night"] == "full" then
        uptable["iceWaterMixTypeNight"] = 0x00
    elseif streams["ice_water_mix_type_night"] == "smash" then
        uptable["iceWaterMixTypeNight"] = 0x20
    end
    uptable["iceWaterMixProportionNight"] = checkBoundary(streams["ice_water_mix_proportion_night"], -1, 10)
    if streams["smart_morning_start_hour"] ~= nil then
        uptable["smartMorningStartHour"] = checkBoundary(streams["smart_morning_start_hour"], -1, 30)
    end
    if streams["open_door_warning_time"] ~= nil then
        uptable["openDoorWarningTime"] = checkBoundary(streams["open_door_warning_time"], -1, 257)
    end
    if streams["open_door_hover_time"] ~= nil then
        uptable["openDoorHoverTime"] = checkBoundary(streams["open_door_hover_time"], -1, 257)
    end
    if streams["camera_switch"] == "on" then
        uptable["cameraSwitch"] = 0x80
    elseif streams["camera_switch"] == "off" then
        uptable["cameraSwitch"] = 0x00
    end
    if streams["gps_report_switch"] == "on" then
        uptable["gpsReportSwitch"] = 0x01
    elseif streams["gps_report_switch"] == "off" then
        uptable["gpsReportSwitch"] = 0x00
    end
    if streams["room_led_dimming_flag"] == "on" then
        uptable["roomLedDimmingFlag"] = 0x20
    elseif streams["room_led_dimming_flag"] == "off" then
        uptable["roomLedDimmingFlag"] = 0x00
    end
    if streams["ice_machine_stop_ice_flag"] == "on" then
        uptable["iceMachineStopIceFlag"] = 0x40
    elseif streams["ice_machine_stop_ice_flag"] == "off" then
        uptable["iceMachineStopIceFlag"] = 0x00
    end
    if streams["display_board_mute_flag"] == "on" then
        uptable["displayBoardMuteFlag"] = 0x80
    elseif streams["display_board_mute_flag"] == "off" then
        uptable["displayBoardMuteFlag"] = 0x00
    end
    if streams["freezer_light_one_minute_flag"] == "on" then
        uptable["freezerLightOneMinuteFlag"] = 0x02
    elseif streams["freezer_light_one_minute_flag"] == "off" then
        uptable["freezerLightOneMinuteFlag"] = 0x00
    end
    if streams["is_have_freezing_ice"] == "yes" then
        uptable["isHaveFreezingIce"] = 0x40
    elseif streams["is_have_freezing_ice"] == "no" then
        uptable["isHaveFreezingIce"] = 0x00
    end
    if streams["handle_atmosphere_lamp_brightness"] ~= nil then
        uptable["handleAtmosphereLampBrightness"] = checkBoundary(streams["handle_atmosphere_lamp_brightness"], -1, 10)
    end
    if streams["colmo_cool_freeze_mode"] ~= nil then
        uptable["colmoCoolFreezeMode"] = checkBoundary(streams["colmo_cool_freeze_mode"], -1, 4)
    end
    if streams["tmf_cool_freeze_mode"] ~= nil then
        uptable["tmfCoolFreezeMode"] = checkBoundary(streams["tmf_cool_freeze_mode"], -1, 10)
    end
    if streams["app_smart_selection_mode"] == "on" then
        uptable["appSmartSelectionMode"] = 0x01
    elseif streams["app_smart_selection_mode"] == "off" then
        uptable["appSmartSelectionMode"] = 0x00
    end
    if streams["smart_selection_gear_change"] == "yes" then
        uptable["smartSelectionGearChange"] = 0x02
    elseif streams["smart_selection_gear_change"] == "no" then
        uptable["smartSelectionGearChange"] = 0x00
    end
    if streams["fridge_constant_temp_humidity"] == "on" then
        uptable["fridgeConstantTempHumidity"] = 0x04
    elseif streams["fridge_constant_temp_humidity"] == "off" then
        uptable["fridgeConstantTempHumidity"] = 0x00
    end
    if streams["spherical_ice_mode_select"] == "fast" then
        uptable["sphericalIceModeSelect"] = 0x40
    elseif streams["spherical_ice_mode_select"] == "hyaline" then
        uptable["sphericalIceModeSelect"] = 0x00
    end
    if streams["ice_maker_shape_opention"] == "spherical" then
        uptable["iceMakerShapeOpention"] = 0x80
    elseif streams["ice_maker_shape_opention"] == "normal" then
        uptable["iceMakerShapeOpention"] = 0x00
    end
    ...
    if streams["electronic_clean_smart_mode"] == "on" then
        uptable["electronicCleanSmartMode"] = 0x40
    elseif streams["electronic_clean_smart_mode"] == "off" then
        uptable["electronicCleanSmartMode"] = 0x00
    end
    if streams["smart_freeze_mode"] == "on" then
        uptable["smartFreezeMode"] = 0x04
    elseif streams["smart_freeze_mode"] == "off" then
        uptable["smartFreezeMode"] = 0x00
    end
    if streams["smart_cool_mode"] == "on" then
        uptable["smartCoolMode"] = 0x08
    elseif streams["smart_cool_mode"] == "off" then
        uptable["smartCoolMode"] = 0x00
    end
    if streams["multi_func_zone_status"] == "off" then
        uptable["multiFuncZoneStatus"] = 0x10
    elseif streams["multi_func_zone_status"] == "on" then
        uptable["multiFuncZoneStatus"] = 0x00
    end
    if streams["defrost_mode_switch"] == "on" then
        uptable["defrostModeSwitch"] = 0x01
    elseif streams["defrost_mode_switch"] == "off" then
        uptable["defrostModeSwitch"] = 0x00
    end
    if streams["defrost_completed_state"] == "yes" then
        uptable["defrostCompletedState"] = 0x02
    elseif streams["defrost_completed_state"] == "no" then
        uptable["defrostCompletedState"] = 0x00
    end
    if streams["defrost_time_unit"] == "double" then
        uptable["defrostTimeUnit"] = 0x02
    elseif streams["defrost_time_unit"] == "normal" then
        uptable["defrostTimeUnit"] = 0x00
    end
    ...
    if streams["defrost_time_user_defined"] ~= nil then
        uptable["defrostTimeUserDefined"] = checkBoundary(streams["defrost_time_user_defined"], -1, 500)
    end
    if streams["nfc_signal_board_enabled"] == "on" then
        uptable["nfcSignalBoardEnabled"] = 0x01
    elseif streams["nfc_signal_board_enabled"] == "off" then
        uptable["nfcSignalBoardEnabled"] = 0x01
    else
        uptable["nfcSignalBoardEnabled"] = 0x01
    end
    if streams["hex_length"] ~= nil then uptable["hexLength"] = checkBoundary(streams["hex_length"], -1, 200) end
    if streams["food_clip_data116"] ~= nil then
        uptable["foodClipData116"] = bit.bor(checkBoundary(streams["food_clip_data116"], -1, 1000), 0x00)
    end
    if streams["food_clip_data117"] ~= nil then
        uptable["foodClipData117"] = bit.bor(checkBoundary(streams["food_clip_data117"], -1, 1000), 0x00)
    end
    if streams["wifi_human_induction_value"] ~= nil then
        uptable["wifiHumanInductionValue"] = checkBoundary(streams["wifi_human_induction_value"], -1, 100)
    end
    if streams["wifi_human_induction_far_value"] ~= nil then
        uptable["wifiHumanInductionFarValue"] = checkBoundary(streams["wifi_human_induction_far_value"], -1, 100)
    end
    if streams["wifi_human_induction_exist_value"] ~= nil then
        uptable["wifiHumanInductionExistValue"] = checkBoundary(streams["wifi_human_induction_exist_value"], -1, 100)
    end
    if streams["range_tracking_short_value"] ~= nil then
        uptable["rangeTrackingShortValue"] = checkBoundary(streams["range_tracking_short_value"], -1, 100)
    end
    if streams["range_tracking_far_value"] ~= nil then
        uptable["rangeTrackingFarValue"] = checkBoundary(streams["range_tracking_far_value"], -1, 100)
    end
    if streams["resist_spectrum_symmetry_disturb_ratio"] ~= nil then
        uptable["resistSpectrumSymmetryDisturbRatio"] =
            checkBoundary(streams["resist_spectrum_symmetry_disturb_ratio"], -1, 100)
    end
    if streams["resist_spectrum_symmetry_disturb_num"] ~= nil then
        uptable["resistSpectrumSymmetryDisturbNum"] =
            checkBoundary(streams["resist_spectrum_symmetry_disturb_num"], -1, 100)
    end
    if streams["ai_human_induction_similarity_value"] ~= nil then
        uptable["aiHumanInductionSimilarityValue"] =
            checkBoundary(streams["ai_human_induction_similarity_value"], -1, 100)
    end
    if streams["door_open_overtime_alarm_switch"] == "on" then
        uptable["doorOpenOvertimeAlarmSwitch"] = 0x80
    elseif streams["door_open_overtime_alarm_switch"] == "off" then
        uptable["doorOpenOvertimeAlarmSwitch"] = 0x00
    end
    if streams["basic_power_saving_switch"] == "on" then
        uptable["basicPowerSavingSwitch"] = 0x01
    elseif streams["basic_power_saving_switch"] == "off" then
        uptable["basicPowerSavingSwitch"] = 0x00
    end
    if streams["smart_denoise_open_hours"] ~= nil then
        uptable["smartDenoiseOpenHours"] = checkBoundary(streams["smart_denoise_open_hours"], 0, 24)
    end
    if streams["smart_denoise_open_mins"] ~= nil then
        uptable["smartDenoiseOpenMins"] = checkBoundary(streams["smart_denoise_open_mins"], 0, 60)
    end
    if streams["freezer_elec_powerful_deodorize_switch"] == "on" then
        uptable["freezerElecPowerfulDeodorizeSwitch"] = 0x01
    elseif streams["freezer_elec_powerful_deodorize_switch"] == "off" then
        uptable["freezerElecPowerfulDeodorizeSwitch"] = 0x00
    end
    if streams["freezer_elec_powerful_deodorize_hour_time"] ~= nil then
        uptable["freezerElecPowerfulDeodorizeHourTime"] =
            checkBoundary(streams["freezer_elec_powerful_deodorize_hour_time"], 0, 128)
    end
    if streams["freezer_elec_powerful_deodorize_min_time"] ~= nil then
        uptable["freezerElecPowerfulDeodorizeMinTime"] =
            checkBoundary(streams["freezer_elec_powerful_deodorize_min_time"], 0, 256)
    end
    if streams["storage_elec_powerful_deodorize_hour_time"] ~= nil then
        uptable["storageElecPowerfulDeodorizeHourTime"] =
            checkBoundary(streams["storage_elec_powerful_deodorize_hour_time"], 0, 256)
    end
end
local function binToModel(binData)
    if #binData < 6 then return nil end
    local messageBytes = binData
    if
        (uptable["dataType"] == 0x02 and messageBytes[0] == 0x00)
        or (uptable["dataType"] == 0x03 and messageBytes[0] == 0x00)
        or (uptable["dataType"] == 0x04 and messageBytes[0] == 0x02)
    then
        ...
        uptable["atomizationFuncSwitch"] = bit.band(messageBytes[10], 0x01)
        ...
        if #messageBytes > 17 then uptable["refrigerationRealTemperature"] = messageBytes[17] end
        if #messageBytes > 18 then uptable["freezingRealTemperature"] = messageBytes[18] end
        if #messageBytes > 19 then uptable["lVariableRealTemperature"] = messageBytes[19] end
        if #messageBytes > 20 then uptable["rVariableRealTemperature"] = messageBytes[20] end
                                                    ...
                                                    if #messageBytes >= 51 then
                                                        ...
                                                        if #messageBytes >= 59 then
                                                            ...
                                                            if #messageBytes >= 67 then
                                                                uptable["lightingEffect"] =
                                                                    bit.band(messageBytes[67], 0x07)
                                                                uptable["lightingColor"] =
                                                                    bit.rshift(bit.band(messageBytes[67], 0xF8), 3)
                                                                uptable["customColorR"] = messageBytes[68]
                                                                uptable["customColorG"] = messageBytes[69]
                                                                uptable["customColorB"] = messageBytes[70]
                                                                uptable["turnOffLight"] =
                                                                    bit.band(messageBytes[71], 0x01)
                                                                uptable["lightBrightness"] =
                                                                    bit.band(messageBytes[71], 0x02)
                                                                uptable["sunnyForSevenDays"] =
                                                                    bit.band(messageBytes[71], 0x04)
                                                                uptable["standbyMode"] =
                                                                    bit.band(messageBytes[71], 0x08)
                                                                uptable["quickFreezing"] =
                                                                    bit.band(messageBytes[71], 0x10)
                                                                uptable["freezingLightOpenChose"] =
                                                                    bit.band(messageBytes[71], 0x20)
                                                                uptable["freezingLightOpen"] =
                                                                    bit.rshift(messageBytes[71], 6)
                                                                if #messageBytes >= 72 then
                                                                    uptable["wifiHumanInductionValue"] =
                                                                        messageBytes[72]
                                                                    if #messageBytes >= 73 then
                                                                        uptable["teslaHandleSwitchMode"] =
                                                                            bit.band(messageBytes[73], 0x01)
                                                                        uptable["fivePreservationMode"] =
                                                                            bit.band(messageBytes[73], 0x02)
                                                                        uptable["controlSugarFlag"] =
                                                                            bit.band(messageBytes[73], 0x04)
                                                                        uptable["strongControlSugarFlag"] =
                                                                            bit.band(messageBytes[73], 0x08)
                                                                        uptable["nightLightSwitch"] =
                                                                            bit.band(messageBytes[73], 0x10)
                                                                        uptable["openDoorTipsSwitch"] =
                                                                            bit.band(messageBytes[73], 0x20)
                                                                        uptable["pulseSwitch"] =
                                                                            bit.band(messageBytes[73], 0x40)
                                                                        uptable["deliveryMode"] =
                                                                            bit.band(messageBytes[73], 0x80)
                                                                        if #messageBytes >= 74 then
                                                                            uptable["sabbathExitTime"] =
                                                                                bit.band(messageBytes[74], 0x3F)
                                                                            uptable["sabbathMode"] =
                                                                                bit.band(messageBytes[74], 0xC0)
                                                                                            ...
                                                                                            if #messageBytes >= 86 then
                                                                                                ...
                                                                                                then
                                                                                                    ...
                                                                                                    then
                                                                                                        ...
                                                                                                        uptable["sphericalIceModeSelect"] =
                                                                                                            bit.band(
                                                                                                                messageBytes[103],
                                                                                                                0x40
                                                                                                            )
                                                                                                        uptable["iceMakerShapeOpention"] =
                                                                                                            bit.band(
                                                                                                                messageBytes[103],
                                                                                                                0x80
                                                                                                            )
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        >= 112
                                                                                                    then
                                                                                                        uptable["defrostTimeUserDefined"] =
                                                                                                            bit.band(
                                                                                                                messageBytes[112],
                                                                                                                0xFF
                                                                                                            )
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        >= 118
                                                                                                    then
                                                                                                        uptable["wifiHumanInductionFarValue"] =
                                                                                                            messageBytes[118]
                                                                                                    end
                                                                                                    if
                                                                                                        #messageBytes
                                                                                                        >= 119
                                                                                                    then
                                                                                                        uptable["wifiHumanInductionExistValue"] =
                                                                                                            messageBytes[119]
                                                                                                    end
                                                                                                    if
                                                                                                        #messageBytes
                                                                                                        >= 120
                                                                                                    then
                                                                                                        uptable["rangeTrackingShortValue"] =
                                                                                                            messageBytes[120]
                                                                                                    end
                                                                                                    if
                                                                                                        #messageBytes
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        >= 127
                                                                                                    then
                                                                                                        uptable["doorOpenOvertimeAlarmSwitch"] =
                                                                                                            bit.band(
                                                                                                                messageBytes[127],
                                                                                                                0x80
                                                                                                            )
    ...
    elseif
        ...
        or (uptable["dataType"] == 0x03 and messageBytes[0] == 0x01)
    then
        ...
        if #messageBytes > 54 then
            ...
            if #messageBytes > 57 then
                ...
                if #messageBytes > 83 and messageBytes[84] >= 0 then
                    uptable["globalFlexTemperature"] = messageBytes[84]
                end
            end
        end
    ...
    elseif uptable["dataType"] == 0x04 and messageBytes[0] == 0x04 then
    elseif
        (uptable["dataType"] == 0x06 and messageBytes[0] == 0x01)
        or (uptable["dataType"] == 0x03 and messageBytes[0] == 0x02)
    then
        if
            messageBytes[1] ~= 0x00
            or messageBytes[2] ~= 0x00
            or messageBytes[3] ~= 0x00
            or messageBytes[4] ~= 0x00
            or messageBytes[5] ~= 0x00
            or messageBytes[6] ~= 0x00
            or messageBytes[7] ~= 0x00
        then
                            ...
                            if #messageBytes > 7 then
                                ...
                                if #messageBytes > 8 then
                                    ...
                                    if #messageBytes > 10 then
                                        ...
                                        if #messageBytes > 14 then
                                            uptable["freezerWaterShortageAlarm"] = bit.band(messageBytes[14], 0x20)
                                        end
                                    end
                                end
                            end
    ...
    elseif control then
            ...
            bit.bor(
                bit.bor(
                    bit.bor(
                        bit.bor(
                            bit.bor(
                                bit.bor(bit.band(uptable["codeMode"], 0x01), bit.band(uptable["freezingMode"], 0x02)),
                                bit.band(uptable["smartMode"], 0x04)
                            ),
                            bit.band(uptable["energySavingMode"], 0x08)
                        ),
                        bit.band(uptable["holidayMode"], 0x10)
                    ),
                    bit.band(uptable["moisturizeMode"], 0x20)
                ),
                bit.band(uptable["preservationMode"], 0x40)
            ),
            bit.band(uptable["acmeFreezingMode"], 0x80)
        )
        bodyBytes[2] = bit.bor(
            bit.lshift(bit.band(uptable["freezingTemperature"], 0x0F), 4),
            ...
            bit.bor(
                bit.bor(
                    bit.bor(
                        bit.bor(
                            bit.bor(
                                bit.band(uptable["refrigerationPowerValue"], 0x01),
                                bit.band(uptable["lVariablePowerValue"], 0x04)
                            ),
                            bit.band(uptable["rVariablePowerValue"], 0x08)
                        ),
                        bit.band(uptable["freezingPowerValue"], 0x10)
                    ),
                    bit.band(uptable["crossPeakElectricityEnter"], 0x20)
                ),
                bit.band(uptable["crossPeakElectricity"], 0x40)
            ),
        ...
        bodyBytes[7] = bit.bor(
            bit.bor(
                bit.bor(
                    bit.bor(
                        bit.bor(bit.band(uptable["removeDew"], 0x01), bit.band(uptable["humidify"], 0x02)),
                        bit.band(uptable["unfreeze"], 0x04)
                    ),
                    bit.band(uptable["temperatureUnit"], 0x08)
                ),
                bit.band(uptable["floodlight"], 0x10)
            ),
            bit.band(uptable["functionSwitch"], 0xC0)
        )
        bodyBytes[8] = bit.bor(
            bit.bor(
                bit.bor(
                    bit.bor(
                        bit.bor(
                            bit.bor(
                                bit.bor(bit.band(uptable["radarMode"], 0x01), bit.band(uptable["milkMode"], 0x02)),
                                bit.band(uptable["icedMode"], 0x04)
                            ),
                            bit.band(uptable["plasmaAsepticMode"], 0x08)
                        ),
                        bit.band(uptable["acquireIceaMode"], 0x10)
                    ),
                    bit.band(uptable["brashIceaMode"], 0x20)
                ),
                bit.band(uptable["acquireWaterMode"], 0x40)
            ),
            bit.band(uptable["freezingIceMachinePower"], 0x80)
        )
        bodyBytes[10] = bit.band(uptable["atomizationFuncSwitch"], 0x01)
        bodyBytes[14] =
            bit.bor(bit.band(uptable["humanInduction"], 0x10), bit.band(uptable["humanInductionLightSwitch"], 0x40))
        bodyBytes[16] = bit.band(uptable["intervalRoomHumidityLevel"], 0xFE)
        if num >= 25 then
            if uptable["foodSite"] ~= nil then bodyBytes[25] = bit.band(uptable["foodSite"], 0x0F) end
        end
        if num >= 27 then
            if
                uptable["microcrystalFresh"] ~= nil
                and uptable["dryZone"] ~= nil
                and uptable["performanceMode"] ~= nil
                and uptable["electronicSmell"] ~= nil
                and uptable["eradicatePesticideResidue"] ~= nil
            then
                bodyBytes[27] = bit.bor(
                    bit.bor(
                        bit.bor(
                            bit.bor(
                                bit.bor(
                                    bit.band(uptable["microcrystalFresh"], 0x01),
                                    bit.band(uptable["dryZone"], 0x02)
                                ),
                                bit.band(uptable["electronicSmell"], 0x04)
                            ),
                            bit.band(uptable["eradicatePesticideResidue"], 0x08)
                        ),
                        bit.band(uptable["humidity"], 0x70)
                    ),
                    bit.band(uptable["performanceMode"], 0x80)
                )
            end
        end
        if num >= 28 then
            if uptable["normalTemperatureLevel"] ~= nil then bodyBytes[28] = uptable["normalTemperatureLevel"] end
        end
        if num >= 29 then
            if uptable["functionZoneLevel"] ~= nil then bodyBytes[29] = uptable["functionZoneLevel"] end
        end
        if num >= 30 then
            if uptable["humiditySetting"] ~= nil and uptable["smartHumidity"] ~= nil then
                bodyBytes[30] =
                    bit.bor(bit.band(uptable["humiditySetting"], 0x7F), bit.band(uptable["smartHumidity"], 0x80))
            end
        end
        if num >= 31 then
            if
                uptable["storageLeftDoorAuto"] ~= nil
                and uptable["storageRightDoorAuto"] ~= nil
                and uptable["freezerDoorAuto"] ~= nil
                and uptable["freezerDoorAutoControl"] ~= nil
                and uptable["storageDoorAutoControl"] ~= nil
            then
                bodyBytes[31] = bit.bor(
                    bit.bor(
                        bit.bor(
                            bit.bor(
                                bit.band(uptable["storageLeftDoorAuto"], 0x03),
                                bit.band(uptable["storageRightDoorAuto"], 0x0C)
                            ),
                            bit.band(uptable["freezerDoorAuto"], 0x30)
                        ),
                        bit.band(uptable["freezerDoorAutoControl"], 0x40)
                    ),
                    bit.band(uptable["storageDoorAutoControl"], 0x80)
                )
            end
        end
        if num >= 33 then
            if uptable["storageIceMachinePower"] ~= nil and uptable["filterReplacementWarningElimination"] ~= nil then
                bodyBytes[33] = bit.bor(
                    bit.band(uptable["storageIceMachinePower"], 0x01),
                    bit.band(uptable["filterReplacementWarningElimination"], 0x80)
                )
            end
        end
        if num >= 37 then
        ...
        if num >= 39 then
            if uptable["quickBeverageTime"] ~= nil and uptable["quickBeverage"] ~= nil then
                bodyBytes[39] =
                    bit.bor(bit.band(uptable["quickBeverageTime"], 0x7F), bit.band(uptable["quickBeverage"], 0x80))
            end
        end
        if num >= 41 then
            if
                uptable["aquaticProduct"] ~= nil
                and uptable["silentNightMode"] ~= nil
                and uptable["deepColdMode"] ~= nil
            then
                bodyBytes[40] = bit.bor(
                    bit.bor(
                        bit.bor(bit.band(uptable["aquaticProduct"], 0x01), bit.band(uptable["silentNightMode"], 0x04)),
                        bit.band(uptable["deepColdMode"], 0x08)
                    ),
                    bit.bor(bit.band(uptable["vacuumMode"], 0x10), bit.band(uptable["vacuumCompleted"], 0x20))
                )
            end
            if uptable["silentMode"] ~= nil then bodyBytes[41] = bit.band(uptable["silentMode"], 0x08) end
        end
        if num >= 42 then
            bodyBytes[42] = bit.bor(bit.band(uptable["storageLightLevel"], 0x1F), bit.band(uptable["nightMode"], 0x20))
        end
        if num >= 43 then
            if
                uptable["voiceDoorAuto"] ~= nil
                and uptable["touchDoorAuto"] ~= nil
                and uptable["helpDoorAuto"] ~= nil
                and uptable["speedDoorOpen"] ~= nil
                and uptable["angleDoorOpen"] ~= nil
                and uptable["voiceAssistant"] ~= nil
                and uptable["noActionDoorClose"] ~= nil
            then
                bodyBytes[43] = bit.bor(
                    bit.bor(
                        bit.bor(
                            bit.bor(
                                bit.bor(
                                    bit.bor(
                                        bit.band(uptable["voiceDoorAuto"], 0x01),
                                        bit.band(uptable["touchDoorAuto"], 0x02)
                                    ),
                                    bit.band(uptable["helpDoorAuto"], 0x04)
                                ),
                                bit.band(uptable["speedDoorOpen"], 0x08)
                            ),
                            bit.band(uptable["angleDoorOpen"], 0x30)
                        ),
                        bit.band(uptable["voiceAssistant"], 0x40)
                    ),
                    bit.band(uptable["noActionDoorClose"], 0x80)
                )
            end
        end
        if num >= 44 then
            bodyBytes[44] = bit.bor(
                bit.bor(
                    bit.bor(bit.band(uptable["foodExpireLight"], 0x08), bit.band(uptable["levelMsgLight"], 0x10)),
                    bit.band(uptable["quickIceMode"], 0x20)
                ),
                bit.band(uptable["noActionDoorCloseTime"], 0xC0)
            )
        end
        if num >= 50 then
        ...
        if num >= 70 then
            bodyBytes[67] = bit.bor(
                bit.band(uptable["lightingEffect"], 0x07),
        ...
        if num >= 71 then
            bodyBytes[71] = bit.bor(
                bit.lshift(uptable["freezingLightOpen"], 6),
                bit.band(uptable["turnOffLight"], 0x01),
                bit.band(uptable["lightBrightness"], 0x02),
                bit.band(uptable["sunnyForSevenDays"], 0x04),
                bit.band(uptable["standbyMode"], 0x08),
                bit.band(uptable["quickFreezing"], 0x10),
                bit.band(uptable["freezingLightOpenChose"], 0x20)
            )
        end
        if num >= 72 then bodyBytes[72] = uptable["wifiHumanInductionValue"] end
        if num >= 73 then
            bodyBytes[73] = bit.bor(
                bit.bor(
                    bit.bor(
                        bit.bor(
                            bit.bor(
                                bit.bor(
                                    bit.bor(
                                        bit.band(uptable["teslaHandleSwitchMode"], 0x01),
                                        bit.band(uptable["fivePreservationMode"], 0x02)
                                    ),
                                    bit.band(uptable["controlSugarFlag"], 0x04)
                                ),
                                bit.band(uptable["strongControlSugarFlag"], 0x08)
                            ),
                            bit.band(uptable["nightLightSwitch"], 0x10)
                        ),
                        bit.band(uptable["openDoorTipsSwitch"], 0x20)
                    ),
                    bit.band(uptable["pulseSwitch"], 0x40)
                ),
                bit.band(uptable["deliveryMode"], 0x80)
            )
        end
        if num >= 74 then
            bodyBytes[74] = bit.bor(bit.band(uptable["sabbathExitTime"], 0x3F), bit.band(uptable["sabbathMode"], 0xC0))
        end
        if num >= 77 then bodyBytes[77] = uptable["handleReturnTime"] end
        if num >= 78 then
            bodyBytes[78] = bit.bor(
                bit.band(uptable["delayDefrostSwitch"], 0x01),
                bit.band(uptable["demandResponseSwitch"], 0x02),
                bit.band(uptable["temporaryDeloadingSwitch"], 0x04),
                bit.band(uptable["iceClean"], 0x08),
                bit.lshift(bit.band(uptable["deloadingMaximumExitTime"], 0x0F), 4)
            )
        end
        if num >= 79 then
            bodyBytes[79] = bit.bor(
                bit.band(uptable["defrostMaximumExitTime"], 0x0F),
                bit.lshift(bit.band(uptable["demandResponseMaximumExitTime"], 0x0F), 4)
            )
        end
        if num >= 80 then
            bodyBytes[80] = bit.bor(
                bit.band(uptable["telstarSavingMode"], 0x01),
                bit.band(uptable["panelDisplayGear"], 0x02),
                bit.band(uptable["offPeakDefrostSwitch"], 0x08),
                bit.lshift(bit.band(uptable["coolThresholdUpwardValue"], 0x03), 4),
                bit.lshift(bit.band(uptable["freezeThresholdUpwardValue"], 0x03), 6)
            )
        end
        ...
        if num >= 85 then
            bodyBytes[85] = bit.bor(
                bit.lshift(bit.band(uptable["storageRightDoorAutoOpenAngle"], 0x0F), 4),
                bit.band(uptable["storageLeftDoorAutoOpenAngle"], 0x0F)
            )
        end
        if num >= 86 then bodyBytes[86] = uptable["globalFlexTemperature"] end
        if num >= 87 then
            bodyBytes[87] = bit.bor(
                bit.bor(
                    bit.bor(
                        bit.bor(
                            bit.band(uptable["storageGlassDoorLight"], 0x07),
                            bit.lshift(uptable["storageGlassDoorLightOpen"], 4)
                        ),
                        bit.band(uptable["vegetableFreezing"], 0x40)
                    ),
                    bit.band(uptable["vegetableFreezingDry"], 0x80)
                ),
                bit.band(uptable["storageLightOpenChose"], 0x08)
            )
        end
        if num >= 88 then
            bodyBytes[88] = bit.bor(
                bit.bor(bit.band(uptable["aiFruitDisplayControl"], 0x07), bit.band(uptable["aiFruitFlag"], 0x08)),
                bit.bor(bit.band(uptable["aiPurineDisplayControl"], 0x70), bit.band(uptable["aiPurineFlag"], 0x80))
            )
        end
        if num >= 89 then
            bodyBytes[89] = bit.bor(
                bit.band(uptable["aiFruitBoxGear"], 0x07),
                bit.band(uptable["smartAiToSelfSelect"], 0x08),
                bit.band(uptable["aiPurine2ndEstimate"], 0x10),
                bit.band(uptable["surfaceLightModeSelect"], 0x20),
                bit.band(uptable["atmosphereLampModeSelect"], 0x40)
            )
        end
        if num >= 90 then
            bodyBytes[90] = bit.bor(
                bit.bor(
                    bit.bor(
                        bit.bor(
                            bit.bor(bit.band(uptable["storageDoorAutoOpen"], 0x01), bit.band(uptable["tapTap"], 0x02)),
                            bit.lshift(bit.band(uptable["wineType"], 0x03), 2)
                        ),
                        bit.lshift(bit.band(uptable["offlineVoiceSensitivity"], 0x03), 5)
                    ),
                    bit.band(uptable["offlineVoiceSwitch"], 0x10)
                ),
                bit.band(uptable["cameraSwitch"], 0x80)
            )
        end
        if num >= 95 then
            ...
            bodyBytes[92] = bit.bor(
                bit.bor(
                    bit.bor(
                        bit.band(uptable["sleepModeStartHour"], 0x1F),
                        bit.band(uptable["roomLedDimmingFlag"], 0x20)
                    ),
                    bit.band(uptable["iceMachineStopIceFlag"], 0x40)
                ),
                bit.band(uptable["displayBoardMuteFlag"], 0x80)
            )
            bodyBytes[93] = bit.bor(
                bit.band(uptable["sleepModeStartMinute"], 0x3F),
                bit.band(uptable["electronicCleanSmartMode"], 0x40)
            )
            bodyBytes[94] = bit.band(uptable["sleepModeEndHour"], 0x1F)
            bodyBytes[95] = bit.band(uptable["sleepModeEndMinute"], 0x3F)
        end
        if num >= 99 then
            bodyBytes[96] = bit.bor(
                bit.bor(
                    bit.bor(bit.band(uptable["iceWaterMode"], 0x01), bit.band(uptable["smartRecommend"], 0x02)),
                    bit.band(uptable["iceWaterMixType"], 0x08)
                ),
                bit.bor(
                    bit.lshift(bit.band(uptable["iceWaterMixProportion"], 0x03), 4),
                    bit.band(uptable["dividerSupportAutoFill"], 0x80)
                )
            )
            bodyBytes[97] = bit.bor(
                bit.bor(
                    bit.band(uptable["smartMorningStartHour"], 0x0F),
                    bit.band(uptable["iceWaterMixTypeMorning"], 0x10)
                ),
        ...
        if num >= 102 then
            bodyBytes[102] = bit.bor(
                bit.bor(
                    bit.bor(
                        bit.band(uptable["gpsReportSwitch"], 0x01),
                        bit.band(uptable["freezerLightOneMinuteFlag"], 0x02)
                    ),
                    bit.bor(bit.band(uptable["smartFreezeMode"], 0x04), bit.band(uptable["smartCoolMode"], 0x08))
                ),
                bit.band(uptable["multiFuncZoneStatus"], 0x10)
            )
        end
        if num >= 103 then
            bodyBytes[103] = bit.bor(
                bit.band(uptable["appSmartSelectionMode"], 0x01),
                bit.band(uptable["smartSelectionGearChange"], 0x02),
                bit.band(uptable["fridgeConstantTempHumidity"], 0x04),
                bit.band(uptable["sphericalIceModeSelect"], 0x40),
                bit.band(uptable["iceMakerShapeOpention"], 0x80)
            )
        end
        if num >= 104 then
            if uptable["smartSelectionSetTemp"] == 99 then
                bodyBytes[104] = 0
            else
                bodyBytes[104] = uptable["smartSelectionSetTemp"]
            end
        end
        if num >= 105 then bodyBytes[105] = bit.band(uptable["tmfCoolFreezeMode"], 0x0F) end
        if num >= 106 then
            bodyBytes[106] = bit.bor(
                bit.band(uptable["handleAtmosphereLampBrightness"], 0x0F),
                bit.lshift(bit.band(uptable["colmoCoolFreezeMode"], 0x03), 4)
            )
        end
        if num >= 110 then
            bodyBytes[110] = bit.bor(
                bit.band(uptable["defrostModeSwitch"], 0x01),
                bit.band(uptable["defrostCompletedState"], 0x02),
                bit.lshift(bit.band(uptable["defrostRemainTimeData110"], 0xFF), 2)
            )
        end
        if num >= 111 then bodyBytes[111] = uptable["defrostRemainTimeData111"] end
        if num >= 112 then
            if uptable["defrostTimeUnit"] == 0x02 then
                uptable["defrostTimeUserDefined"] = math.ceil(uptable["defrostTimeUserDefined"] / 2)
            end
            bodyBytes[112] = uptable["defrostTimeUserDefined"]
        end
        if num >= 113 then
            bodyBytes[113] =
                bit.bor(bit.band(uptable["nfcSignalBoardEnabled"], 0x01), bit.band(uptable["defrostTimeUnit"], 0x02))
        end
        if num >= 117 then
        ...
        if num >= 127 then bodyBytes[127] = bit.band(uptable["doorOpenOvertimeAlarmSwitch"], 0x80) end
        ...
        if num >= 135 then
            bodyBytes[135] = bit.bor(
                bit.band(uptable["freezerElecPowerfulDeodorizeSwitch"], 0x01),
                bit.lshift(bit.band(uptable["freezerElecPowerfulDeodorizeHourTime"], 0xFE), 1)
            )
        end
...
function dataToJson(jsonCmd)
    ...
    if
        (uptable["dataType"] == 0x02 and bodyBytes[0] == 0x00)
        or (uptable["dataType"] == 0x03 and bodyBytes[0] == 0x00)
        or (uptable["dataType"] == 0x04 and bodyBytes[0] == 0x02)
    then
        ...
        if (uptable["rVariableTemperature"] >= 1) and (uptable["rVariableTemperature"] <= 29) then
        ...
        if uptable["crossPeakElectricityEnter"] == 0x20 then
            streams["cross_peak_electricity_enter"] = "enter"
        elseif uptable["crossPeakElectricityEnter"] == 0x00 then
            streams["cross_peak_electricity_enter"] = "quit"
        end
        ...
        if uptable["atomizationFuncSwitch"] == 0x01 then
            streams["atomization_func_switch"] = "on"
        elseif uptable["atomizationFuncSwitch"] == 0x00 then
            streams["atomization_func_switch"] = "off"
        end
        ...
        if uptable["freezerIcemakerWaterShortage"] == 0x20 then
            streams["freezer_icemaker_water_shortage"] = "shortage"
        elseif uptable["freezerIcemakerWaterShortage"] == 0x00 then
            streams["freezer_icemaker_water_shortage"] = "normal"
        end
        if uptable["humanInductionLightSwitch"] == 0x40 then
            streams["human_induction_light_switch"] = "on"
        elseif uptable["humanInductionLightSwitch"] == 0x00 then
            streams["human_induction_light_switch"] = "off"
        end
        ...
        if uptable["variableDoorPower"] == 0x04 then
        ...
        if uptable["barDoorPower"] == 0x10 then
        ...
        if uptable["isHaveFreezingIce"] == 0x40 then
            streams["is_have_freezing_ice"] = "yes"
        elseif uptable["isHaveFreezingIce"] == 0x00 then
            streams["is_have_freezing_ice"] = "no"
        end
        ...
        streams["refrigeration_real_temperature"] =
            int2String(math.floor((uptable["refrigerationRealTemperature"] - 100) / 2))
        streams["freezing_real_temperature"] = int2String(math.floor((uptable["freezingRealTemperature"] - 100) / 2))
        streams["left_variable_real_temperature"] =
            int2String(math.floor((uptable["lVariableRealTemperature"] - 100) / 2))
        streams["right_variable_real_temperature"] =
            int2String(math.floor((uptable["rVariableRealTemperature"] - 100) / 2))
        ...
        if bodyLength > 24 then
            streams["fast_freeze_minute"] =
                int2String(256 * uptable["fastFreezeMinuteLow"] + uptable["fastFreezeMinuteHigh"])
        ...
        if bodyLength > 25 then
            ...
            if bodyLength > 30 then
                ...
                if bodyLength > 31 then
                    ...
                    streams["eradicate_pesticide_residue_progress"] =
                        int2String(uptable["eradicatePesticideResidueProgress"])
                    ...
                    if bodyLength > 33 then
                        ...
                        streams["ice_room_real_temperature"] =
                            int2String(math.floor((uptable["iceRoomRealTemperature"] - 100) / 2))
                            ...
                            if bodyLength > 38 then
                                ...
                                if bodyLength > 39 then
                                    ...
                                    if bodyLength > 40 then
                                        if uptable["aquaticProduct"] == 0x01 then
                                            streams["aquatic_product"] = "on"
                                        elseif uptable["aquaticProduct"] == 0x00 then
                                            streams["aquatic_product"] = "off"
                                        end
                                        if uptable["silentNightMode"] == 0x04 then
                                            streams["silent_night_mode"] = "on"
                                        elseif uptable["silentNightMode"] == 0x00 then
                                            streams["silent_night_mode"] = "off"
                                        end
                                        if uptable["silentMode"] == 0x08 then
                                            streams["silent_mode"] = "on"
                                        elseif uptable["silentMode"] == 0x00 then
                                            streams["silent_mode"] = "off"
                                        end
                                        if uptable["deepColdMode"] == 0x08 then
                                            streams["deep_cold_mode"] = "on"
                                        elseif uptable["deepColdMode"] == 0x00 then
                                            streams["deep_cold_mode"] = "off"
                                        end
                                        if uptable["vacuumMode"] == 0x10 then
                                            streams["vacuum_mode"] = "on"
                                        elseif uptable["vacuumMode"] == 0x00 then
                                            streams["vacuum_mode"] = "off"
                                        end
                                        if uptable["vacuumCompleted"] == 0x20 then
                                            streams["vacuum_completed"] = "yes"
                                        elseif uptable["vacuumCompleted"] == 0x00 then
                                            streams["vacuum_completed"] = "no"
                                        end
                                        if uptable["blueRayMode"] == 0x02 then
                                            streams["blue_ray_mode"] = "on"
                                        elseif uptable["blueRayMode"] == 0x00 then
                                            streams["blue_ray_mode"] = "off"
                                        end
                                        if uptable["flexDoorAuto"] == 0x10 then
                                            streams["flex_door_auto"] = "on"
                                        elseif uptable["flexDoorAuto"] == 0x20 then
                                            streams["flex_door_auto"] = "off"
                                        elseif uptable["flexDoorAuto"] == 0x00 then
                                            streams["flex_door_auto"] = "invalid"
                                        end
                                        if uptable["freezerDownDoorAuto"] == 0x40 then
                                            streams["freezer_down_door_auto"] = "on"
                                        elseif uptable["freezerDownDoorAuto"] == 0x80 then
                                            streams["freezer_down_door_auto"] = "off"
                                        elseif uptable["freezerDownDoorAuto"] == 0x00 then
                                            streams["freezer_down_door_auto"] = "invalid"
                                        end
                                        if bodyLength > 42 then
                                            streams["storage_light_level"] = int2String(uptable["storageLightLevel"])
                                            if uptable["nightMode"] == 0x20 then
                                                streams["night_mode"] = "on"
                                            elseif uptable["nightMode"] == 0x00 then
                                                streams["night_mode"] = "off"
                                            end
                                            if uptable["quickBeverageCompleted"] == 0x40 then
                                                streams["quick_beverage_completed"] = "yes"
                                            elseif uptable["quickBeverageCompleted"] == 0x00 then
                                                streams["quick_beverage_completed"] = "no"
                                            end
                                            if uptable["voiceDoorAuto"] == 0x01 then
                                                streams["voice_door_auto"] = "on"
                                            elseif uptable["voiceDoorAuto"] == 0x00 then
                                                streams["voice_door_auto"] = "off"
                                            end
                                            if uptable["touchDoorAuto"] == 0x02 then
                                                streams["touch_door_auto"] = "on"
                                            elseif uptable["touchDoorAuto"] == 0x00 then
                                                streams["touch_door_auto"] = "off"
                                            end
                                            if uptable["helpDoorAuto"] == 0x04 then
                                                streams["help_door_auto"] = "on"
                                            elseif uptable["helpDoorAuto"] == 0x00 then
                                                streams["help_door_auto"] = "off"
                                            end
                                            if uptable["speedDoorOpen"] == 0x08 then
                                                streams["speed_door_open"] = "fast"
                                            elseif uptable["speedDoorOpen"] == 0x00 then
                                                streams["speed_door_open"] = "slow"
                                            end
                                            if uptable["angleDoorOpen"] == 0x20 then
                                                streams["angle_door_open"] = int2String "110"
                                            elseif uptable["angleDoorOpen"] == 0x10 then
                                                streams["angle_door_open"] = int2String "90"
                                            elseif uptable["angleDoorOpen"] == 0x30 then
                                                streams["angle_door_open"] = int2String "135"
                                            end
                                            if uptable["voiceAssistant"] == 0x40 then
                                                streams["voice_assistant"] = "on"
                                            elseif uptable["voiceAssistant"] == 0x00 then
                                                streams["voice_assistant"] = "off"
                                            end
                                            if uptable["noActionDoorClose"] == 0x80 then
                                                streams["no_action_door_close"] = "on"
                                            elseif uptable["noActionDoorClose"] == 0x00 then
                                                streams["no_action_door_close"] = "off"
                                            end
                                            if uptable["foodExpireLight"] == 0x08 then
                                                streams["food_expire_light"] = "on"
                                            elseif uptable["foodExpireLight"] == 0x00 then
                                                streams["food_expire_light"] = "off"
                                            end
                                            if uptable["levelMsgLight"] == 0x10 then
                                                streams["level_msg_light"] = "on"
                                            elseif uptable["levelMsgLight"] == 0x00 then
                                                streams["level_msg_light"] = "off"
                                            end
                                            if uptable["quickIceMode"] == 0x20 then
                                                streams["rapid_ice_making"] = "on"
                                            elseif uptable["quickIceMode"] == 0x00 then
                                                streams["rapid_ice_making"] = "off"
                                            end
                                            if uptable["noActionDoorCloseTime"] == 0x00 then
                                                streams["no_action_door_close_time"] = int2String "60"
                                            elseif uptable["noActionDoorCloseTime"] == 0x40 then
                                                streams["no_action_door_close_time"] = int2String "45"
                                            elseif uptable["noActionDoorCloseTime"] == 0x80 then
                                                streams["no_action_door_close_time"] = int2String "30"
                                            end
                                            if bodyLength >= 45 then
                                                streams["leach_expire_day_high"] =
                                                    int2String(uptable["leachExpireDayHigh"])
                                                streams["filter_natural_time_high"] =
                                                    int2String(uptable["filterNaturalTimeHigh"])
                                                streams["filter_natural_time_low"] =
                                                    int2String(uptable["filterNaturalTimeLow"])
                                                streams["water_flow_percentage"] =
                                                    int2String(uptable["waterFlowPercentage"])
                                                if bodyLength >= 47 then
                                                    streams["beverage_vial_number"] =
                                                        int2String(uptable["beverageVialNumber"])
                                                    streams["beverage_mid_number"] =
                                                        int2String(uptable["beverageMidNumber"])
                                                    streams["beverage_big_number"] =
                                                        int2String(uptable["beverageBigNumber"])
                                                    streams["beverage_quick_time"] =
                                                        int2String(uptable["beverageQuickTime"])
                                                    if bodyLength >= 51 then
                                                        streams["local_time_hour"] =
                                                            int2String(uptable["localTimeHour"])
                                                        streams["local_time_minute"] =
                                                            int2String(uptable["localTimeMinute"])
                                                        streams["local_time_second"] =
                                                            int2String(uptable["localTimeSecond"])
                                                        ...
                                                        if bodyLength >= 59 then
                                                            streams["e_cleaning_percentage"] =
                                                                int2String(uptable["eCleaningPercentage"])
                                                            streams["drink_valve_equal_open_high"] =
                                                                int2String(uptable["drinkValveEqualOpenHigh"])
                                                            streams["drink_valve_equal_open_low"] =
                                                                int2String(uptable["drinkValveEqualOpenLow"])
                                                            streams["inlet_valve_equal_open_high"] =
                                                                int2String(uptable["inletValveEqualOpenHigh"])
                                                            streams["inlet_valve_equal_open_low"] =
                                                                int2String(uptable["inletValveEqualOpenLow"])
                                                            streams["filter_element_use_percentage"] =
                                                                int2String(uptable["filterElementUsePercentage"])
                                                            streams["ice_maker_times_high"] =
                                                                int2String(uptable["iceMakerTimesHigh"])
                                                            streams["ice_maker_times_low"] =
                                                                int2String(uptable["iceMakerTimesLow"])
                                                            if bodyLength >= 67 then
                                                                streams["lighting_effect"] =
                                                                    int2String(uptable["lightingEffect"])
                                                                streams["lighting_color"] =
                                                                    int2String(uptable["lightingColor"])
                                                                streams["custom_color_R"] =
                                                                    int2String(uptable["customColorR"])
                                                                streams["custom_color_G"] =
                                                                    int2String(uptable["customColorG"])
                                                                streams["custom_color_B"] =
                                                                    int2String(uptable["customColorB"])
                                                                if uptable["turnOffLight"] == 0x01 then
                                                                    streams["turn_off_light"] = "off"
                                                                elseif uptable["turnOffLight"] == 0x00 then
                                                                    streams["turn_off_light"] = "on"
                                                                end
                                                                if uptable["lightBrightness"] == 0x02 then
                                                                    streams["light_brightness"] = "low"
                                                                elseif uptable["lightBrightness"] == 0x00 then
                                                                    streams["light_brightness"] = "high"
                                                                end
                                                                if uptable["sunnyForSevenDays"] == 0x00 then
                                                                    streams["sunny_for_seven_days"] = "off"
                                                                elseif uptable["sunnyForSevenDays"] == 0x04 then
                                                                    streams["sunny_for_seven_days"] = "on"
                                                                end
                                                                if uptable["standbyMode"] == 0x00 then
                                                                    streams["standby_mode"] = "off"
                                                                elseif uptable["standbyMode"] == 0x08 then
                                                                    streams["standby_mode"] = "on"
                                                                end
                                                                if uptable["quickFreezing"] == 0x00 then
                                                                    streams["quick_freezing"] = "off"
                                                                elseif uptable["quickFreezing"] == 0x10 then
                                                                    streams["quick_freezing"] = "on"
                                                                end
                                                                streams["freezing_light_open"] =
                                                                    int2String(uptable["freezingLightOpen"])
                                                                if uptable["freezingLightOpenChose"] == 0x00 then
                                                                    streams["freezing_light_open_chose"] = "off"
                                                                elseif uptable["freezingLightOpenChose"] == 0x20 then
                                                                    streams["freezing_light_open_chose"] = "on"
                                                                end
                                                                if bodyLength >= 72 then
                                                                    streams["wifi_human_induction_value"] =
                                                                        int2String(uptable["wifiHumanInductionValue"])
                                                                    if bodyLength >= 73 then
                                                                        if uptable["teslaHandleSwitchMode"] == 0x01 then
                                                                            streams["tesla_handle_switch_mode"] = "on"
                                                                        elseif
                                                                            uptable["teslaHandleSwitchMode"] == 0x00
                                                                        then
                                                                            streams["tesla_handle_switch_mode"] = "off"
                                                                        end
                                                                        if uptable["fivePreservationMode"] == 0x02 then
                                                                            streams["five_preservation_mode"] = "on"
                                                                        elseif
                                                                            uptable["fivePreservationMode"] == 0x00
                                                                        then
                                                                            streams["five_preservation_mode"] = "off"
                                                                        end
                                                                        if uptable["controlSugarFlag"] == 0x04 then
                                                                            streams["control_sugar_flag"] = "on"
                                                                        elseif uptable["controlSugarFlag"] == 0x00 then
                                                                            streams["control_sugar_flag"] = "off"
                                                                        end
                                                                        if
                                                                            uptable["strongControlSugarFlag"] == 0x08
                                                                        then
                                                                            streams["strong_control_sugar_flag"] = "on"
                                                                        elseif
                                                                            uptable["strongControlSugarFlag"] == 0x00
                                                                        then
                                                                            streams["strong_control_sugar_flag"] = "off"
                                                                        end
                                                                        if uptable["nightLightSwitch"] == 0x10 then
                                                                            streams["night_light_switch"] = "on"
                                                                        elseif uptable["nightLightSwitch"] == 0x00 then
                                                                            streams["night_light_switch"] = "off"
                                                                        end
                                                                        if uptable["openDoorTipsSwitch"] == 0x20 then
                                                                            streams["open_door_tips_switch"] = "on"
                                                                        elseif
                                                                            uptable["openDoorTipsSwitch"] == 0x00
                                                                        then
                                                                            streams["open_door_tips_switch"] = "off"
                                                                        end
                                                                        if uptable["pulseSwitch"] == 0x40 then
                                                                            streams["pulse_switch"] = "on"
                                                                        elseif uptable["pulseSwitch"] == 0x00 then
                                                                            streams["pulse_switch"] = "off"
                                                                        end
                                                                        if uptable["deliveryMode"] == 0x80 then
                                                                            streams["delivery_mode"] = "on"
                                                                        elseif uptable["deliveryMode"] == 0x00 then
                                                                            streams["delivery_mode"] = "off"
                                                                        end
                                                                        if bodyLength >= 74 then
                                                                            streams["sabbath_exit_time"] =
                                                                                int2String(uptable["sabbathExitTime"])
                                                                            if uptable["sabbathMode"] == 0x40 then
                                                                                streams["sabbath_mode"] = "on"
                                                                            elseif uptable["sabbathMode"] == 0x80 then
                                                                                streams["sabbath_mode"] = "off"
                                                                            elseif uptable["sabbathMode"] == 0x00 then
                                                                                streams["sabbath_mode"] = "hold"
                                                                            end
                                                                                ...
                                                                                if bodyLength >= 77 then
                                                                                    ...
                                                                                    if bodyLength >= 78 then
                                                                                        ...
                                                                                        if
                                                                                            ...
                                                                                            == 0x02
                                                                                        then
                                                                                            streams["demand_response_switch"] =
                                                                                                "on"
                                                                                        elseif
                                                                                            uptable["demandResponseSwitch"]
                                                                                            == 0x00
                                                                                        ...
                                                                                        if
                                                                                            ...
                                                                                            == 0x04
                                                                                        then
                                                                                            streams["temporary_deloading_switch"] =
                                                                                                "on"
                                                                                        elseif
                                                                                            uptable["temporaryDeloadingSwitch"]
                                                                                            == 0x00
                                                                                        ...
                                                                                        if
                                                                                            uptable["iceClean"] == 0x08
                                                                                        then
                                                                                            streams["ice_clean"] = "on"
                                                                                        elseif
                                                                                            uptable["iceClean"] == 0x00
                                                                                        then
                                                                                            streams["ice_clean"] = "off"
                                                                                        end
                                                                                    ...
                                                                                    if bodyLength >= 79 then
                                                                                        streams["defrost_maximum_exit_time"] = int2String(
                                                                                            uptable["defrostMaximumExitTime"]
                                                                                        ) * 0.5
                                                                                        streams["demand_response_maximum_exit_time"] = int2String(
                                                                                            uptable["demandResponseMaximumExitTime"]
                                                                                        ) * 0.5
                                                                                    end
                                                                                    if bodyLength >= 80 then
                                                                                        ...
                                                                                        if
                                                                                            ...
                                                                                            == 0x08
                                                                                        then
                                                                                            streams["off_peak_defrost_switch"] =
                                                                                                "on"
                                                                                        elseif
                                                                                            uptable["offPeakDefrostSwitch"]
                                                                                            == 0x00
                                                                                        ...
                                                                                        if bodyLength >= 86 then
                                                                                            ...
                                                                                            if bodyLength >= 87 then
                                                                                                ...
                                                                                                if
                                                                                                    ...
                                                                                                    == 0x08
                                                                                                then
                                                                                                    streams["storage_light_open_chose"] =
                                                                                                        "on"
                                                                                                elseif
                                                                                                    uptable["storageLightOpenChose"]
                                                                                                    == 0x00
                                                                                                ...
                                                                                                if
                                                                                                    ...
                                                                                                    == 0x80
                                                                                                then
                                                                                                    streams["vegetable_freezing_dry"] =
                                                                                                        "on"
                                                                                                elseif
                                                                                                    uptable["vegetableFreezingDry"]
                                                                                                    == 0x00
                                                                                                ...
                                                                                                if bodyLength >= 89 then
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x08
                                                                                                    then
                                                                                                        streams["smart_ai_to_self_select"] =
                                                                                                            "yes"
                                                                                                    elseif
                                                                                                        uptable["smartAiToSelfSelect"]
                                                                                                        == 0x00
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x10
                                                                                                    then
                                                                                                        streams["ai_purine_2nd_estimate"] =
                                                                                                            "process"
                                                                                                    elseif
                                                                                                        uptable["aiPurine2ndEstimate"]
                                                                                                        == 0x00
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x20
                                                                                                    then
                                                                                                        streams["surface_light_mode_select"] =
                                                                                                            "manual"
                                                                                                    elseif
                                                                                                        uptable["surfaceLightModeSelect"]
                                                                                                        == 0x00
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x40
                                                                                                    then
                                                                                                        streams["atmosphere_lamp_mode_select"] =
                                                                                                            "manual"
                                                                                                    elseif
                                                                                                        uptable["atmosphereLampModeSelect"]
                                                                                                        == 0x00
                                                                                                ...
                                                                                                if bodyLength >= 90 then
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x01
                                                                                                    then
                                                                                                        streams["storage_door_auto_open"] =
                                                                                                            "full"
                                                                                                    elseif
                                                                                                        uptable["storageDoorAutoOpen"]
                                                                                                        == 0x00
                                                                                                ...
                                                                                                if bodyLength >= 92 then
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x40
                                                                                                    then
                                                                                                        streams["ice_machine_stop_ice_flag"] =
                                                                                                            "on"
                                                                                                    elseif
                                                                                                        uptable["iceMachineStopIceFlag"]
                                                                                                        == 0x00
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x80
                                                                                                    then
                                                                                                        streams["display_board_mute_flag"] =
                                                                                                            "on"
                                                                                                    elseif
                                                                                                        uptable["displayBoardMuteFlag"]
                                                                                                        == 0x00
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x40
                                                                                                    then
                                                                                                        streams["electronic_clean_smart_mode"] =
                                                                                                            "on"
                                                                                                    elseif
                                                                                                        uptable["electronicCleanSmartMode"]
                                                                                                        == 0x00
                                                                                                ...
                                                                                                if bodyLength >= 96 then
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x80
                                                                                                    then
                                                                                                        streams["divider_support_auto_fill"] =
                                                                                                            "yes"
                                                                                                    elseif
                                                                                                        uptable["dividerSupportAutoFill"]
                                                                                                        == 0x00
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x00
                                                                                                    then
                                                                                                        streams["ice_water_mix_type_morning"] =
                                                                                                            "full"
                                                                                                    elseif
                                                                                                        uptable["iceWaterMixTypeMorning"]
                                                                                                        == 0x10
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x00
                                                                                                    then
                                                                                                        streams["ice_water_mix_type_noon"] =
                                                                                                            "full"
                                                                                                    elseif
                                                                                                        uptable["iceWaterMixTypeNoon"]
                                                                                                        == 0x10
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x00
                                                                                                    then
                                                                                                        streams["ice_water_mix_type_night"] =
                                                                                                            "full"
                                                                                                    elseif
                                                                                                        uptable["iceWaterMixTypeNight"]
                                                                                                        == 0x10
                                                                                                ...
                                                                                                if
                                                                                                    bodyLength >= 100
                                                                                                then
                                                                                                    streams["open_door_warning_time"] =
                                                                                                        int2String(
                                                                                                            uptable["openDoorWarningTime"]
                                                                                                        )
                                                                                                end
                                                                                                ...
                                                                                                then
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x02
                                                                                                    then
                                                                                                        streams["freezer_light_one_minute_flag"] =
                                                                                                            "on"
                                                                                                    elseif
                                                                                                        uptable["freezerLightOneMinuteFlag"]
                                                                                                        == 0x00
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x10
                                                                                                    then
                                                                                                        streams["multi_func_zone_status"] =
                                                                                                            "off"
                                                                                                    elseif
                                                                                                        uptable["multiFuncZoneStatus"]
                                                                                                        == 0x00
                                                                                                ...
                                                                                                then
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x01
                                                                                                    then
                                                                                                        streams["app_smart_selection_mode"] =
                                                                                                            "on"
                                                                                                    elseif
                                                                                                        uptable["appSmartSelectionMode"]
                                                                                                        == 0x00
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x02
                                                                                                    then
                                                                                                        streams["smart_selection_gear_change"] =
                                                                                                            "yes"
                                                                                                    elseif
                                                                                                        uptable["smartSelectionGearChange"]
                                                                                                        == 0x00
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x04
                                                                                                    then
                                                                                                        streams["fridge_constant_temp_humidity"] =
                                                                                                            "on"
                                                                                                    elseif
                                                                                                        uptable["fridgeConstantTempHumidity"]
                                                                                                        == 0x00
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x40
                                                                                                    then
                                                                                                        streams["spherical_ice_mode_select"] =
                                                                                                            "fast"
                                                                                                    elseif
                                                                                                        uptable["sphericalIceModeSelect"]
                                                                                                        == 0x00
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x80
                                                                                                    then
                                                                                                        streams["ice_maker_shape_opention"] =
                                                                                                            "spherical"
                                                                                                    elseif
                                                                                                        uptable["iceMakerShapeOpention"]
                                                                                                        == 0x00
                                                                                                ...
                                                                                                if
                                                                                                    bodyLength >= 104
                                                                                                then
                                                                                                    streams["smart_selection_set_temp"] =
                                                                                                        int2String(
                                                                                                            uptable["smartSelectionSetTemp"]
                                                                                                                - 50
                                                                                                        )
                                                                                                ...
                                                                                                then
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x02
                                                                                                    then
                                                                                                        streams["defrost_completed_state"] =
                                                                                                            "yes"
                                                                                                    else
                                                                                                        streams["defrost_completed_state"] =
                                                                                                            "no"
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        >= 111
                                                                                                    then
                                                                                                        uptable["defrostRemainTime"] = uptable["defrostRemainTimeData111"]
                                                                                                                * 64
                                                                                                            + uptable["defrostRemainTimeData110"]
                                                                                                        if
                                                                                                            uptable["defrostTimeUnit"]
                                                                                                                == 0x02
                                                                                                            or streams["defrost_time_unit"]
                                                                                                                == "double"
                                                                                                        then
                                                                                                            uptable["defrostRemainTime"] = uptable["defrostRemainTime"]
                                                                                                                * 2
                                                                                                        end
                                                                                                    ...
                                                                                                    then
                                                                                                        if
                                                                                                            ...
                                                                                                            or streams["defrost_time_unit"]
                                                                                                                == "double"
                                                                                                        then
                                                                                                            uptable["defrostTimeUserDefined"] = uptable["defrostTimeUserDefined"]
                                                                                                                * 2
                                                                                                        end
                                                                                                        streams["defrost_time_user_defined"] =
                                                                                                            int2String(
                                                                                                                uptable["defrostTimeUserDefined"]
                                                                                                            )
                                                                                                    end
                                                                                                ...
                                                                                                then
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x01
                                                                                                    then
                                                                                                        streams["nfc_signal_board_enabled"] =
                                                                                                            "on"
                                                                                                    elseif
                                                                                                        uptable["nfcSignalBoardEnabled"]
                                                                                                        == 0x00
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x08
                                                                                                    then
                                                                                                        streams["nfc_signal_board_state"] =
                                                                                                            "on"
                                                                                                    elseif
                                                                                                        uptable["nfcSignalBoardState"]
                                                                                                        == 0x00
                                                                                                ...
                                                                                                if
                                                                                                    bodyLength >= 118
                                                                                                then
                                                                                                    streams["wifi_human_induction_far_value"] =
                                                                                                        uptable["wifiHumanInductionFarValue"]
                                                                                                end
                                                                                                if
                                                                                                    bodyLength >= 119
                                                                                                then
                                                                                                    streams["wifi_human_induction_exist_value"] =
                                                                                                        uptable["wifiHumanInductionExistValue"]
                                                                                                end
                                                                                                if
                                                                                                    bodyLength >= 120
                                                                                                then
                                                                                                    streams["range_tracking_short_value"] =
                                                                                                        uptable["rangeTrackingShortValue"]
                                                                                                end
                                                                                                if
                                                                                                    bodyLength >= 121
                                                                                                then
                                                                                                    streams["range_tracking_far_value"] =
                                                                                                        uptable["rangeTrackingFarValue"]
                                                                                                end
                                                                                                if
                                                                                                    bodyLength >= 122
                                                                                                then
                                                                                                    streams["resist_spectrum_symmetry_disturb_ratio"] =
                                                                                                        uptable["resistSpectrumSymmetryDisturbRatio"]
                                                                                                end
                                                                                                if
                                                                                                    bodyLength >= 123
                                                                                                then
                                                                                                    streams["resist_spectrum_symmetry_disturb_num"] =
                                                                                                        uptable["resistSpectrumSymmetryDisturbNum"]
                                                                                                end
                                                                                                if
                                                                                                    bodyLength >= 124
                                                                                                then
                                                                                                    streams["ai_human_induction_similarity_value"] =
                                                                                                        uptable["aiHumanInductionSimilarityValue"]
                                                                                                end
                                                                                                if
                                                                                                    bodyLength >= 127
                                                                                                then
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x80
                                                                                                    then
                                                                                                        streams["door_open_overtime_alarm_switch  "] =
                                                                                                            "on"
                                                                                                    elseif
                                                                                                        uptable["doorOpenOvertimeAlarmSwitch"]
                                                                                                        == 0x00
                                                                                                ...
                                                                                                then
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x01
                                                                                                    then
                                                                                                        streams["basic_power_saving_switch"] =
                                                                                                            "on"
                                                                                                    elseif
                                                                                                        uptable["basicPowerSavingSwitch"]
                                                                                                        == 0x00
                                                                                                    ...
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x02
                                                                                                    then
                                                                                                        streams["power_saving_star_version"] =
                                                                                                            "new"
                                                                                                    elseif
                                                                                                        uptable["powerSavingStarVersion"]
                                                                                                        == 0x00
                                                                                                ...
                                                                                                if
                                                                                                    bodyLength >= 132
                                                                                                then
                                                                                                    streams["internal_deloading_maximum_exit_time"] =
                                                                                                        int2String(
                                                                                                            uptable["internalDeloadingMaximumExitTime"]
                                                                                                                * 2
                                                                                                        )
                                                                                                ...
                                                                                                if
                                                                                                    bodyLength >= 133
                                                                                                then
                                                                                                    streams["smart_denoise_open_hours"] =
                                                                                                        int2String(
                                                                                                            uptable["smartDenoiseOpenHours"]
                                                                                                        )
                                                                                                end
                                                                                                if
                                                                                                    bodyLength >= 134
                                                                                                then
                                                                                                    streams["smart_denoise_open_mins"] =
                                                                                                        int2String(
                                                                                                            uptable["smartDenoiseOpenMins"]
                                                                                                        )
                                                                                                end
                                                                                                ...
                                                                                                then
                                                                                                    if
                                                                                                        ...
                                                                                                        == 0x01
                                                                                                    then
                                                                                                        streams["freezer_elec_powerful_deodorize_switch"] =
                                                                                                            "on"
                                                                                                    elseif
                                                                                                        uptable["freezerElecPowerfulDeodorizeSwitch"]
                                                                                                        == 0x00
                                                                                                ...
                                                                                                if
                                                                                                    bodyLength >= 136
                                                                                                then
                                                                                                    streams["freezer_elec_powerful_deodorize_min_time"] =
                                                                                                        int2String(
                                                                                                            uptable["freezerElecPowerfulDeodorizeMinTime"]
                                                                                                        )
                                                                                                end
                                                                                                if
                                                                                                    bodyLength >= 137
                                                                                                then
                                                                                                    streams["storage_elec_powerful_deodorize_hour_time"] =
                                                                                                        int2String(
                                                                                                            uptable["storageElecPowerfulDeodorizeHourTime"]
                                                                                                        )
                                                                                                end
    ...
    elseif
        (uptable["dataType"] == 0x04 and bodyBytes[0] == 0x01)
        or (uptable["dataType"] == 0x03 and bodyBytes[0] == 0x01)
    then
        if uptable["codeMode"] == 0x01 then
            streams["storage_mode"] = "on"
        elseif uptable["codeMode"] == 0x00 then
        ...
        if uptable["globalFlexTemperature"] ~= nil then
            streams["global_flex_temperature"] = int2String(-12 - uptable["globalFlexTemperature"])
        end
    elseif uptable["dataType"] == 0x04 and bodyBytes[0] == 0x00 then
        ...
        if uptable["purineInhibitDrawerSwitch"] == 0x20 then
            streams["purine_inhibit_drawer_switch"] = "on"
        elseif uptable["purineInhibitDrawerSwitch"] == 0x00 then
            streams["purine_inhibit_drawer_switch"] = "off"
        end
    ...
    elseif uptable["dataType"] == 0x04 and bodyBytes[0] == 0x04 then
        if #bodyBytes >= 6 then
            uptable["humanSensingTriggerState"] = bit.band(bodyBytes[5], 0x80)
            if uptable["humanSensingTriggerState"] == 0x80 then
                streams["human_sensing_trigger_state"] = "yes"
            elseif uptable["humanSensingTriggerState"] == 0x00 then
                streams["human_sensing_trigger_state"] = "no"
            end
        end
    elseif
        (uptable["dataType"] == 0x06 and bodyBytes[0] == 0x01)
        or (uptable["dataType"] == 0x03 and bodyBytes[0] == 0x02)
    then
        if uptable["isError"] == 0x01 then
            streams["is_error"] = "yes"
        elseif uptable["isError"] == 0x00 then
        ...
        if uptable["mcuFiveCommunicationError"] == 0x01 then
            streams["mcu_five_communication_error"] = "yes"
        elseif uptable["mcuFiveCommunicationError"] == 0x00 then
            streams["mcu_five_communication_error"] = "no"
        end
        if uptable["fiveTslCommunicationError"] == 0x02 then
            streams["five_tsl_communication_error"] = "yes"
        elseif uptable["fiveTslCommunicationError"] == 0x00 then
            streams["five_tsl_communication_error"] = "no"
        end
        if uptable["twoTslCommunicationError"] == 0x04 then
            streams["two_tsl_communication_error"] = "yes"
        elseif uptable["twoTslCommunicationError"] == 0x00 then
            streams["two_tsl_communication_error"] = "no"
        end
        if uptable["fiveNOError"] == 0x08 then
            streams["five_N_O_error"] = "yes"
        elseif uptable["fiveNOError"] == 0x00 then
            streams["five_N_O_error"] = "no"
        end
        if uptable["fiveCTError"] == 0x10 then
            streams["five_ct_error"] = "yes"
        elseif uptable["fiveCTError"] == 0x00 then
            streams["five_ct_error"] = "no"
        end
        if uptable["freezerWaterShortageAlarm"] == 0x20 then
            streams["freezer_water_shortage_alarm"] = "yes"
        elseif uptable["freezerWaterShortageAlarm"] == 0x00 then
            streams["freezer_water_shortage_alarm"] = "no"
        end
    end
    local retTable = {}
