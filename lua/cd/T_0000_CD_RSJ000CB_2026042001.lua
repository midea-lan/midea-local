...
local function binToModel(binData)
    ...
    if myTable["dataType"] == 3 or myTable["dataType"] == 5 then
        ...
        if myTable["queryType"] == 1 then
            ...
            if myTable["vacationMode"] == 1 then myTable["vacationMode"] = 16 end
...
function jsonToData(jsonCmd)
    ...
    elseif control then
        ...
        elseif myTable["controlType"] == 2 then
            ...
            bodyBytes[2] = 6
            bodyBytes[3] = bit.bor(
                bit.band(myTable["timer1Effect"], 1),
                bit.band(myTable["timer2Effect"], 2),
                bit.band(myTable["timer3Effect"], 4),
                bit.band(myTable["timer4Effect"], 8),
                bit.band(myTable["timer5Effect"], 16),
                bit.band(myTable["timer6Effect"], 32)
            )
        ...
        elseif myTable["controlType"] == 7 then
            ...
            bodyBytes[1] = 1
            bodyBytes[2] = bit.bor(
                bit.band(myTable["week0timer1Effect"], 1),
                bit.band(myTable["week0timer2Effect"], 2),
                bit.band(myTable["week0timer3Effect"], 4),
                bit.band(myTable["week0timer4Effect"], 8),
                bit.band(myTable["week0timer5Effect"], 16),
                bit.band(myTable["week0timer6Effect"], 32)
            )
            bodyBytes[3] = bit.bor(
                bit.band(myTable["week1timer1Effect"], 1),
                bit.band(myTable["week1timer2Effect"], 2),
                bit.band(myTable["week1timer3Effect"], 4),
                bit.band(myTable["week1timer4Effect"], 8),
                bit.band(myTable["week1timer5Effect"], 16),
                bit.band(myTable["week1timer6Effect"], 32)
            )
            bodyBytes[4] = bit.bor(
                bit.band(myTable["week2timer1Effect"], 1),
                bit.band(myTable["week2timer2Effect"], 2),
                bit.band(myTable["week2timer3Effect"], 4),
                bit.band(myTable["week2timer4Effect"], 8),
                bit.band(myTable["week2timer5Effect"], 16),
                bit.band(myTable["week2timer6Effect"], 32)
            )
            bodyBytes[5] = bit.bor(
                bit.band(myTable["week3timer1Effect"], 1),
                bit.band(myTable["week3timer2Effect"], 2),
                bit.band(myTable["week3timer3Effect"], 4),
                bit.band(myTable["week3timer4Effect"], 8),
                bit.band(myTable["week3timer5Effect"], 16),
                bit.band(myTable["week3timer6Effect"], 32)
            )
            bodyBytes[6] = bit.bor(
                bit.band(myTable["week4timer1Effect"], 1),
                bit.band(myTable["week4timer2Effect"], 2),
                bit.band(myTable["week4timer3Effect"], 4),
                bit.band(myTable["week4timer4Effect"], 8),
                bit.band(myTable["week4timer5Effect"], 16),
                bit.band(myTable["week4timer6Effect"], 32)
            )
            bodyBytes[7] = bit.bor(
                bit.band(myTable["week5timer1Effect"], 1),
                bit.band(myTable["week5timer2Effect"], 2),
                bit.band(myTable["week5timer3Effect"], 4),
                bit.band(myTable["week5timer4Effect"], 8),
                bit.band(myTable["week5timer5Effect"], 16),
                bit.band(myTable["week5timer6Effect"], 32)
            )
            bodyBytes[8] = bit.bor(
                bit.band(myTable["week6timer1Effect"], 1),
                bit.band(myTable["week6timer2Effect"], 2),
                bit.band(myTable["week6timer3Effect"], 4),
                bit.band(myTable["week6timer4Effect"], 8),
                bit.band(myTable["week6timer5Effect"], 16),
                bit.band(myTable["week6timer6Effect"], 32)
            )
...
function dataToJson(jsonCmd)
    ...
    if
        ((myTable["dataType"] == BYTE_AUTO_REPORT) and (msgSubType == 1))
        or ((myTable["dataType"] == BYTE_QUERYL_REQUEST) and (msgSubType == 1))
    then
    ...
    elseif
        ((myTable["dataType"] == BYTE_AUTO_REPORT) and (msgSubType == 2))
        or ((myTable["dataType"] == BYTE_QUERYL_REQUEST) and (msgSubType == 2))
    then
        if myTable["week0timer1Effect"] == 1 then
            streams["week0timer1_effect"] = VALUE_FUNCTION_ON
    ...
    elseif
        ((myTable["dataType"] == BYTE_AUTO_REPORT) and (msgSubType == 3))
        or ((myTable["dataType"] == BYTE_QUERYL_REQUEST) and (msgSubType == 3))
    then
