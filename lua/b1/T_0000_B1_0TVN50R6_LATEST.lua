...
function jsonToData(jsonCmdStr)
    ...
    if control then
        ...
        --普通工作模式控制
            ...
            elseif
                control["hour_inc"] ~= nil
                or control["minute_inc"] ~= nil
                or control["second_inc"] ~= nil
                or control["temp_inc"] ~= nil
            then
                bodyBytes[0] = 0x22
                bodyBytes[1] = 0x03
                bodyBytes[2] = 0xff
                ...
                bodyBytes[18] = 0xff
            elseif
                control["hour_red"] ~= nil
                or control["minute_red"] ~= nil
                or control["second_red"] ~= nil
                or control["temp_red"] ~= nil
            then
                bodyBytes[0] = 0x22
                bodyBytes[1] = 0x05
                bodyBytes[2] = 0xff
                ...
                bodyBytes[18] = 0xff
            elseif
                control["hour_set"] ~= nil
                or control["minute_set"] ~= nil
                or control["second_set"] ~= nil
                or control["temp_set"] ~= nil
            then
                bodyBytes[0] = 0x22
                bodyBytes[1] = 0x04
                bodyBytes[2] = 0xff
...
function cloudtodevice(megBodys)
    ...
    if megBodys[9] == "02" then
        ...
        elseif megBodys[10] == "24" then
            ...
            if megBodys[23] ~= "FF" and megBodys[23] ~= "ff" then jsonTable["work_mode"] = getmodetype(megBodys[23]) end
            if megBodys[25] ~= "FF" and megBodys[25] ~= "ff" then
            ...
            if megBodys[30] ~= "FF" and megBodys[30] ~= "ff" then jsonTable["workend"] = tonumber(megBodys[30], 16) end
    ...
    elseif megBodys[9] == "03" or megBodys[9] == "04" then
        ...
        jsonTable["totalstep"] = math.modf(tonumber(megBodys[15], 16) / 16)
        jsonTable["stepnum"] = math.fmod(tonumber(megBodys[15], 16), 16)
        if megBodys[16] ~= "FF" and megBodys[16] ~= "ff" then jsonTable["work_hour"] = tonumber(megBodys[16], 16) end
        if megBodys[17] ~= "FF" and megBodys[17] ~= "ff" then jsonTable["work_minute"] = tonumber(megBodys[17], 16) end
        if megBodys[18] ~= "FF" and megBodys[18] ~= "ff" then jsonTable["work_second"] = tonumber(megBodys[18], 16) end
        if megBodys[19] ~= "FF" and megBodys[19] ~= "ff" then jsonTable["work_mode"] = getmodetype(megBodys[19]) end
        if megBodys[21] ~= "FF" and megBodys[21] ~= "ff" then
        ...
        if megBodys[25] ~= "FF" and megBodys[25] ~= "ff" then jsonTable["weight"] = tonumber(megBodys[25], 16) * 10 end
        ...
        if water_box == "1" then jsonTable["tips_code"] = 6 end
        if water_state == "1" then jsonTable["tips_code"] = 2 end
        if changewater == "1" then jsonTable["tips_code"] = 7 end
        if preheat == "1" then jsonTable["tips_code"] = 8 end
        if preheatvalue == "1" then jsonTable["tips_code"] = 9 end
        if error_code == "1" then jsonTable["error_code"] = 1 end
        if fanmian == "1" then jsonTable["tips_code"] = 4 end
        if ganying == "1" then jsonTable["work_status"] = "reaction" end
        if ludeng == "1" then
            jsonTable["furnace_light"] = "on"
        ...
        if megBodys[29] ~= "FF" and megBodys[29] ~= "ff" then jsonTable["temperature"] = tonumber(megBodys[29], 16) end
        -- if(megBodys[31]~="FF" and megBodys[31]~="ff") then
