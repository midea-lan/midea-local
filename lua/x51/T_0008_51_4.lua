...
function updateGlobalPropertyValueByJson(luaTable)
    ...
    if luaTable[KEY_TIME_YEAR] ~= nil then timeYear = string2Int(luaTable[KEY_TIME_YEAR]) end
    if luaTable[KEY_TIME_MONTH] ~= nil then timeMonth = string2Int(luaTable[KEY_TIME_MONTH]) end
    if luaTable[KEY_TIME_DAY] ~= nil then timeDay = string2Int(luaTable[KEY_TIME_DAY]) end
    if luaTable[KEY_TIME_HOUR] ~= nil then timeHour = string2Int(luaTable[KEY_TIME_HOUR]) end
    if luaTable[KEY_TIME_MIN] ~= nil then timeMin = string2Int(luaTable[KEY_TIME_MIN]) end
