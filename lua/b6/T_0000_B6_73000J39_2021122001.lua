        ...
        elseif (ctrl.electronic_control_version == 2) then
            ...
            if (ctrl.type == 'b6') then
                ...
                if (ctrl.b6_action == "control") then
                    ...
                    if (ctrl.wisdom_wind_time) then
                        cmd[17] = getNumber(ctrl.wisdom_wind_time)
                    end
                    if (ctrl.wisdom_wind_gear) then
                        cmd[18] = getNumber(ctrl.wisdom_wind_gear)
                    end
                ...
                elseif (ctrl.b6_action == "setting") then
                    ...
                    elseif (ctrl.setting == "prevent_false_touch") then
                        ...
                        cmd[16] = 0xff
                        cmd[17] = 0xff
                        if (ctrl.prevent_false_touch and
                            ctrl.prevent_false_touch == "on") then
                            cmd[15] = 0x01
                            cmd[16] = 0xff
                            cmd[17] = 0xff
                        elseif (ctrl.prevent_false_touch and
                            ctrl.prevent_false_touch == "off") then
                            cmd[15] = 0x00
                            cmd[16] = 0xff
                            cmd[17] = 0xff
                        end
                        if (ctrl.prevent_false_touch_timevalue) then
                            cmd[15] = 0x01
                            local millisecond = getNumber(
                                                    ctrl.prevent_false_touch_timevalue)
                ...
                if (cmd[14] == 2) then
                    ...
                    elseif (cmd[13] == 3 and ctrl.b7_middle_destination_time ~=
                        ...
                        local seconds = getNumber(
                                            ctrl.b7_middle_destination_time)
                        if (seconds < 256 * 256) then
                            cmd[16] = seconds % 256
                            cmd[17] = (seconds - cmd[16]) / 256
                        end
...
local function getB6Json(json, pkg)
    ...
    if (pkg[43] and pkg[44] and pkg[45] and pkg[43] ~= 0xff) then
        ...
        if (pkg[44] ~= 0xff and pkg[45] ~= 0xff) then
            json.prevent_false_touch_time = pkg[44] * 256 + pkg[45]
        end
    end
