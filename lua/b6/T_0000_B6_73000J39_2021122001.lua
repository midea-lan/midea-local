...
local function jsonToCmd(json, cmd)
    ...
    if ctrl then
        if ctrl.electronic_control_version == nil or ctrl.electronic_control_version == 1 then
            cmd[10] = 0x02
            cmd[11] = 0x22
                ...
                if ctrl["light"] then
                    if ctrl["light"] == VALUE_ON then
                        ...
                        if ctrl["lightness"] then
                            ...
                            if lightness ~= 0x00 then cmd[13] = lightness end
                        end
        ...
        elseif ctrl.electronic_control_version == 2 then
            ...
            if ctrl.type == "b6" then
                ...
                if ctrl.b6_action == "control" then
                    cmd[13] = 0x01
                    cmd[14] = 0xff
                    if ctrl.wind_type then cmd[14] = getNumber(ctrl.wind_type) end
                    cmd[15] = 0xff
                    if ctrl.power == "on" or ctrl.work_status == "working" then
                        cmd[15] = 0x02
                        cmd[16] = 0x02
                    elseif ctrl.power == "off" or ctrl.work_status == "power_off" then
                        cmd[15] = 0x01
                    elseif ctrl.power == "delay_off" or ctrl.work_status == "power_off_delay" then
                        cmd[15] = 0x03
                        cmd[16] = 0x01
                    elseif ctrl.steaming == "on" or ctrl.work_status == "hotclean" then
                        cmd[15] = 0x04
                        cmd[16] = 0x01
                    ...
                    elseif ctrl.aidry == "off" then
                        cmd[15] = 0x0a
                        cmd[16] = 0x02
                    elseif ctrl.wisdom_wind == "on" then
                        cmd[15] = 0x0d
                        cmd[16] = 0x01
                        cmd[17] = 0xFF
                        cmd[18] = 0xFF
                    elseif ctrl.wisdom_wind == "off" then
                        cmd[15] = 0x0d
                        cmd[16] = 0x02
                        cmd[17] = 0xFF
                        cmd[18] = 0xFF
                    end
                    if ctrl.wisdom_wind_time then cmd[17] = getNumber(ctrl.wisdom_wind_time) end
                    if ctrl.wisdom_wind_gear then cmd[18] = getNumber(ctrl.wisdom_wind_gear) end
                    if ctrl.gear ~= nil then
                        cmd[15] = 0x02
                        cmd[16] = getNumber(ctrl.gear)
                        if cmd[16] == 0x00 then cmd[15] = 0x01 end
                    end
                elseif ctrl.b6_action == "setting" then
                    ...
                    if ctrl.setting == "power_off_delay" then
                        cmd[16] = 0xff
                        cmd[17] = 0xff
                        if ctrl.power_off_delay_timevalue and getNumber(ctrl.power_off_delay_timevalue) == 0 then
                            cmd[14] = 0x01
                            cmd[15] = 0x00
                        elseif ctrl.power_off_delay_timevalue and getNumber(ctrl.power_off_delay_timevalue) ~= 0 then
                            cmd[14] = 0x01
                            cmd[15] = 0x01
                            cmd[16] = getNumber(ctrl.power_off_delay_timevalue)
                        end
                        if ctrl.power_off_delay_gearvalue and getNumber(ctrl.power_off_delay_gearvalue) ~= 0 then
                    ...
                    elseif ctrl.setting == "light" then
                        ...
                        if ctrl.lightness then cmd[16] = getNumber(ctrl.lightness) end
                    ...
                    elseif ctrl.setting == "gesture" then
                        ...
                        if ctrl.gesture_value and getNumber(ctrl.gesture_value) ~= 0 then
                            cmd[16] = ctrl.gesture_value
                        end
                        if ctrl.gesture_sensitivity_value and getNumber(ctrl.gesture_sensitivity_value) ~= 0 then
                    ...
                    elseif ctrl.setting == "smoke_detector" then
                        ...
                        if ctrl.smoke_detector_value and getNumber(ctrl.smoke_detector_value) == 0 then
                            cmd[14] = 0x04
                            cmd[15] = 0x00
                            cmd[16] = 0xff
                        elseif ctrl.smoke_detector_value and getNumber(ctrl.smoke_detector_value) ~= 0 then
                            cmd[14] = 0x04
                            cmd[15] = 0x01
                    ...
                    elseif ctrl.setting == "ir" then
                        ...
                        if ctrl.ir_value and getNumber(ctrl.ir_value) ~= 0 then cmd[16] = ctrl.ir_value end
                    ...
                    elseif ctrl.setting == "stove_select" then
                        ...
                        if ctrl.stove_select and ctrl.stove_select == "left" then
                            cmd[15] = 0x01
                        elseif ctrl.stove_select and ctrl.stove_select == "right" then
                            cmd[15] = 0x02
                        end
                    elseif ctrl.setting == "stove_time_length" then
                        ...
                        cmd[15] = 0x00
                        cmd[16] = 0x00
                        if ctrl.stove_time_length and getNumber(ctrl.stove_time_length) ~= 0 then
                    ...
                    elseif ctrl.setting == "air_duct_detection" then
                        cmd[14] = 0x0C
                        cmd[15] = 0xff
                        if ctrl.air_duct_detection and ctrl.air_duct_detection == "off" then
                            cmd[15] = 0x02
                        elseif ctrl.air_duct_detection and ctrl.air_duct_detection == "on" then
                            cmd[15] = 0x01
                        end
                    elseif ctrl.setting == "ambient_light" then
                        ...
                        if ctrl.ambient_light and ctrl.ambient_light == "on" then
                            cmd[15] = 0x01
                        elseif ctrl.ambient_light and ctrl.ambient_light == "off" then
                            cmd[15] = 0x00
                        end
                        if ctrl.ambient_lightness then cmd[16] = getNumber(ctrl.ambient_lightness) end
                        if ctrl.ambient_light_on_setting then
                            if getNumber(ctrl.ambient_light_on_setting) == 0x00 then
                                cmd[18] = 0x01
                            elseif getNumber(ctrl.ambient_light_on_setting) == 0x01 then
                                cmd[18] = 0x01
                            elseif getNumber(ctrl.ambient_light_on_setting) == 0x02 then
                                cmd[18] = 0x02
                            end
                        end
                        if ctrl.ambient_light_off_setting then
                            if getNumber(ctrl.ambient_light_off_setting) == 0x00 then
                                cmd[18] = 0x10
                            elseif getNumber(ctrl.ambient_light_off_setting) == 0x01 then
                                cmd[18] = 0x10
                            elseif getNumber(ctrl.ambient_light_off_setting) == 0x02 then
                                cmd[18] = 0x20
                            end
                        end
                    elseif ctrl.setting == "prevent_false_touch" then
                        cmd[14] = 0x0E
                        cmd[15] = 0xff
                        cmd[16] = 0xff
                        cmd[17] = 0xff
                        if ctrl.prevent_false_touch and ctrl.prevent_false_touch == "on" then
                            cmd[15] = 0x01
                            cmd[16] = 0xff
                            cmd[17] = 0xff
                        elseif ctrl.prevent_false_touch and ctrl.prevent_false_touch == "off" then
                            cmd[15] = 0x00
                            cmd[16] = 0xff
                            cmd[17] = 0xff
                        end
                        if ctrl.prevent_false_touch_timevalue then
                            cmd[15] = 0x01
                            local millisecond = getNumber(ctrl.prevent_false_touch_timevalue)
                            if millisecond < 256 * 256 then
                                cmd[17] = millisecond % 256
                                cmd[16] = (millisecond - cmd[17]) / 256
                            end
                        end
                    end
                end
            elseif ctrl.type == "b7" then
                cmd[12] = 0x02
                cmd[13] = 0xff
                if ctrl.b7_work_burner_control ~= nil then cmd[13] = getNumber(ctrl.b7_work_burner_control) end
                cmd[14] = 0xff
                if ctrl.b7_function_control ~= nil then cmd[14] = getNumber(ctrl.b7_function_control) end
                cmd[15] = 0xff
                cmd[16] = 0xff
                cmd[17] = 0xff
                cmd[18] = 0xff
                ...
                if cmd[14] == 2 then
                    ...
                    elseif cmd[13] == 3 and ctrl.b7_middle_destination_time ~= nil then
                        local seconds = getNumber(ctrl.b7_middle_destination_time)
                        if seconds < 256 * 256 then
                            cmd[16] = seconds % 256
                            cmd[17] = (seconds - cmd[16]) / 256
                        end
                ...
                elseif cmd[14] == 3 then
                    ...
                    elseif cmd[13] == 3 and ctrl.b7_middle_destination_time ~= nil then
                        local minute = getNumber(ctrl.b7_middle_destination_time)
                        if minute < 256 * 256 then
                            cmd[17] = minute % 256
                            cmd[16] = (minute - cmd[17]) / 256
                        end
                ...
                elseif cmd[14] == 4 then
                    ...
                    elseif cmd[13] == 2 and ctrl.b7_right_destination_temp ~= nil then
                        local seconds = getNumber(ctrl.b7_right_destination_temp)
                        if seconds < 256 * 256 then
                            cmd[16] = seconds % 256
                            cmd[17] = (seconds - cmd[16]) / 256
                        end
                    elseif cmd[13] == 3 and ctrl.b7_middle_destination_temp ~= nil then
    ...
    elseif query then
        ...
        if query.tips then
            ...
            if query.electronic_control_version == nil or query.electronic_control_version == 1 then
                cmd[11] = 0x31
...
local function getB6Json(json, pkg)
    ...
    if pkg[2] ~= 0xff then
        ...
        elseif pkg[2] == 0x0d then
            json.work_status_desc = "wisdom_wind"
            json.wisdom_wind = VALUE_ON
        end
    end
    ...
    if pkg[14] ~= 0xff then
        if pkg[14] < 0x80 then
            ...
            json.gesture_value = getNumber(pkg[14]) % 16
            json.gesture_sensitivity_value = math.floor(getNumber(pkg[14]) / 16) - 8
        end
    end
    if pkg[15] ~= 0xff then json.destination_time = pkg[15] end
    if pkg[16] ~= 0xff then json.remaining_time = pkg[16] end
    if pkg[17] ~= 0xff then json.total_working_time = pkg[17] * 256 + pkg[18] end
    ...
    if pkg[28] ~= nil and pkg[29] ~= nil and pkg[28] ~= 0xff then json.wind_pressure = pkg[28] * 256 + pkg[29] end
    ...
    if pkg[35] and pkg[36] and pkg[35] ~= 0xff then json.temperature = pkg[35] * 256 + pkg[36] end
    if pkg[37] and pkg[38] and pkg[37] ~= 0xff then json.humidity = pkg[37] * 256 + pkg[38] end
    ...
    if pkg[43] and pkg[44] and pkg[45] and pkg[43] ~= 0xff then
        if pkg[43] ~= 0xff then
            if pkg[43] == 0x00 then
                json.prevent_false_touch = VALUE_OFF
            else
                json.prevent_false_touch = VALUE_ON
            end
        end
        if pkg[44] ~= 0xff and pkg[45] ~= 0xff then json.prevent_false_touch_time = pkg[44] * 256 + pkg[45] end
    end
    if pkg[48] and pkg[49] ~= 0xff then
        json.wisdom_wind_time = pkg[48]
        json.wisdom_wind_gear = pkg[49]
    end
    return json
end
local function getB7Json(json, pkg)
    ...
    if pkg[1] == 0x01 then
        ...
        if pkg[4] ~= 0xff and pkg[5] ~= 0xff then json.b7_left_destination_time = pkg[4] * 256 + pkg[5] end
        if pkg[6] ~= 0xff and pkg[7] ~= 0xff then
            json.b7_left_remaining_time = pkg[6] * 256 + pkg[7]
            if json.b7_left_remaining_time > 0 then json.b7_left_status = "power_off_delay" end
        end
        if pkg[8] ~= 0xff and pkg[9] ~= 0xff then json.b7_left_work_time = pkg[8] * 256 + pkg[9] end
    ...
    elseif pkg[1] == 0x02 then
        ...
        if pkg[4] ~= 0xff and pkg[5] ~= 0xff then json.b7_right_destination_time = pkg[4] * 256 + pkg[5] end
        if pkg[6] ~= 0xff and pkg[7] ~= 0xff then
            json.b7_right_remaining_time = pkg[6] * 256 + pkg[7]
            if json.b7_right_remaining_time > 0 then json.b7_right_status = "power_off_delay" end
        end
        if pkg[8] ~= 0xff and pkg[9] ~= 0xff then json.b7_right_work_time = pkg[8] * 256 + pkg[9] end
    ...
    elseif pkg[1] == 0x03 then
        ...
        if pkg[4] ~= 0xff and pkg[5] ~= 0xff then json.b7_middle_destination_time = pkg[4] * 256 + pkg[5] end
        if pkg[6] ~= 0xff and pkg[7] ~= 0xff then
            json.b7_middle_remaining_time = pkg[6] * 256 + pkg[7]
            if json.b7_middle_remaining_time > 0 then json.b7_middle_status = "power_off_delay" end
        end
        if pkg[8] ~= 0xff and pkg[9] ~= 0xff then json.b7_middle_work_time = pkg[8] * 256 + pkg[9] end
...
local function queryAllCmdToJson(json, cmd)
    if cmd[9] == 0 or cmd[9] == 1 then
        ...
        if cmd[13] == 0x06 and cmd[32] and cmd[32] ~= 0xff then json["hotclean_minutes"] = cmd[32] end
        if cmd[13] == 0x16 and cmd[35] + cmd[36] ~= 0 then json["wind_pressure"] = cmd[35] * 256 + cmd[36] end
        json["volume"] = 0
...
local function cmdToJson(json, cmd)
    ...
    if cmd[10] == 0x02 then
        if cmd[11] == 0x22 then
            ...
            elseif cmd[12] == 0x02 then
                if cmd[13] ~= 0x00 then
                    if cmd[13] >= 128 then cmd[13] = cmd[13] - 0xff - 0x01 end
                    json["volume_inc"] = cmd[13]
                end
                if cmd[14] ~= 0x00 then
                    if cmd[14] >= 128 then cmd[14] = cmd[14] - 0xff - 0x01 end
                    json["gear_inc"] = cmd[14]
                end
            elseif cmd[12] == 0xFE then
                json["ctrl_fail"] = "1"
                if cmd[14] ~= 0x00 then json["ctrl_fail_reason"] = cmd[14] end
            end
            ...
            if cmd[12] == 0x01 then
                if cmd[13] == 0x01 then
                    ...
                    elseif cmd[15] == 0x02 then
                        json.power = VALUE_ON
                        json.work_status_desc = "working"
                        if cmd[16] ~= 0xFF then json.gear = cmd[16] end
                ...
                elseif cmd[13] == 0x02 then
                    if cmd[14] == 0x01 then
                        ...
                        elseif cmd[15] ~= 0x00 then
                            ...
                            if cmd[17] ~= 0x00 and cmd[17] ~= 0xff then json.power_off_delay_gearvalue = cmd[17] end
                        end
                    elseif cmd[14] == 0x02 then
                        if cmd[15] == 0x00 then
                            json.light = "off"
                        ...
                        if cmd[16] ~= 0x00 and cmd[16] ~= 0xff then json.lightness = cmd[16] end
                        if cmd[18] ~= 0xff then
                            json.light_on_setting = getNumber(cmd[18]) % 16
                            json.light_off_setting = math.floor(getNumber(cmd[18]) / 16)
                        end
                    elseif cmd[14] == 0x03 then
                        ...
                        elseif cmd[15] == 0x01 then
                            json.gesture = VALUE_ON
                            if cmd[16] ~= 0x00 and cmd[16] ~= 0xff then json.gesture_value = cmd[16] end
                            if cmd[17] ~= 0x00 and cmd[17] ~= 0xff then json.gesture_sensitivity_value = cmd[17] end
                        end
                    elseif cmd[14] == 0x04 then
                        if cmd[15] == 0x00 then
                            json.smoke_detector = VALUE_OFF
                        ...
                        elseif cmd[15] == 0x01 then
                            json.smoke_detector = VALUE_ON
                            if cmd[16] ~= 0x00 and cmd[16] ~= 0xff then json.smoke_detector_value = cmd[16] end
                        end
                    elseif cmd[14] == 0x05 then
                        ...
                        elseif cmd[15] == 0x01 then
                            json.ir = VALUE_ON
                            if cmd[16] ~= 0x00 and cmd[16] ~= 0xff then json.ir_value = cmd[16] end
                        end
                    ...
                    elseif cmd[14] == 0x0A then
                        if cmd[15] ~= 0xFF and cmd[16] ~= 0xFF then json.stove_time_length = cmd[16] end
                    ...
                    elseif cmd[14] == 0x0D then
                        ...
                        if cmd[16] ~= 0x00 and cmd[16] ~= 0xff then json.ambient_lightness = cmd[16] end
                        if cmd[18] ~= 0xff then
                            json.ambient_light_on_setting = getNumber(cmd[18]) % 16
                            json.ambient_light_off_setting = math.floor(getNumber(cmd[18]) / 16)
                        end
                    end
                end
            elseif cmd[12] == 0x02 then
                if cmd[13] == 0x01 then
                    ...
                    elseif cmd[14] == 0x03 then
                        json.b7_left_status = "power_off_delay"
                        if cmd[16] ~= 0xff then
                            json.b7_left_destination_time = cmd[16] * 256 + cmd[17]
                            json.b7_left_remaining_time = json.b7_left_destination_time
                        end
                    elseif cmd[14] == 0x04 then
                        json.b7_left_status = "temp"
                        if cmd[16] ~= 0xff then json.b7_left_destination_temp = cmd[16] * 256 + cmd[17] end
                    end
                    if cmd[15] ~= 0xff then json.b7_left_gear = cmd[15] end
                elseif cmd[13] == 0x02 then
                    if cmd[14] == 0x01 then
                        json.b7_right_status = "power_off"
                    elseif cmd[14] == 0x02 then
                    ...
                    elseif cmd[14] == 0x03 then
                        json.b7_right_status = "power_off_delay"
                        if cmd[16] ~= 0xff then
                            json.b7_right_destination_time = cmd[16] * 256 + cmd[17]
                            json.b7_right_remaining_time = json.b7_right_destination_time
                        end
                    elseif cmd[14] == 0x04 then
                        json.b7_right_status = "temp"
                        if cmd[16] ~= 0xff then json.b7_right_destination_temp = cmd[16] * 256 + cmd[17] end
                    end
                    if cmd[15] ~= 0xff then json.b7_right_gear = cmd[15] end
                elseif cmd[13] == 0x03 then
                    if cmd[14] == 0x01 then
                        json.b7_middle_status = "power_off"
                    elseif cmd[14] == 0x02 then
                    ...
                    elseif cmd[14] == 0x03 then
                        json.b7_middle_status = "power_off_delay"
                        if cmd[16] ~= 0xff then
                            json.b7_middle_destination_time = cmd[16] * 256 + cmd[17]
                            json.b7_middle_remaining_time = json.b7_middle_destination_time
                        end
                    elseif cmd[14] == 0x04 then
                        json.b7_middle_status = "temp"
                        if cmd[16] ~= 0xff then json.b7_middle_destination_temp = cmd[16] * 256 + cmd[17] end
                    end
                    if cmd[15] ~= 0xff then json.b7_middle_gear = cmd[15] end
                end
            end
        end
    ...
    elseif cmd[10] == 0x0A and cmd[11] == 0xA1 then
        if getBit(cmd[12], 2) == "1" then json["error_type"] = "sensor_error" end
        if getBit(cmd[13], 0) == "1" then json["error_type"] = "hotclean_error" end
        if getBit(cmd[13], 1) == "1" then json["error_type"] = "split_error" end
        if cmd[14] ~= 0 or cmd[15] ~= 0 then json["error_type"] = "inverter_error" end
    end
    return json
end
