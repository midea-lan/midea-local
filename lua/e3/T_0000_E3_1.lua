...
local function cmdToJson(json, cmd)
    ...
    elseif (cmd[10] == 0x02 and cmd[11] == 0x14) or (cmd[10] == 0x03 and cmd[11] == 0x02) then
    ...
    elseif cmd[10] == 0x03 and cmd[11] == 0x03 then
        ...
        json["fire_time_amount"] = getNumber(cmd[26]) * 10000 + getNumber(cmd[27]) * 100 + getNumber(cmd[28])
        json["fire_duration_amount"] = getNumber(cmd[29]) * 10000 + getNumber(cmd[30]) * 100 + getNumber(cmd[31])
    end
    return json
end
