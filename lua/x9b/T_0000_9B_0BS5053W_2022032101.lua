...
local function deviceToCloud(megBodys)
    ...
    if megBodys[9] == "02" or megBodys[9] == "03" or megBodys[9] == "04" then
        ...
        if megBodys[19] ~= "FF" and megBodys[19] ~= "ff" then jsonTable["hour_set"] = tonumber(megBodys[19], 16) end
        if megBodys[20] ~= "FF" and megBodys[20] ~= "ff" then jsonTable["minute_set"] = tonumber(megBodys[20], 16) end
        if megBodys[21] ~= "FF" and megBodys[21] ~= "ff" then jsonTable["second_set"] = tonumber(megBodys[21], 16) end
        ...
        if megBodys[32] ~= "FF" and megBodys[32] ~= "ff" then jsonTable["work_hour"] = tonumber(megBodys[32], 16) end
        if megBodys[33] ~= "FF" and megBodys[33] ~= "ff" then jsonTable["work_minute"] = tonumber(megBodys[33], 16) end
        if megBodys[34] ~= "FF" and megBodys[34] ~= "ff" then jsonTable["work_second"] = tonumber(megBodys[34], 16) end
