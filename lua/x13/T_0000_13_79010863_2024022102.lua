...
local function updateGlobalPropertyValueByJson(luaTable)
    ...
    if luaTable[keytable["KEY_CONST_TEMP_VALUE"]] ~= nil then
        valuetable["CONSTTMEPVALUE"] = string2Int(luaTable[keytable["KEY_CONST_TEMP_VALUE"]])
    end
    ...
    if luaTable[keytable["KEY_DELAY_FAN_OFF"]] ~= nil then
        valuetable["DELAYFANOFF"] = string2Int(luaTable[keytable["KEY_DELAY_FAN_OFF"]])
    end
    if luaTable[keytable["KEY_ARROUND_DIR"]] ~= nil then
        valuetable["ARROUNDDIR"] = string2Int(luaTable[keytable["KEY_ARROUND_DIR"]])
    end
    ...
    if luaTable[keytable["KEY_TEMPERATURE_MIN"]] ~= nil then
        valuetable["TEMPERATURE_MIN"] = string2Int(luaTable[keytable["KEY_TEMPERATURE_MIN"]])
    end
    if luaTable[keytable["KEY_TEMPERATURE_MAX"]] ~= nil then
        valuetable["TEMPERATURE_MAX"] = string2Int(luaTable[keytable["KEY_TEMPERATURE_MAX"]])
    end
    if luaTable[keytable["KEY_LED_TIME_ONOFF_1"]] ~= nil then
        valuetable["LED_TIME_OF_HOUR_1"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_1"]], 1, 2))
        valuetable["LED_TIME_OF_MINUTE_1"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_1"]], 3, 4))
    end
    if luaTable[keytable["KEY_LED_MONDAY_ENDIS_1"]] ~= nil then
        if luaTable[keytable["KEY_LED_MONDAY_ENDIS_1"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_1"] = bit.bor(valuetable["LED_WEEK_EN_DIS_1"], 0x02)
        else
            valuetable["LED_WEEK_EN_DIS_1"] = bit.band(valuetable["LED_WEEK_EN_DIS_1"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_1"]] ~= nil then
        if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_1"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_1"] = bit.bor(valuetable["LED_WEEK_EN_DIS_1"], 0x04)
        else
            valuetable["LED_WEEK_EN_DIS_1"] = bit.band(valuetable["LED_WEEK_EN_DIS_1"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_1"]] ~= nil then
        if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_1"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_1"] = bit.bor(valuetable["LED_WEEK_EN_DIS_1"], 0x08)
        else
            valuetable["LED_WEEK_EN_DIS_1"] = bit.band(valuetable["LED_WEEK_EN_DIS_1"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_1"]] ~= nil then
        if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_1"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_1"] = bit.bor(valuetable["LED_WEEK_EN_DIS_1"], 0x10)
        else
            valuetable["LED_WEEK_EN_DIS_1"] = bit.band(valuetable["LED_WEEK_EN_DIS_1"], 0xef)
        end
    end
    if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_1"]] ~= nil then
        if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_1"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_1"] = bit.bor(valuetable["LED_WEEK_EN_DIS_1"], 0x20)
        else
            valuetable["LED_WEEK_EN_DIS_1"] = bit.band(valuetable["LED_WEEK_EN_DIS_1"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_1"]] ~= nil then
        if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_1"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_1"] = bit.bor(valuetable["LED_WEEK_EN_DIS_1"], 0x40)
        else
            valuetable["LED_WEEK_EN_DIS_1"] = bit.band(valuetable["LED_WEEK_EN_DIS_1"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_1"]] ~= nil then
        if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_1"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_1"] = bit.bor(valuetable["LED_WEEK_EN_DIS_1"], 0x01)
        else
            valuetable["LED_WEEK_EN_DIS_1"] = bit.band(valuetable["LED_WEEK_EN_DIS_1"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_LED_CTRL_ONOFF_1"]] ~= nil then
        if luaTable[keytable["KEY_LED_CTRL_ONOFF_1"]] == "1" then
            valuetable["LED_CTRL_ONOFF_1"] = bit.bor(valuetable["LED_CTRL_ONOFF_1"], 0x80)
        else
            valuetable["LED_CTRL_ONOFF_1"] = bit.band(valuetable["LED_CTRL_ONOFF_1"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_ENABLE_TIMEING_1"]] ~= nil then
        if luaTable[keytable["KEY_LED_ENABLE_TIMEING_1"]] == "1" then
            valuetable["LED_ENABLE_TIMEING_1"] = bit.bor(valuetable["LED_ENABLE_TIMEING_1"], 0x80)
        else
            valuetable["LED_ENABLE_TIMEING_1"] = bit.band(valuetable["LED_ENABLE_TIMEING_1"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_TIME_ONOFF_2"]] ~= nil then
        valuetable["LED_TIME_OF_HOUR_2"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_2"]], 1, 2))
        valuetable["LED_TIME_OF_MINUTE_2"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_2"]], 3, 4))
    end
    if luaTable[keytable["KEY_LED_MONDAY_ENDIS_2"]] ~= nil then
        if luaTable[keytable["KEY_LED_MONDAY_ENDIS_2"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_2"] = bit.bor(valuetable["LED_WEEK_EN_DIS_2"], 0x02)
        else
            valuetable["LED_WEEK_EN_DIS_2"] = bit.band(valuetable["LED_WEEK_EN_DIS_2"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_2"]] ~= nil then
        if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_2"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_2"] = bit.bor(valuetable["LED_WEEK_EN_DIS_2"], 0x04)
        else
            valuetable["LED_WEEK_EN_DIS_2"] = bit.band(valuetable["LED_WEEK_EN_DIS_2"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_2"]] ~= nil then
        if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_2"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_2"] = bit.bor(valuetable["LED_WEEK_EN_DIS_2"], 0x08)
        else
            valuetable["LED_WEEK_EN_DIS_2"] = bit.band(valuetable["LED_WEEK_EN_DIS_2"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_2"]] ~= nil then
        if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_2"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_2"] = bit.bor(valuetable["LED_WEEK_EN_DIS_2"], 0x10)
        else
            valuetable["LED_WEEK_EN_DIS_2"] = bit.band(valuetable["LED_WEEK_EN_DIS_2"], 0xef)
        end
    end
    if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_2"]] ~= nil then
        if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_2"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_2"] = bit.bor(valuetable["LED_WEEK_EN_DIS_2"], 0x20)
        else
            valuetable["LED_WEEK_EN_DIS_2"] = bit.band(valuetable["LED_WEEK_EN_DIS_2"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_2"]] ~= nil then
        if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_2"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_2"] = bit.bor(valuetable["LED_WEEK_EN_DIS_2"], 0x40)
        else
            valuetable["LED_WEEK_EN_DIS_2"] = bit.band(valuetable["LED_WEEK_EN_DIS_2"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_2"]] ~= nil then
        if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_2"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_2"] = bit.bor(valuetable["LED_WEEK_EN_DIS_2"], 0x01)
        else
            valuetable["LED_WEEK_EN_DIS_2"] = bit.band(valuetable["LED_WEEK_EN_DIS_2"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_LED_CTRL_ONOFF_2"]] ~= nil then
        if luaTable[keytable["KEY_LED_CTRL_ONOFF_2"]] == "1" then
            valuetable["LED_CTRL_ONOFF_2"] = bit.bor(valuetable["LED_CTRL_ONOFF_2"], 0x80)
        else
            valuetable["LED_CTRL_ONOFF_2"] = bit.band(valuetable["LED_CTRL_ONOFF_2"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_ENABLE_TIMEING_2"]] ~= nil then
        if luaTable[keytable["KEY_LED_ENABLE_TIMEING_2"]] == "1" then
            valuetable["LED_ENABLE_TIMEING_2"] = bit.bor(valuetable["LED_ENABLE_TIMEING_2"], 0x80)
        else
            valuetable["LED_ENABLE_TIMEING_2"] = bit.band(valuetable["LED_ENABLE_TIMEING_2"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_TIME_ONOFF_3"]] ~= nil then
        valuetable["LED_TIME_OF_HOUR_3"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_3"]], 1, 2))
        valuetable["LED_TIME_OF_MINUTE_3"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_3"]], 3, 4))
    end
    if luaTable[keytable["KEY_LED_MONDAY_ENDIS_3"]] ~= nil then
        if luaTable[keytable["KEY_LED_MONDAY_ENDIS_3"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_3"] = bit.bor(valuetable["LED_WEEK_EN_DIS_3"], 0x02)
        else
            valuetable["LED_WEEK_EN_DIS_3"] = bit.band(valuetable["LED_WEEK_EN_DIS_3"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_3"]] ~= nil then
        if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_3"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_3"] = bit.bor(valuetable["LED_WEEK_EN_DIS_3"], 0x04)
        else
            valuetable["LED_WEEK_EN_DIS_3"] = bit.band(valuetable["LED_WEEK_EN_DIS_3"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_3"]] ~= nil then
        if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_3"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_3"] = bit.bor(valuetable["LED_WEEK_EN_DIS_3"], 0x08)
        else
            valuetable["LED_WEEK_EN_DIS_3"] = bit.band(valuetable["LED_WEEK_EN_DIS_3"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_3"]] ~= nil then
        if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_3"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_3"] = bit.bor(valuetable["LED_WEEK_EN_DIS_3"], 0x10)
        else
            valuetable["LED_WEEK_EN_DIS_3"] = bit.band(valuetable["LED_WEEK_EN_DIS_3"], 0xef)
        end
    end
    if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_3"]] ~= nil then
        if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_3"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_3"] = bit.bor(valuetable["LED_WEEK_EN_DIS_3"], 0x20)
        else
            valuetable["LED_WEEK_EN_DIS_3"] = bit.band(valuetable["LED_WEEK_EN_DIS_3"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_3"]] ~= nil then
        if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_3"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_3"] = bit.bor(valuetable["LED_WEEK_EN_DIS_3"], 0x40)
        else
            valuetable["LED_WEEK_EN_DIS_3"] = bit.band(valuetable["LED_WEEK_EN_DIS_3"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_3"]] ~= nil then
        if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_3"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_3"] = bit.bor(valuetable["LED_WEEK_EN_DIS_3"], 0x01)
        else
            valuetable["LED_WEEK_EN_DIS_3"] = bit.band(valuetable["LED_WEEK_EN_DIS_3"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_LED_CTRL_ONOFF_3"]] ~= nil then
        if luaTable[keytable["KEY_LED_CTRL_ONOFF_3"]] == "1" then
            valuetable["LED_CTRL_ONOFF_3"] = bit.bor(valuetable["LED_CTRL_ONOFF_3"], 0x80)
        else
            valuetable["LED_CTRL_ONOFF_3"] = bit.band(valuetable["LED_CTRL_ONOFF_3"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_ENABLE_TIMEING_3"]] ~= nil then
        if luaTable[keytable["KEY_LED_ENABLE_TIMEING_3"]] == "1" then
            valuetable["LED_ENABLE_TIMEING_3"] = bit.bor(valuetable["LED_ENABLE_TIMEING_3"], 0x80)
        else
            valuetable["LED_ENABLE_TIMEING_3"] = bit.band(valuetable["LED_ENABLE_TIMEING_3"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_TIME_ONOFF_4"]] ~= nil then
        valuetable["LED_TIME_OF_HOUR_4"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_4"]], 1, 2))
        valuetable["LED_TIME_OF_MINUTE_4"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_4"]], 3, 4))
    end
    if luaTable[keytable["KEY_LED_MONDAY_ENDIS_4"]] ~= nil then
        if luaTable[keytable["KEY_LED_MONDAY_ENDIS_4"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_4"] = bit.bor(valuetable["LED_WEEK_EN_DIS_4"], 0x02)
        else
            valuetable["LED_WEEK_EN_DIS_4"] = bit.band(valuetable["LED_WEEK_EN_DIS_4"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_4"]] ~= nil then
        if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_4"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_4"] = bit.bor(valuetable["LED_WEEK_EN_DIS_4"], 0x04)
        else
            valuetable["LED_WEEK_EN_DIS_4"] = bit.band(valuetable["LED_WEEK_EN_DIS_4"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_4"]] ~= nil then
        if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_4"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_4"] = bit.bor(valuetable["LED_WEEK_EN_DIS_4"], 0x08)
        else
            valuetable["LED_WEEK_EN_DIS_4"] = bit.band(valuetable["LED_WEEK_EN_DIS_4"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_4"]] ~= nil then
        if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_4"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_4"] = bit.bor(valuetable["LED_WEEK_EN_DIS_4"], 0x10)
        else
            valuetable["LED_WEEK_EN_DIS_4"] = bit.band(valuetable["LED_WEEK_EN_DIS_4"], 0xef)
        end
    end
    if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_4"]] ~= nil then
        if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_4"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_4"] = bit.bor(valuetable["LED_WEEK_EN_DIS_4"], 0x20)
        else
            valuetable["LED_WEEK_EN_DIS_4"] = bit.band(valuetable["LED_WEEK_EN_DIS_4"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_4"]] ~= nil then
        if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_4"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_4"] = bit.bor(valuetable["LED_WEEK_EN_DIS_4"], 0x40)
        else
            valuetable["LED_WEEK_EN_DIS_4"] = bit.band(valuetable["LED_WEEK_EN_DIS_4"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_4"]] ~= nil then
        if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_4"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_4"] = bit.bor(valuetable["LED_WEEK_EN_DIS_4"], 0x01)
        else
            valuetable["LED_WEEK_EN_DIS_4"] = bit.band(valuetable["LED_WEEK_EN_DIS_4"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_LED_CTRL_ONOFF_4"]] ~= nil then
        if luaTable[keytable["KEY_LED_CTRL_ONOFF_4"]] == "1" then
            valuetable["LED_CTRL_ONOFF_4"] = bit.bor(valuetable["LED_CTRL_ONOFF_4"], 0x80)
        else
            valuetable["LED_CTRL_ONOFF_4"] = bit.band(valuetable["LED_CTRL_ONOFF_4"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_ENABLE_TIMEING_4"]] ~= nil then
        if luaTable[keytable["KEY_LED_ENABLE_TIMEING_4"]] == "1" then
            valuetable["LED_ENABLE_TIMEING_4"] = bit.bor(valuetable["LED_ENABLE_TIMEING_4"], 0x80)
        else
            valuetable["LED_ENABLE_TIMEING_4"] = bit.band(valuetable["LED_ENABLE_TIMEING_4"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_TIME_ONOFF_5"]] ~= nil then
        valuetable["LED_TIME_OF_HOUR_5"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_5"]], 1, 2))
        valuetable["LED_TIME_OF_MINUTE_5"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_5"]], 3, 4))
    end
    if luaTable[keytable["KEY_LED_MONDAY_ENDIS_5"]] ~= nil then
        if luaTable[keytable["KEY_LED_MONDAY_ENDIS_5"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_5"] = bit.bor(valuetable["LED_WEEK_EN_DIS_5"], 0x02)
        else
            valuetable["LED_WEEK_EN_DIS_5"] = bit.band(valuetable["LED_WEEK_EN_DIS_5"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_5"]] ~= nil then
        if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_5"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_5"] = bit.bor(valuetable["LED_WEEK_EN_DIS_5"], 0x04)
        else
            valuetable["LED_WEEK_EN_DIS_5"] = bit.band(valuetable["LED_WEEK_EN_DIS_5"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_5"]] ~= nil then
        if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_5"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_5"] = bit.bor(valuetable["LED_WEEK_EN_DIS_5"], 0x08)
        else
            valuetable["LED_WEEK_EN_DIS_5"] = bit.band(valuetable["LED_WEEK_EN_DIS_5"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_5"]] ~= nil then
        if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_5"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_5"] = bit.bor(valuetable["LED_WEEK_EN_DIS_5"], 0x10)
        else
            valuetable["LED_WEEK_EN_DIS_5"] = bit.band(valuetable["LED_WEEK_EN_DIS_5"], 0xef)
        end
    end
    if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_5"]] ~= nil then
        if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_5"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_5"] = bit.bor(valuetable["LED_WEEK_EN_DIS_5"], 0x20)
        else
            valuetable["LED_WEEK_EN_DIS_5"] = bit.band(valuetable["LED_WEEK_EN_DIS_5"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_5"]] ~= nil then
        if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_5"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_5"] = bit.bor(valuetable["LED_WEEK_EN_DIS_5"], 0x40)
        else
            valuetable["LED_WEEK_EN_DIS_5"] = bit.band(valuetable["LED_WEEK_EN_DIS_5"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_5"]] ~= nil then
        if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_5"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_5"] = bit.bor(valuetable["LED_WEEK_EN_DIS_5"], 0x01)
        else
            valuetable["LED_WEEK_EN_DIS_5"] = bit.band(valuetable["LED_WEEK_EN_DIS_5"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_LED_CTRL_ONOFF_5"]] ~= nil then
        if luaTable[keytable["KEY_LED_CTRL_ONOFF_5"]] == "1" then
            valuetable["LED_CTRL_ONOFF_5"] = bit.bor(valuetable["LED_CTRL_ONOFF_5"], 0x80)
        else
            valuetable["LED_CTRL_ONOFF_5"] = bit.band(valuetable["LED_CTRL_ONOFF_5"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_ENABLE_TIMEING_5"]] ~= nil then
        if luaTable[keytable["KEY_LED_ENABLE_TIMEING_5"]] == "1" then
            valuetable["LED_ENABLE_TIMEING_5"] = bit.bor(valuetable["LED_ENABLE_TIMEING_5"], 0x80)
        else
            valuetable["LED_ENABLE_TIMEING_5"] = bit.band(valuetable["LED_ENABLE_TIMEING_5"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_TIME_ONOFF_6"]] ~= nil then
        valuetable["LED_TIME_OF_HOUR_6"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_6"]], 1, 2))
        valuetable["LED_TIME_OF_MINUTE_6"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_6"]], 3, 4))
    end
    if luaTable[keytable["KEY_LED_MONDAY_ENDIS_6"]] ~= nil then
        if luaTable[keytable["KEY_LED_MONDAY_ENDIS_6"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_6"] = bit.bor(valuetable["LED_WEEK_EN_DIS_6"], 0x02)
        else
            valuetable["LED_WEEK_EN_DIS_6"] = bit.band(valuetable["LED_WEEK_EN_DIS_6"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_6"]] ~= nil then
        if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_6"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_6"] = bit.bor(valuetable["LED_WEEK_EN_DIS_6"], 0x04)
        else
            valuetable["LED_WEEK_EN_DIS_6"] = bit.band(valuetable["LED_WEEK_EN_DIS_6"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_6"]] ~= nil then
        if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_6"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_6"] = bit.bor(valuetable["LED_WEEK_EN_DIS_6"], 0x08)
        else
            valuetable["LED_WEEK_EN_DIS_6"] = bit.band(valuetable["LED_WEEK_EN_DIS_6"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_6"]] ~= nil then
        if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_6"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_6"] = bit.bor(valuetable["LED_WEEK_EN_DIS_6"], 0x10)
        else
            valuetable["LED_WEEK_EN_DIS_6"] = bit.band(valuetable["LED_WEEK_EN_DIS_6"], 0xef)
        end
    end
    if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_6"]] ~= nil then
        if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_6"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_6"] = bit.bor(valuetable["LED_WEEK_EN_DIS_6"], 0x20)
        else
            valuetable["LED_WEEK_EN_DIS_6"] = bit.band(valuetable["LED_WEEK_EN_DIS_6"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_6"]] ~= nil then
        if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_6"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_6"] = bit.bor(valuetable["LED_WEEK_EN_DIS_6"], 0x40)
        else
            valuetable["LED_WEEK_EN_DIS_6"] = bit.band(valuetable["LED_WEEK_EN_DIS_6"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_6"]] ~= nil then
        if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_6"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_6"] = bit.bor(valuetable["LED_WEEK_EN_DIS_6"], 0x01)
        else
            valuetable["LED_WEEK_EN_DIS_6"] = bit.band(valuetable["LED_WEEK_EN_DIS_6"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_LED_CTRL_ONOFF_6"]] ~= nil then
        if luaTable[keytable["KEY_LED_CTRL_ONOFF_6"]] == "1" then
            valuetable["LED_CTRL_ONOFF_6"] = bit.bor(valuetable["LED_CTRL_ONOFF_6"], 0x80)
        else
            valuetable["LED_CTRL_ONOFF_6"] = bit.band(valuetable["LED_CTRL_ONOFF_6"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_ENABLE_TIMEING_6"]] ~= nil then
        if luaTable[keytable["KEY_LED_ENABLE_TIMEING_6"]] == "1" then
            valuetable["LED_ENABLE_TIMEING_6"] = bit.bor(valuetable["LED_ENABLE_TIMEING_6"], 0x80)
        else
            valuetable["LED_ENABLE_TIMEING_6"] = bit.band(valuetable["LED_ENABLE_TIMEING_6"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_TIME_ONOFF_7"]] ~= nil then
        valuetable["LED_TIME_OF_HOUR_7"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_7"]], 1, 2))
        valuetable["LED_TIME_OF_MINUTE_7"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_7"]], 3, 4))
    end
    if luaTable[keytable["KEY_LED_MONDAY_ENDIS_7"]] ~= nil then
        if luaTable[keytable["KEY_LED_MONDAY_ENDIS_7"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_7"] = bit.bor(valuetable["LED_WEEK_EN_DIS_7"], 0x02)
        else
            valuetable["LED_WEEK_EN_DIS_7"] = bit.band(valuetable["LED_WEEK_EN_DIS_7"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_7"]] ~= nil then
        if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_7"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_7"] = bit.bor(valuetable["LED_WEEK_EN_DIS_7"], 0x04)
        else
            valuetable["LED_WEEK_EN_DIS_7"] = bit.band(valuetable["LED_WEEK_EN_DIS_7"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_7"]] ~= nil then
        if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_7"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_7"] = bit.bor(valuetable["LED_WEEK_EN_DIS_7"], 0x08)
        else
            valuetable["LED_WEEK_EN_DIS_7"] = bit.band(valuetable["LED_WEEK_EN_DIS_7"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_7"]] ~= nil then
        if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_7"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_7"] = bit.bor(valuetable["LED_WEEK_EN_DIS_7"], 0x10)
        else
            valuetable["LED_WEEK_EN_DIS_7"] = bit.band(valuetable["LED_WEEK_EN_DIS_7"], 0xef)
        end
    end
    if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_7"]] ~= nil then
        if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_7"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_7"] = bit.bor(valuetable["LED_WEEK_EN_DIS_7"], 0x20)
        else
            valuetable["LED_WEEK_EN_DIS_7"] = bit.band(valuetable["LED_WEEK_EN_DIS_7"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_7"]] ~= nil then
        if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_7"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_7"] = bit.bor(valuetable["LED_WEEK_EN_DIS_7"], 0x40)
        else
            valuetable["LED_WEEK_EN_DIS_7"] = bit.band(valuetable["LED_WEEK_EN_DIS_7"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_7"]] ~= nil then
        if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_7"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_7"] = bit.bor(valuetable["LED_WEEK_EN_DIS_7"], 0x01)
        else
            valuetable["LED_WEEK_EN_DIS_7"] = bit.band(valuetable["LED_WEEK_EN_DIS_7"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_LED_CTRL_ONOFF_7"]] ~= nil then
        if luaTable[keytable["KEY_LED_CTRL_ONOFF_7"]] == "1" then
            valuetable["LED_CTRL_ONOFF_7"] = bit.bor(valuetable["LED_CTRL_ONOFF_7"], 0x80)
        else
            valuetable["LED_CTRL_ONOFF_7"] = bit.band(valuetable["LED_CTRL_ONOFF_7"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_ENABLE_TIMEING_7"]] ~= nil then
        if luaTable[keytable["KEY_LED_ENABLE_TIMEING_7"]] == "1" then
            valuetable["LED_ENABLE_TIMEING_7"] = bit.bor(valuetable["LED_ENABLE_TIMEING_7"], 0x80)
        else
            valuetable["LED_ENABLE_TIMEING_7"] = bit.band(valuetable["LED_ENABLE_TIMEING_7"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_TIME_ONOFF_8"]] ~= nil then
        valuetable["LED_TIME_OF_HOUR_8"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_8"]], 1, 2))
        valuetable["LED_TIME_OF_MINUTE_8"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_8"]], 3, 4))
    end
    if luaTable[keytable["KEY_LED_MONDAY_ENDIS_8"]] ~= nil then
        if luaTable[keytable["KEY_LED_MONDAY_ENDIS_8"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_8"] = bit.bor(valuetable["LED_WEEK_EN_DIS_8"], 0x02)
        else
            valuetable["LED_WEEK_EN_DIS_8"] = bit.band(valuetable["LED_WEEK_EN_DIS_8"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_8"]] ~= nil then
        if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_8"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_8"] = bit.bor(valuetable["LED_WEEK_EN_DIS_8"], 0x04)
        else
            valuetable["LED_WEEK_EN_DIS_8"] = bit.band(valuetable["LED_WEEK_EN_DIS_8"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_8"]] ~= nil then
        if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_8"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_8"] = bit.bor(valuetable["LED_WEEK_EN_DIS_8"], 0x08)
        else
            valuetable["LED_WEEK_EN_DIS_8"] = bit.band(valuetable["LED_WEEK_EN_DIS_8"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_8"]] ~= nil then
        if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_8"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_8"] = bit.bor(valuetable["LED_WEEK_EN_DIS_8"], 0x10)
        else
            valuetable["LED_WEEK_EN_DIS_8"] = bit.band(valuetable["LED_WEEK_EN_DIS_8"], 0xef)
        end
    end
    if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_8"]] ~= nil then
        if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_8"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_8"] = bit.bor(valuetable["LED_WEEK_EN_DIS_8"], 0x20)
        else
            valuetable["LED_WEEK_EN_DIS_8"] = bit.band(valuetable["LED_WEEK_EN_DIS_8"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_8"]] ~= nil then
        if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_8"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_8"] = bit.bor(valuetable["LED_WEEK_EN_DIS_8"], 0x40)
        else
            valuetable["LED_WEEK_EN_DIS_8"] = bit.band(valuetable["LED_WEEK_EN_DIS_8"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_8"]] ~= nil then
        if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_8"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_8"] = bit.bor(valuetable["LED_WEEK_EN_DIS_8"], 0x01)
        else
            valuetable["LED_WEEK_EN_DIS_8"] = bit.band(valuetable["LED_WEEK_EN_DIS_8"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_LED_CTRL_ONOFF_8"]] ~= nil then
        if luaTable[keytable["KEY_LED_CTRL_ONOFF_8"]] == "1" then
            valuetable["LED_CTRL_ONOFF_8"] = bit.bor(valuetable["LED_CTRL_ONOFF_8"], 0x80)
        else
            valuetable["LED_CTRL_ONOFF_8"] = bit.band(valuetable["LED_CTRL_ONOFF_8"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_ENABLE_TIMEING_8"]] ~= nil then
        if luaTable[keytable["KEY_LED_ENABLE_TIMEING_8"]] == "1" then
            valuetable["LED_ENABLE_TIMEING_8"] = bit.bor(valuetable["LED_ENABLE_TIMEING_8"], 0x80)
        else
            valuetable["LED_ENABLE_TIMEING_8"] = bit.band(valuetable["LED_ENABLE_TIMEING_8"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_TIME_ONOFF_9"]] ~= nil then
        valuetable["LED_TIME_OF_HOUR_9"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_9"]], 1, 2))
        valuetable["LED_TIME_OF_MINUTE_9"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_9"]], 3, 4))
    end
    if luaTable[keytable["KEY_LED_MONDAY_ENDIS_9"]] ~= nil then
        if luaTable[keytable["KEY_LED_MONDAY_ENDIS_9"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_9"] = bit.bor(valuetable["LED_WEEK_EN_DIS_9"], 0x02)
        else
            valuetable["LED_WEEK_EN_DIS_9"] = bit.band(valuetable["LED_WEEK_EN_DIS_9"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_9"]] ~= nil then
        if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_9"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_9"] = bit.bor(valuetable["LED_WEEK_EN_DIS_9"], 0x04)
        else
            valuetable["LED_WEEK_EN_DIS_9"] = bit.band(valuetable["LED_WEEK_EN_DIS_9"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_9"]] ~= nil then
        if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_9"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_9"] = bit.bor(valuetable["LED_WEEK_EN_DIS_9"], 0x08)
        else
            valuetable["LED_WEEK_EN_DIS_9"] = bit.band(valuetable["LED_WEEK_EN_DIS_9"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_9"]] ~= nil then
        if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_9"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_9"] = bit.bor(valuetable["LED_WEEK_EN_DIS_9"], 0x10)
        else
            valuetable["LED_WEEK_EN_DIS_9"] = bit.band(valuetable["LED_WEEK_EN_DIS_9"], 0xef)
        end
    end
    if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_9"]] ~= nil then
        if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_9"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_9"] = bit.bor(valuetable["LED_WEEK_EN_DIS_9"], 0x20)
        else
            valuetable["LED_WEEK_EN_DIS_9"] = bit.band(valuetable["LED_WEEK_EN_DIS_9"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_9"]] ~= nil then
        if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_9"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_9"] = bit.bor(valuetable["LED_WEEK_EN_DIS_9"], 0x40)
        else
            valuetable["LED_WEEK_EN_DIS_9"] = bit.band(valuetable["LED_WEEK_EN_DIS_9"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_9"]] ~= nil then
        if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_9"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_9"] = bit.bor(valuetable["LED_WEEK_EN_DIS_9"], 0x01)
        else
            valuetable["LED_WEEK_EN_DIS_9"] = bit.band(valuetable["LED_WEEK_EN_DIS_9"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_LED_CTRL_ONOFF_9"]] ~= nil then
        if luaTable[keytable["KEY_LED_CTRL_ONOFF_9"]] == "1" then
            valuetable["LED_CTRL_ONOFF_9"] = bit.bor(valuetable["LED_CTRL_ONOFF_9"], 0x80)
        else
            valuetable["LED_CTRL_ONOFF_9"] = bit.band(valuetable["LED_CTRL_ONOFF_9"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_ENABLE_TIMEING_9"]] ~= nil then
        if luaTable[keytable["KEY_LED_ENABLE_TIMEING_9"]] == "1" then
            valuetable["LED_ENABLE_TIMEING_9"] = bit.bor(valuetable["LED_ENABLE_TIMEING_9"], 0x80)
        else
            valuetable["LED_ENABLE_TIMEING_9"] = bit.band(valuetable["LED_ENABLE_TIMEING_9"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_TIME_ONOFF_10"]] ~= nil then
        valuetable["LED_TIME_OF_HOUR_10"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_10"]], 1, 2))
        valuetable["LED_TIME_OF_MINUTE_10"] = string2Int(string.sub(luaTable[keytable["KEY_LED_TIME_ONOFF_10"]], 3, 4))
    end
    if luaTable[keytable["KEY_LED_MONDAY_ENDIS_10"]] ~= nil then
        if luaTable[keytable["KEY_LED_MONDAY_ENDIS_10"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_10"] = bit.bor(valuetable["LED_WEEK_EN_DIS_10"], 0x02)
        else
            valuetable["LED_WEEK_EN_DIS_10"] = bit.band(valuetable["LED_WEEK_EN_DIS_10"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_10"]] ~= nil then
        if luaTable[keytable["KEY_LED_TUESDAY_ENDIS_10"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_10"] = bit.bor(valuetable["LED_WEEK_EN_DIS_10"], 0x04)
        else
            valuetable["LED_WEEK_EN_DIS_10"] = bit.band(valuetable["LED_WEEK_EN_DIS_10"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_10"]] ~= nil then
        if luaTable[keytable["KEY_LED_WEDNESDAY_ENDIS_10"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_10"] = bit.bor(valuetable["LED_WEEK_EN_DIS_10"], 0x08)
        else
            valuetable["LED_WEEK_EN_DIS_10"] = bit.band(valuetable["LED_WEEK_EN_DIS_10"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_10"]] ~= nil then
        if luaTable[keytable["KEY_LED_THURSDAY_ENDIS_10"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_10"] = bit.bor(valuetable["LED_WEEK_EN_DIS_10"], 0x10)
        else
            valuetable["LED_WEEK_EN_DIS_10"] = bit.band(valuetable["LED_WEEK_EN_DIS_10"], 0xef)
        end
    end
    if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_10"]] ~= nil then
        if luaTable[keytable["KEY_LED_FRIDAY_ENDIS_10"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_10"] = bit.bor(valuetable["LED_WEEK_EN_DIS_10"], 0x20)
        else
            valuetable["LED_WEEK_EN_DIS_10"] = bit.band(valuetable["LED_WEEK_EN_DIS_10"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_10"]] ~= nil then
        if luaTable[keytable["KEY_LED_SATURDAY_ENDIS_10"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_10"] = bit.bor(valuetable["LED_WEEK_EN_DIS_10"], 0x40)
        else
            valuetable["LED_WEEK_EN_DIS_10"] = bit.band(valuetable["LED_WEEK_EN_DIS_10"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_10"]] ~= nil then
        if luaTable[keytable["KEY_LED_SUNDAY_ENDIS_10"]] == "1" then
            valuetable["LED_WEEK_EN_DIS_10"] = bit.bor(valuetable["LED_WEEK_EN_DIS_10"], 0x01)
        else
            valuetable["LED_WEEK_EN_DIS_10"] = bit.band(valuetable["LED_WEEK_EN_DIS_10"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_LED_CTRL_ONOFF_10"]] ~= nil then
        if luaTable[keytable["KEY_LED_CTRL_ONOFF_10"]] == "1" then
            valuetable["LED_CTRL_ONOFF_10"] = bit.bor(valuetable["LED_CTRL_ONOFF_10"], 0x80)
        else
            valuetable["LED_CTRL_ONOFF_10"] = bit.band(valuetable["LED_CTRL_ONOFF_10"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_LED_ENABLE_TIMEING_10"]] ~= nil then
        if luaTable[keytable["KEY_LED_ENABLE_TIMEING_10"]] == "1" then
            valuetable["LED_ENABLE_TIMEING_10"] = bit.bor(valuetable["LED_ENABLE_TIMEING_10"], 0x80)
        else
            valuetable["LED_ENABLE_TIMEING_10"] = bit.band(valuetable["LED_ENABLE_TIMEING_10"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_TIME_ONOFF_1"]] ~= nil then
        valuetable["FAN_TIME_OF_HOUR_1"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_1"]], 1, 2))
        valuetable["FAN_TIME_OF_MINUTE_1"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_1"]], 3, 4))
    end
    if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_1"]] ~= nil then
        if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_1"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_1"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_1"], 0x02)
        else
            valuetable["FAN_WEEK_EN_DIS_1"] = bit.band(valuetable["FAN_WEEK_EN_DIS_1"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_1"]] ~= nil then
        if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_1"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_1"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_1"], 0x04)
        else
            valuetable["FAN_WEEK_EN_DIS_1"] = bit.band(valuetable["FAN_WEEK_EN_DIS_1"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_1"]] ~= nil then
        if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_1"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_1"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_1"], 0x08)
        else
            valuetable["FAN_WEEK_EN_DIS_1"] = bit.band(valuetable["FAN_WEEK_EN_DIS_1"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_1"]] ~= nil then
        if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_1"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_1"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_1"], 0x10)
        else
            valuetable["FAN_WEEK_EN_DIS_1"] = bit.band(valuetable["FAN_WEEK_EN_DIS_1"], 0xef)
        end
    end
    if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_1"]] ~= nil then
        if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_1"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_1"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_1"], 0x20)
        else
            valuetable["FAN_WEEK_EN_DIS_1"] = bit.band(valuetable["FAN_WEEK_EN_DIS_1"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_1"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_1"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_1"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_1"], 0x40)
        else
            valuetable["FAN_WEEK_EN_DIS_1"] = bit.band(valuetable["FAN_WEEK_EN_DIS_1"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_1"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_1"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_1"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_1"], 0x01)
        else
            valuetable["FAN_WEEK_EN_DIS_1"] = bit.band(valuetable["FAN_WEEK_EN_DIS_1"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_FAN_CTRL_ONOFF_1"]] ~= nil then
        if luaTable[keytable["KEY_FAN_CTRL_ONOFF_1"]] == "1" then
            valuetable["FAN_CTRL_ONOFF_1"] = bit.bor(valuetable["FAN_CTRL_ONOFF_1"], 0x80)
        else
            valuetable["FAN_CTRL_ONOFF_1"] = bit.band(valuetable["FAN_CTRL_ONOFF_1"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_1"]] ~= nil then
        if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_1"]] == "1" then
            valuetable["FAN_ENABLE_TIMEING_1"] = bit.bor(valuetable["FAN_ENABLE_TIMEING_1"], 0x80)
        else
            valuetable["FAN_ENABLE_TIMEING_1"] = bit.band(valuetable["FAN_ENABLE_TIMEING_1"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_TIME_ONOFF_2"]] ~= nil then
        valuetable["FAN_TIME_OF_HOUR_2"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_2"]], 1, 2))
        valuetable["FAN_TIME_OF_MINUTE_2"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_2"]], 3, 4))
    end
    if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_2"]] ~= nil then
        if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_2"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_2"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_2"], 0x02)
        else
            valuetable["FAN_WEEK_EN_DIS_2"] = bit.band(valuetable["FAN_WEEK_EN_DIS_2"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_2"]] ~= nil then
        if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_2"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_2"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_2"], 0x04)
        else
            valuetable["FAN_WEEK_EN_DIS_2"] = bit.band(valuetable["FAN_WEEK_EN_DIS_2"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_2"]] ~= nil then
        if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_2"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_2"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_2"], 0x08)
        else
            valuetable["FAN_WEEK_EN_DIS_2"] = bit.band(valuetable["FAN_WEEK_EN_DIS_2"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_2"]] ~= nil then
        if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_2"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_2"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_2"], 0x10)
        else
            valuetable["FAN_WEEK_EN_DIS_2"] = bit.band(valuetable["FAN_WEEK_EN_DIS_2"], 0xef)
        end
    end
    if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_2"]] ~= nil then
        if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_2"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_2"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_2"], 0x20)
        else
            valuetable["FAN_WEEK_EN_DIS_2"] = bit.band(valuetable["FAN_WEEK_EN_DIS_2"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_2"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_2"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_2"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_2"], 0x40)
        else
            valuetable["FAN_WEEK_EN_DIS_2"] = bit.band(valuetable["FAN_WEEK_EN_DIS_2"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_2"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_2"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_2"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_2"], 0x01)
        else
            valuetable["FAN_WEEK_EN_DIS_2"] = bit.band(valuetable["FAN_WEEK_EN_DIS_2"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_FAN_CTRL_ONOFF_2"]] ~= nil then
        if luaTable[keytable["KEY_FAN_CTRL_ONOFF_2"]] == "1" then
            valuetable["FAN_CTRL_ONOFF_2"] = bit.bor(valuetable["FAN_CTRL_ONOFF_2"], 0x80)
        else
            valuetable["FAN_CTRL_ONOFF_2"] = bit.band(valuetable["FAN_CTRL_ONOFF_2"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_2"]] ~= nil then
        if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_2"]] == "1" then
            valuetable["FAN_ENABLE_TIMEING_2"] = bit.bor(valuetable["FAN_ENABLE_TIMEING_2"], 0x80)
        else
            valuetable["FAN_ENABLE_TIMEING_2"] = bit.band(valuetable["FAN_ENABLE_TIMEING_2"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_TIME_ONOFF_3"]] ~= nil then
        valuetable["FAN_TIME_OF_HOUR_3"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_3"]], 1, 2))
        valuetable["FAN_TIME_OF_MINUTE_3"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_3"]], 3, 4))
    end
    if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_3"]] ~= nil then
        if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_3"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_3"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_3"], 0x02)
        else
            valuetable["FAN_WEEK_EN_DIS_3"] = bit.band(valuetable["FAN_WEEK_EN_DIS_3"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_3"]] ~= nil then
        if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_3"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_3"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_3"], 0x04)
        else
            valuetable["FAN_WEEK_EN_DIS_3"] = bit.band(valuetable["FAN_WEEK_EN_DIS_3"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_3"]] ~= nil then
        if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_3"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_3"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_3"], 0x08)
        else
            valuetable["FAN_WEEK_EN_DIS_3"] = bit.band(valuetable["FAN_WEEK_EN_DIS_3"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_3"]] ~= nil then
        if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_3"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_3"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_3"], 0x10)
        else
            valuetable["FAN_WEEK_EN_DIS_3"] = bit.band(valuetable["FAN_WEEK_EN_DIS_3"], 0xef)
        end
    end
    if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_3"]] ~= nil then
        if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_3"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_3"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_3"], 0x20)
        else
            valuetable["FAN_WEEK_EN_DIS_3"] = bit.band(valuetable["FAN_WEEK_EN_DIS_3"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_3"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_3"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_3"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_3"], 0x40)
        else
            valuetable["FAN_WEEK_EN_DIS_3"] = bit.band(valuetable["FAN_WEEK_EN_DIS_3"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_3"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_3"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_3"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_3"], 0x01)
        else
            valuetable["FAN_WEEK_EN_DIS_3"] = bit.band(valuetable["FAN_WEEK_EN_DIS_3"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_FAN_CTRL_ONOFF_3"]] ~= nil then
        if luaTable[keytable["KEY_FAN_CTRL_ONOFF_3"]] == "1" then
            valuetable["FAN_CTRL_ONOFF_3"] = bit.bor(valuetable["FAN_CTRL_ONOFF_3"], 0x80)
        else
            valuetable["FAN_CTRL_ONOFF_3"] = bit.band(valuetable["FAN_CTRL_ONOFF_3"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_3"]] ~= nil then
        if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_3"]] == "1" then
            valuetable["FAN_ENABLE_TIMEING_3"] = bit.bor(valuetable["FAN_ENABLE_TIMEING_3"], 0x80)
        else
            valuetable["FAN_ENABLE_TIMEING_3"] = bit.band(valuetable["FAN_ENABLE_TIMEING_3"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_TIME_ONOFF_4"]] ~= nil then
        valuetable["FAN_TIME_OF_HOUR_4"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_4"]], 1, 2))
        valuetable["FAN_TIME_OF_MINUTE_4"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_4"]], 3, 4))
    end
    if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_4"]] ~= nil then
        if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_4"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_4"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_4"], 0x02)
        else
            valuetable["FAN_WEEK_EN_DIS_4"] = bit.band(valuetable["FAN_WEEK_EN_DIS_4"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_4"]] ~= nil then
        if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_4"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_4"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_4"], 0x04)
        else
            valuetable["FAN_WEEK_EN_DIS_4"] = bit.band(valuetable["FAN_WEEK_EN_DIS_4"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_4"]] ~= nil then
        if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_4"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_4"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_4"], 0x08)
        else
            valuetable["FAN_WEEK_EN_DIS_4"] = bit.band(valuetable["FAN_WEEK_EN_DIS_4"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_4"]] ~= nil then
        if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_4"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_4"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_4"], 0x10)
        else
            valuetable["FAN_WEEK_EN_DIS_4"] = bit.band(valuetable["FAN_WEEK_EN_DIS_4"], 0xef)
        end
    end
    if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_4"]] ~= nil then
        if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_4"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_4"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_4"], 0x20)
        else
            valuetable["FAN_WEEK_EN_DIS_4"] = bit.band(valuetable["FAN_WEEK_EN_DIS_4"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_4"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_4"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_4"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_4"], 0x40)
        else
            valuetable["FAN_WEEK_EN_DIS_4"] = bit.band(valuetable["FAN_WEEK_EN_DIS_4"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_4"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_4"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_4"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_4"], 0x01)
        else
            valuetable["FAN_WEEK_EN_DIS_4"] = bit.band(valuetable["FAN_WEEK_EN_DIS_4"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_FAN_CTRL_ONOFF_4"]] ~= nil then
        if luaTable[keytable["KEY_FAN_CTRL_ONOFF_4"]] == "1" then
            valuetable["FAN_CTRL_ONOFF_4"] = bit.bor(valuetable["FAN_CTRL_ONOFF_4"], 0x80)
        else
            valuetable["FAN_CTRL_ONOFF_4"] = bit.band(valuetable["FAN_CTRL_ONOFF_4"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_4"]] ~= nil then
        if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_4"]] == "1" then
            valuetable["FAN_ENABLE_TIMEING_4"] = bit.bor(valuetable["FAN_ENABLE_TIMEING_4"], 0x80)
        else
            valuetable["FAN_ENABLE_TIMEING_4"] = bit.band(valuetable["FAN_ENABLE_TIMEING_4"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_TIME_ONOFF_5"]] ~= nil then
        valuetable["FAN_TIME_OF_HOUR_5"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_5"]], 1, 2))
        valuetable["FAN_TIME_OF_MINUTE_5"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_5"]], 3, 4))
    end
    if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_5"]] ~= nil then
        if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_5"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_5"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_5"], 0x02)
        else
            valuetable["FAN_WEEK_EN_DIS_5"] = bit.band(valuetable["FAN_WEEK_EN_DIS_5"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_5"]] ~= nil then
        if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_5"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_5"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_5"], 0x04)
        else
            valuetable["FAN_WEEK_EN_DIS_5"] = bit.band(valuetable["FAN_WEEK_EN_DIS_5"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_5"]] ~= nil then
        if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_5"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_5"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_5"], 0x08)
        else
            valuetable["FAN_WEEK_EN_DIS_5"] = bit.band(valuetable["FAN_WEEK_EN_DIS_5"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_5"]] ~= nil then
        if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_5"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_5"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_5"], 0x10)
        else
            valuetable["FAN_WEEK_EN_DIS_5"] = bit.band(valuetable["FAN_WEEK_EN_DIS_5"], 0xef)
        end
    end
    if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_5"]] ~= nil then
        if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_5"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_5"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_5"], 0x20)
        else
            valuetable["FAN_WEEK_EN_DIS_5"] = bit.band(valuetable["FAN_WEEK_EN_DIS_5"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_5"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_5"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_5"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_5"], 0x40)
        else
            valuetable["FAN_WEEK_EN_DIS_5"] = bit.band(valuetable["FAN_WEEK_EN_DIS_5"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_5"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_5"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_5"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_5"], 0x01)
        else
            valuetable["FAN_WEEK_EN_DIS_5"] = bit.band(valuetable["FAN_WEEK_EN_DIS_5"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_FAN_CTRL_ONOFF_5"]] ~= nil then
        if luaTable[keytable["KEY_FAN_CTRL_ONOFF_5"]] == "1" then
            valuetable["FAN_CTRL_ONOFF_5"] = bit.bor(valuetable["FAN_CTRL_ONOFF_5"], 0x80)
        else
            valuetable["FAN_CTRL_ONOFF_5"] = bit.band(valuetable["FAN_CTRL_ONOFF_5"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_5"]] ~= nil then
        if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_5"]] == "1" then
            valuetable["FAN_ENABLE_TIMEING_5"] = bit.bor(valuetable["FAN_ENABLE_TIMEING_5"], 0x80)
        else
            valuetable["FAN_ENABLE_TIMEING_5"] = bit.band(valuetable["FAN_ENABLE_TIMEING_5"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_TIME_ONOFF_6"]] ~= nil then
        valuetable["FAN_TIME_OF_HOUR_6"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_6"]], 1, 2))
        valuetable["FAN_TIME_OF_MINUTE_6"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_6"]], 3, 4))
    end
    if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_6"]] ~= nil then
        if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_6"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_6"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_6"], 0x02)
        else
            valuetable["FAN_WEEK_EN_DIS_6"] = bit.band(valuetable["FAN_WEEK_EN_DIS_6"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_6"]] ~= nil then
        if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_6"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_6"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_6"], 0x04)
        else
            valuetable["FAN_WEEK_EN_DIS_6"] = bit.band(valuetable["FAN_WEEK_EN_DIS_6"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_6"]] ~= nil then
        if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_6"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_6"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_6"], 0x08)
        else
            valuetable["FAN_WEEK_EN_DIS_6"] = bit.band(valuetable["FAN_WEEK_EN_DIS_6"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_6"]] ~= nil then
        if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_6"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_6"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_6"], 0x10)
        else
            valuetable["FAN_WEEK_EN_DIS_6"] = bit.band(valuetable["FAN_WEEK_EN_DIS_6"], 0xef)
        end
    end
    if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_6"]] ~= nil then
        if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_6"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_6"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_6"], 0x20)
        else
            valuetable["FAN_WEEK_EN_DIS_6"] = bit.band(valuetable["FAN_WEEK_EN_DIS_6"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_6"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_6"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_6"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_6"], 0x40)
        else
            valuetable["FAN_WEEK_EN_DIS_6"] = bit.band(valuetable["FAN_WEEK_EN_DIS_6"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_6"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_6"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_6"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_6"], 0x01)
        else
            valuetable["FAN_WEEK_EN_DIS_6"] = bit.band(valuetable["FAN_WEEK_EN_DIS_6"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_FAN_CTRL_ONOFF_6"]] ~= nil then
        if luaTable[keytable["KEY_FAN_CTRL_ONOFF_6"]] == "1" then
            valuetable["FAN_CTRL_ONOFF_6"] = bit.bor(valuetable["FAN_CTRL_ONOFF_6"], 0x80)
        else
            valuetable["FAN_CTRL_ONOFF_6"] = bit.band(valuetable["FAN_CTRL_ONOFF_6"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_6"]] ~= nil then
        if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_6"]] == "1" then
            valuetable["FAN_ENABLE_TIMEING_6"] = bit.bor(valuetable["FAN_ENABLE_TIMEING_6"], 0x80)
        else
            valuetable["FAN_ENABLE_TIMEING_6"] = bit.band(valuetable["FAN_ENABLE_TIMEING_6"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_TIME_ONOFF_7"]] ~= nil then
        valuetable["FAN_TIME_OF_HOUR_7"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_7"]], 1, 2))
        valuetable["FAN_TIME_OF_MINUTE_7"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_7"]], 3, 4))
    end
    if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_7"]] ~= nil then
        if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_7"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_7"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_7"], 0x02)
        else
            valuetable["FAN_WEEK_EN_DIS_7"] = bit.band(valuetable["FAN_WEEK_EN_DIS_7"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_7"]] ~= nil then
        if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_7"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_7"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_7"], 0x04)
        else
            valuetable["FAN_WEEK_EN_DIS_7"] = bit.band(valuetable["FAN_WEEK_EN_DIS_7"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_7"]] ~= nil then
        if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_7"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_7"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_7"], 0x08)
        else
            valuetable["FAN_WEEK_EN_DIS_7"] = bit.band(valuetable["FAN_WEEK_EN_DIS_7"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_7"]] ~= nil then
        if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_7"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_7"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_7"], 0x10)
        else
            valuetable["FAN_WEEK_EN_DIS_7"] = bit.band(valuetable["FAN_WEEK_EN_DIS_7"], 0xef)
        end
    end
    if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_7"]] ~= nil then
        if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_7"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_7"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_7"], 0x20)
        else
            valuetable["FAN_WEEK_EN_DIS_7"] = bit.band(valuetable["FAN_WEEK_EN_DIS_7"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_7"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_7"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_7"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_7"], 0x40)
        else
            valuetable["FAN_WEEK_EN_DIS_7"] = bit.band(valuetable["FAN_WEEK_EN_DIS_7"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_7"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_7"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_7"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_7"], 0x01)
        else
            valuetable["FAN_WEEK_EN_DIS_7"] = bit.band(valuetable["FAN_WEEK_EN_DIS_7"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_FAN_CTRL_ONOFF_7"]] ~= nil then
        if luaTable[keytable["KEY_FAN_CTRL_ONOFF_7"]] == "1" then
            valuetable["FAN_CTRL_ONOFF_7"] = bit.bor(valuetable["FAN_CTRL_ONOFF_7"], 0x80)
        else
            valuetable["FAN_CTRL_ONOFF_7"] = bit.band(valuetable["FAN_CTRL_ONOFF_7"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_7"]] ~= nil then
        if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_7"]] == "1" then
            valuetable["FAN_ENABLE_TIMEING_7"] = bit.bor(valuetable["FAN_ENABLE_TIMEING_7"], 0x80)
        else
            valuetable["FAN_ENABLE_TIMEING_7"] = bit.band(valuetable["FAN_ENABLE_TIMEING_7"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_TIME_ONOFF_8"]] ~= nil then
        valuetable["FAN_TIME_OF_HOUR_8"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_8"]], 1, 2))
        valuetable["FAN_TIME_OF_MINUTE_8"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_8"]], 3, 4))
    end
    if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_8"]] ~= nil then
        if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_8"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_8"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_8"], 0x02)
        else
            valuetable["FAN_WEEK_EN_DIS_8"] = bit.band(valuetable["FAN_WEEK_EN_DIS_8"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_8"]] ~= nil then
        if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_8"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_8"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_8"], 0x04)
        else
            valuetable["FAN_WEEK_EN_DIS_8"] = bit.band(valuetable["FAN_WEEK_EN_DIS_8"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_8"]] ~= nil then
        if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_8"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_8"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_8"], 0x08)
        else
            valuetable["FAN_WEEK_EN_DIS_8"] = bit.band(valuetable["FAN_WEEK_EN_DIS_8"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_8"]] ~= nil then
        if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_8"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_8"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_8"], 0x10)
        else
            valuetable["FAN_WEEK_EN_DIS_8"] = bit.band(valuetable["FAN_WEEK_EN_DIS_8"], 0xef)
        end
    end
    if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_8"]] ~= nil then
        if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_8"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_8"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_8"], 0x20)
        else
            valuetable["FAN_WEEK_EN_DIS_8"] = bit.band(valuetable["FAN_WEEK_EN_DIS_8"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_8"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_8"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_8"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_8"], 0x40)
        else
            valuetable["FAN_WEEK_EN_DIS_8"] = bit.band(valuetable["FAN_WEEK_EN_DIS_8"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_8"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_8"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_8"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_8"], 0x01)
        else
            valuetable["FAN_WEEK_EN_DIS_8"] = bit.band(valuetable["FAN_WEEK_EN_DIS_8"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_FAN_CTRL_ONOFF_8"]] ~= nil then
        if luaTable[keytable["KEY_FAN_CTRL_ONOFF_8"]] == "1" then
            valuetable["FAN_CTRL_ONOFF_8"] = bit.bor(valuetable["FAN_CTRL_ONOFF_8"], 0x80)
        else
            valuetable["FAN_CTRL_ONOFF_8"] = bit.band(valuetable["FAN_CTRL_ONOFF_8"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_8"]] ~= nil then
        if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_8"]] == "1" then
            valuetable["FAN_ENABLE_TIMEING_8"] = bit.bor(valuetable["FAN_ENABLE_TIMEING_8"], 0x80)
        else
            valuetable["FAN_ENABLE_TIMEING_8"] = bit.band(valuetable["FAN_ENABLE_TIMEING_8"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_TIME_ONOFF_9"]] ~= nil then
        valuetable["FAN_TIME_OF_HOUR_9"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_9"]], 1, 2))
        valuetable["FAN_TIME_OF_MINUTE_9"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_9"]], 3, 4))
    end
    if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_9"]] ~= nil then
        if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_9"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_9"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_9"], 0x02)
        else
            valuetable["FAN_WEEK_EN_DIS_9"] = bit.band(valuetable["FAN_WEEK_EN_DIS_9"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_9"]] ~= nil then
        if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_9"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_9"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_9"], 0x04)
        else
            valuetable["FAN_WEEK_EN_DIS_9"] = bit.band(valuetable["FAN_WEEK_EN_DIS_9"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_9"]] ~= nil then
        if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_9"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_9"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_9"], 0x08)
        else
            valuetable["FAN_WEEK_EN_DIS_9"] = bit.band(valuetable["FAN_WEEK_EN_DIS_9"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_9"]] ~= nil then
        if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_9"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_9"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_9"], 0x10)
        else
            valuetable["FAN_WEEK_EN_DIS_9"] = bit.band(valuetable["FAN_WEEK_EN_DIS_9"], 0xef)
        end
    end
    if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_9"]] ~= nil then
        if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_9"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_9"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_9"], 0x20)
        else
            valuetable["FAN_WEEK_EN_DIS_9"] = bit.band(valuetable["FAN_WEEK_EN_DIS_9"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_9"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_9"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_9"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_9"], 0x40)
        else
            valuetable["FAN_WEEK_EN_DIS_9"] = bit.band(valuetable["FAN_WEEK_EN_DIS_9"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_9"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_9"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_9"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_9"], 0x01)
        else
            valuetable["FAN_WEEK_EN_DIS_9"] = bit.band(valuetable["FAN_WEEK_EN_DIS_9"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_FAN_CTRL_ONOFF_9"]] ~= nil then
        if luaTable[keytable["KEY_FAN_CTRL_ONOFF_9"]] == "1" then
            valuetable["FAN_CTRL_ONOFF_9"] = bit.bor(valuetable["FAN_CTRL_ONOFF_9"], 0x80)
        else
            valuetable["FAN_CTRL_ONOFF_9"] = bit.band(valuetable["FAN_CTRL_ONOFF_9"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_9"]] ~= nil then
        if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_9"]] == "1" then
            valuetable["FAN_ENABLE_TIMEING_9"] = bit.bor(valuetable["FAN_ENABLE_TIMEING_9"], 0x80)
        else
            valuetable["FAN_ENABLE_TIMEING_9"] = bit.band(valuetable["FAN_ENABLE_TIMEING_9"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_TIME_ONOFF_10"]] ~= nil then
        valuetable["FAN_TIME_OF_HOUR_10"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_10"]], 1, 2))
        valuetable["FAN_TIME_OF_MINUTE_10"] = string2Int(string.sub(luaTable[keytable["KEY_FAN_TIME_ONOFF_10"]], 3, 4))
    end
    if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_10"]] ~= nil then
        if luaTable[keytable["KEY_FAN_MONDAY_ENDIS_10"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_10"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_10"], 0x02)
        else
            valuetable["FAN_WEEK_EN_DIS_10"] = bit.band(valuetable["FAN_WEEK_EN_DIS_10"], 0xfd)
        end
    end
    if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_10"]] ~= nil then
        if luaTable[keytable["KEY_FAN_TUESDAY_ENDIS_10"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_10"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_10"], 0x04)
        else
            valuetable["FAN_WEEK_EN_DIS_10"] = bit.band(valuetable["FAN_WEEK_EN_DIS_10"], 0xfb)
        end
    end
    if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_10"]] ~= nil then
        if luaTable[keytable["KEY_FAN_WEDNESDAY_ENDIS_10"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_10"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_10"], 0x08)
        else
            valuetable["FAN_WEEK_EN_DIS_10"] = bit.band(valuetable["FAN_WEEK_EN_DIS_10"], 0xf7)
        end
    end
    if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_10"]] ~= nil then
        if luaTable[keytable["KEY_FAN_THURSDAY_ENDIS_10"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_10"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_10"], 0x10)
        else
            valuetable["FAN_WEEK_EN_DIS_10"] = bit.band(valuetable["FAN_WEEK_EN_DIS_10"], 0xef)
        end
    end
    if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_10"]] ~= nil then
        if luaTable[keytable["KEY_FAN_FRIDAY_ENDIS_10"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_10"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_10"], 0x20)
        else
            valuetable["FAN_WEEK_EN_DIS_10"] = bit.band(valuetable["FAN_WEEK_EN_DIS_10"], 0xdf)
        end
    end
    if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_10"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SATURDAY_ENDIS_10"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_10"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_10"], 0x40)
        else
            valuetable["FAN_WEEK_EN_DIS_10"] = bit.band(valuetable["FAN_WEEK_EN_DIS_10"], 0xbf)
        end
    end
    if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_10"]] ~= nil then
        if luaTable[keytable["KEY_FAN_SUNDAY_ENDIS_10"]] == "1" then
            valuetable["FAN_WEEK_EN_DIS_10"] = bit.bor(valuetable["FAN_WEEK_EN_DIS_10"], 0x01)
        else
            valuetable["FAN_WEEK_EN_DIS_10"] = bit.band(valuetable["FAN_WEEK_EN_DIS_10"], 0xfe)
        end
    end
    if luaTable[keytable["KEY_FAN_CTRL_ONOFF_10"]] ~= nil then
        if luaTable[keytable["KEY_FAN_CTRL_ONOFF_10"]] == "1" then
            valuetable["FAN_CTRL_ONOFF_10"] = bit.bor(valuetable["FAN_CTRL_ONOFF_10"], 0x80)
        else
            valuetable["FAN_CTRL_ONOFF_10"] = bit.band(valuetable["FAN_CTRL_ONOFF_10"], 0x7f)
        end
    end
    if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_10"]] ~= nil then
        if luaTable[keytable["KEY_FAN_ENABLE_TIMEING_10"]] == "1" then
            valuetable["FAN_ENABLE_TIMEING_10"] = bit.bor(valuetable["FAN_ENABLE_TIMEING_10"], 0x80)
        else
            valuetable["FAN_ENABLE_TIMEING_10"] = bit.band(valuetable["FAN_ENABLE_TIMEING_10"], 0x7f)
        end
    end
end
local function updateGlobalPropertyValueByByte(messageBytes)
    ...
    if cmdType == 0xa4 then
        ...
        valuetable["TEMPERATURE_MIN"] = messageBytes[91] * 256 + messageBytes[92]
        valuetable["TEMPERATURE_MAX"] = messageBytes[93] * 256 + messageBytes[94]
...
local function assembleJsonByGlobalProperty()
    ...
    if cmdType == 0xa4 then
        ...
        streams[keytable["KEY_ARROUND_DIR"]] = int2String(valuetable["ARROUNDDIR"])
        ...
        streams[keytable["KEY_DELAY_FAN_OFF"]] = int2String(valuetable["DELAYFANOFF"])
        streams[keytable["KEY_CONST_TEMP_VALUE"]] = int2String(valuetable["CONSTTMEPVALUE"])
        ...
        streams[keytable["KEY_LED_TIME_ONOFF_1"]] = string.format("%02d", valuetable["LED_TIME_OF_HOUR_1"])
        streams[keytable["KEY_LED_TIME_ONOFF_1"]] = streams[keytable["KEY_LED_TIME_ONOFF_1"]]
        ...
        streams[keytable["KEY_LED_TIME_ONOFF_2"]] = string.format("%02d", valuetable["LED_TIME_OF_HOUR_2"])
        streams[keytable["KEY_LED_TIME_ONOFF_2"]] = streams[keytable["KEY_LED_TIME_ONOFF_2"]]
        ...
        streams[keytable["KEY_LED_TIME_ONOFF_3"]] = string.format("%02d", valuetable["LED_TIME_OF_HOUR_3"])
        streams[keytable["KEY_LED_TIME_ONOFF_3"]] = streams[keytable["KEY_LED_TIME_ONOFF_3"]]
        ...
        streams[keytable["KEY_LED_TIME_ONOFF_4"]] = string.format("%02d", valuetable["LED_TIME_OF_HOUR_4"])
        streams[keytable["KEY_LED_TIME_ONOFF_4"]] = streams[keytable["KEY_LED_TIME_ONOFF_4"]]
        ...
        streams[keytable["KEY_LED_TIME_ONOFF_5"]] = string.format("%02d", valuetable["LED_TIME_OF_HOUR_5"])
        streams[keytable["KEY_LED_TIME_ONOFF_5"]] = streams[keytable["KEY_LED_TIME_ONOFF_5"]]
        ...
        streams[keytable["KEY_LED_TIME_ONOFF_6"]] = string.format("%02d", valuetable["LED_TIME_OF_HOUR_6"])
        streams[keytable["KEY_LED_TIME_ONOFF_6"]] = streams[keytable["KEY_LED_TIME_ONOFF_6"]]
        ...
        streams[keytable["KEY_LED_TIME_ONOFF_7"]] = string.format("%02d", valuetable["LED_TIME_OF_HOUR_7"])
        streams[keytable["KEY_LED_TIME_ONOFF_7"]] = streams[keytable["KEY_LED_TIME_ONOFF_7"]]
        ...
        streams[keytable["KEY_LED_TIME_ONOFF_8"]] = string.format("%02d", valuetable["LED_TIME_OF_HOUR_8"])
        streams[keytable["KEY_LED_TIME_ONOFF_8"]] = streams[keytable["KEY_LED_TIME_ONOFF_8"]]
        ...
        streams[keytable["KEY_LED_TIME_ONOFF_9"]] = string.format("%02d", valuetable["LED_TIME_OF_HOUR_9"])
        streams[keytable["KEY_LED_TIME_ONOFF_9"]] = streams[keytable["KEY_LED_TIME_ONOFF_9"]]
        ...
        streams[keytable["KEY_LED_TIME_ONOFF_10"]] = string.format("%02d", valuetable["LED_TIME_OF_HOUR_10"])
        streams[keytable["KEY_LED_TIME_ONOFF_10"]] = streams[keytable["KEY_LED_TIME_ONOFF_10"]]
        ...
        streams[keytable["KEY_FAN_TIME_ONOFF_1"]] = string.format("%02d", valuetable["FAN_TIME_OF_HOUR_1"])
        streams[keytable["KEY_FAN_TIME_ONOFF_1"]] = streams[keytable["KEY_FAN_TIME_ONOFF_1"]]
        ...
        streams[keytable["KEY_FAN_TIME_ONOFF_2"]] = string.format("%02d", valuetable["FAN_TIME_OF_HOUR_2"])
        streams[keytable["KEY_FAN_TIME_ONOFF_2"]] = streams[keytable["KEY_FAN_TIME_ONOFF_2"]]
        ...
        streams[keytable["KEY_FAN_TIME_ONOFF_3"]] = string.format("%02d", valuetable["FAN_TIME_OF_HOUR_3"])
        streams[keytable["KEY_FAN_TIME_ONOFF_3"]] = streams[keytable["KEY_FAN_TIME_ONOFF_3"]]
        ...
        streams[keytable["KEY_FAN_TIME_ONOFF_4"]] = string.format("%02d", valuetable["FAN_TIME_OF_HOUR_4"])
        streams[keytable["KEY_FAN_TIME_ONOFF_4"]] = streams[keytable["KEY_FAN_TIME_ONOFF_4"]]
        ...
        streams[keytable["KEY_FAN_TIME_ONOFF_5"]] = string.format("%02d", valuetable["FAN_TIME_OF_HOUR_5"])
        streams[keytable["KEY_FAN_TIME_ONOFF_5"]] = streams[keytable["KEY_FAN_TIME_ONOFF_5"]]
        ...
        streams[keytable["KEY_FAN_TIME_ONOFF_6"]] = string.format("%02d", valuetable["FAN_TIME_OF_HOUR_6"])
        streams[keytable["KEY_FAN_TIME_ONOFF_6"]] = streams[keytable["KEY_FAN_TIME_ONOFF_6"]]
        ...
        streams[keytable["KEY_FAN_TIME_ONOFF_7"]] = string.format("%02d", valuetable["FAN_TIME_OF_HOUR_7"])
        streams[keytable["KEY_FAN_TIME_ONOFF_7"]] = streams[keytable["KEY_FAN_TIME_ONOFF_7"]]
        ...
        streams[keytable["KEY_FAN_TIME_ONOFF_8"]] = string.format("%02d", valuetable["FAN_TIME_OF_HOUR_8"])
        streams[keytable["KEY_FAN_TIME_ONOFF_8"]] = streams[keytable["KEY_FAN_TIME_ONOFF_8"]]
        ...
        streams[keytable["KEY_FAN_TIME_ONOFF_9"]] = string.format("%02d", valuetable["FAN_TIME_OF_HOUR_9"])
        streams[keytable["KEY_FAN_TIME_ONOFF_9"]] = streams[keytable["KEY_FAN_TIME_ONOFF_9"]]
        ...
        streams[keytable["KEY_FAN_TIME_ONOFF_10"]] = string.format("%02d", valuetable["FAN_TIME_OF_HOUR_10"])
        streams[keytable["KEY_FAN_TIME_ONOFF_10"]] = streams[keytable["KEY_FAN_TIME_ONOFF_10"]]
        ...
        streams[keytable["KEY_TEMPERATURE_MIN"]] = int2String(valuetable["TEMPERATURE_MIN"])
        streams[keytable["KEY_TEMPERATURE_MAX"]] = int2String(valuetable["TEMPERATURE_MAX"])
                ...
                if control[keytable["KEY_LED_MONDAY_ENDIS_1"]] ~= nil then
                    if control[keytable["KEY_LED_WEDNESDAY_ENDIS_1"]] ~= nil then
                        if control[keytable["KEY_LED_TUESDAY_ENDIS_1"]] ~= nil then
                            if control[keytable["KEY_LED_THURSDAY_ENDIS_1"]] ~= nil then
                                if control[keytable["KEY_LED_FRIDAY_ENDIS_1"]] ~= nil then
                                    if control[keytable["KEY_LED_SATURDAY_ENDIS_1"]] ~= nil then
                                        if control[keytable["KEY_LED_SUNDAY_ENDIS_1"]] ~= nil then
                                            if control[keytable["KEY_LED_ENABLE_TIMEING_1"]] ~= nil then
                                                bodyBytes[0] = 0x06
                                                bodyBytes[1] = valuetable["LED_TIME_OF_HOUR_1"]
                                                bodyBytes[2] = valuetable["LED_TIME_OF_MINUTE_1"]
                                                bodyBytes[3] = valuetable["LED_WEEK_EN_DIS_1"]
                                                    + valuetable["LED_CTRL_ONOFF_1"]
                                                bodyBytes[4] = valuetable["LED_ENABLE_TIMEING_1"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_LED_MONDAY_ENDIS_2"]] ~= nil then
                    if control[keytable["KEY_LED_WEDNESDAY_ENDIS_2"]] ~= nil then
                        if control[keytable["KEY_LED_TUESDAY_ENDIS_2"]] ~= nil then
                            if control[keytable["KEY_LED_THURSDAY_ENDIS_2"]] ~= nil then
                                if control[keytable["KEY_LED_FRIDAY_ENDIS_2"]] ~= nil then
                                    if control[keytable["KEY_LED_SATURDAY_ENDIS_2"]] ~= nil then
                                        if control[keytable["KEY_LED_SUNDAY_ENDIS_2"]] ~= nil then
                                            if control[keytable["KEY_LED_ENABLE_TIMEING_2"]] ~= nil then
                                                bodyBytes[0] = 0x07
                                                bodyBytes[1] = valuetable["LED_TIME_OF_HOUR_2"]
                                                bodyBytes[2] = valuetable["LED_TIME_OF_MINUTE_2"]
                                                bodyBytes[3] = valuetable["LED_WEEK_EN_DIS_2"]
                                                    + valuetable["LED_CTRL_ONOFF_2"]
                                                bodyBytes[4] = valuetable["LED_ENABLE_TIMEING_2"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_LED_MONDAY_ENDIS_3"]] ~= nil then
                    if control[keytable["KEY_LED_WEDNESDAY_ENDIS_3"]] ~= nil then
                        if control[keytable["KEY_LED_TUESDAY_ENDIS_3"]] ~= nil then
                            if control[keytable["KEY_LED_THURSDAY_ENDIS_3"]] ~= nil then
                                if control[keytable["KEY_LED_FRIDAY_ENDIS_3"]] ~= nil then
                                    if control[keytable["KEY_LED_SATURDAY_ENDIS_3"]] ~= nil then
                                        if control[keytable["KEY_LED_SUNDAY_ENDIS_3"]] ~= nil then
                                            if control[keytable["KEY_LED_ENABLE_TIMEING_3"]] ~= nil then
                                                bodyBytes[0] = 0x08
                                                bodyBytes[1] = valuetable["LED_TIME_OF_HOUR_3"]
                                                bodyBytes[2] = valuetable["LED_TIME_OF_MINUTE_3"]
                                                bodyBytes[3] = valuetable["LED_WEEK_EN_DIS_3"]
                                                    + valuetable["LED_CTRL_ONOFF_3"]
                                                bodyBytes[4] = valuetable["LED_ENABLE_TIMEING_3"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_LED_MONDAY_ENDIS_4"]] ~= nil then
                    if control[keytable["KEY_LED_WEDNESDAY_ENDIS_4"]] ~= nil then
                        if control[keytable["KEY_LED_TUESDAY_ENDIS_4"]] ~= nil then
                            if control[keytable["KEY_LED_THURSDAY_ENDIS_4"]] ~= nil then
                                if control[keytable["KEY_LED_FRIDAY_ENDIS_4"]] ~= nil then
                                    if control[keytable["KEY_LED_SATURDAY_ENDIS_4"]] ~= nil then
                                        if control[keytable["KEY_LED_SUNDAY_ENDIS_4"]] ~= nil then
                                            if control[keytable["KEY_LED_ENABLE_TIMEING_4"]] ~= nil then
                                                bodyBytes[0] = 0x09
                                                bodyBytes[1] = valuetable["LED_TIME_OF_HOUR_4"]
                                                bodyBytes[2] = valuetable["LED_TIME_OF_MINUTE_4"]
                                                bodyBytes[3] = valuetable["LED_WEEK_EN_DIS_4"]
                                                    + valuetable["LED_CTRL_ONOFF_4"]
                                                bodyBytes[4] = valuetable["LED_ENABLE_TIMEING_4"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_LED_MONDAY_ENDIS_5"]] ~= nil then
                    if control[keytable["KEY_LED_WEDNESDAY_ENDIS_5"]] ~= nil then
                        if control[keytable["KEY_LED_TUESDAY_ENDIS_5"]] ~= nil then
                            if control[keytable["KEY_LED_THURSDAY_ENDIS_5"]] ~= nil then
                                if control[keytable["KEY_LED_FRIDAY_ENDIS_5"]] ~= nil then
                                    if control[keytable["KEY_LED_SATURDAY_ENDIS_5"]] ~= nil then
                                        if control[keytable["KEY_LED_SUNDAY_ENDIS_5"]] ~= nil then
                                            if control[keytable["KEY_LED_ENABLE_TIMEING_5"]] ~= nil then
                                                bodyBytes[0] = 0x0a
                                                bodyBytes[1] = valuetable["LED_TIME_OF_HOUR_5"]
                                                bodyBytes[2] = valuetable["LED_TIME_OF_MINUTE_5"]
                                                bodyBytes[3] = valuetable["LED_WEEK_EN_DIS_5"]
                                                    + valuetable["LED_CTRL_ONOFF_5"]
                                                bodyBytes[4] = valuetable["LED_ENABLE_TIMEING_5"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_LED_MONDAY_ENDIS_6"]] ~= nil then
                    if control[keytable["KEY_LED_WEDNESDAY_ENDIS_6"]] ~= nil then
                        if control[keytable["KEY_LED_TUESDAY_ENDIS_6"]] ~= nil then
                            if control[keytable["KEY_LED_THURSDAY_ENDIS_6"]] ~= nil then
                                if control[keytable["KEY_LED_FRIDAY_ENDIS_6"]] ~= nil then
                                    if control[keytable["KEY_LED_SATURDAY_ENDIS_6"]] ~= nil then
                                        if control[keytable["KEY_LED_SUNDAY_ENDIS_6"]] ~= nil then
                                            if control[keytable["KEY_LED_ENABLE_TIMEING_6"]] ~= nil then
                                                bodyBytes[0] = 0x0b
                                                bodyBytes[1] = valuetable["LED_TIME_OF_HOUR_6"]
                                                bodyBytes[2] = valuetable["LED_TIME_OF_MINUTE_6"]
                                                bodyBytes[3] = valuetable["LED_WEEK_EN_DIS_6"]
                                                    + valuetable["LED_CTRL_ONOFF_6"]
                                                bodyBytes[4] = valuetable["LED_ENABLE_TIMEING_6"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_LED_MONDAY_ENDIS_7"]] ~= nil then
                    if control[keytable["KEY_LED_WEDNESDAY_ENDIS_7"]] ~= nil then
                        if control[keytable["KEY_LED_TUESDAY_ENDIS_7"]] ~= nil then
                            if control[keytable["KEY_LED_THURSDAY_ENDIS_7"]] ~= nil then
                                if control[keytable["KEY_LED_FRIDAY_ENDIS_7"]] ~= nil then
                                    if control[keytable["KEY_LED_SATURDAY_ENDIS_7"]] ~= nil then
                                        if control[keytable["KEY_LED_SUNDAY_ENDIS_7"]] ~= nil then
                                            if control[keytable["KEY_LED_ENABLE_TIMEING_7"]] ~= nil then
                                                bodyBytes[0] = 0x0c
                                                bodyBytes[1] = valuetable["LED_TIME_OF_HOUR_7"]
                                                bodyBytes[2] = valuetable["LED_TIME_OF_MINUTE_7"]
                                                bodyBytes[3] = valuetable["LED_WEEK_EN_DIS_7"]
                                                    + valuetable["LED_CTRL_ONOFF_7"]
                                                bodyBytes[4] = valuetable["LED_ENABLE_TIMEING_7"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_LED_MONDAY_ENDIS_8"]] ~= nil then
                    if control[keytable["KEY_LED_WEDNESDAY_ENDIS_8"]] ~= nil then
                        if control[keytable["KEY_LED_TUESDAY_ENDIS_8"]] ~= nil then
                            if control[keytable["KEY_LED_THURSDAY_ENDIS_8"]] ~= nil then
                                if control[keytable["KEY_LED_FRIDAY_ENDIS_8"]] ~= nil then
                                    if control[keytable["KEY_LED_SATURDAY_ENDIS_8"]] ~= nil then
                                        if control[keytable["KEY_LED_SUNDAY_ENDIS_8"]] ~= nil then
                                            if control[keytable["KEY_LED_ENABLE_TIMEING_8"]] ~= nil then
                                                bodyBytes[0] = 0x0d
                                                bodyBytes[1] = valuetable["LED_TIME_OF_HOUR_8"]
                                                bodyBytes[2] = valuetable["LED_TIME_OF_MINUTE_8"]
                                                bodyBytes[3] = valuetable["LED_WEEK_EN_DIS_8"]
                                                    + valuetable["LED_CTRL_ONOFF_8"]
                                                bodyBytes[4] = valuetable["LED_ENABLE_TIMEING_8"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_LED_MONDAY_ENDIS_9"]] ~= nil then
                    if control[keytable["KEY_LED_WEDNESDAY_ENDIS_9"]] ~= nil then
                        if control[keytable["KEY_LED_TUESDAY_ENDIS_9"]] ~= nil then
                            if control[keytable["KEY_LED_THURSDAY_ENDIS_9"]] ~= nil then
                                if control[keytable["KEY_LED_FRIDAY_ENDIS_9"]] ~= nil then
                                    if control[keytable["KEY_LED_SATURDAY_ENDIS_9"]] ~= nil then
                                        if control[keytable["KEY_LED_SUNDAY_ENDIS_9"]] ~= nil then
                                            if control[keytable["KEY_LED_ENABLE_TIMEING_9"]] ~= nil then
                                                bodyBytes[0] = 0x0e
                                                bodyBytes[1] = valuetable["LED_TIME_OF_HOUR_9"]
                                                bodyBytes[2] = valuetable["LED_TIME_OF_MINUTE_9"]
                                                bodyBytes[3] = valuetable["LED_WEEK_EN_DIS_9"]
                                                    + valuetable["LED_CTRL_ONOFF_9"]
                                                bodyBytes[4] = valuetable["LED_ENABLE_TIMEING_9"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_LED_MONDAY_ENDIS_10"]] ~= nil then
                    if control[keytable["KEY_LED_WEDNESDAY_ENDIS_10"]] ~= nil then
                        if control[keytable["KEY_LED_TUESDAY_ENDIS_10"]] ~= nil then
                            if control[keytable["KEY_LED_THURSDAY_ENDIS_10"]] ~= nil then
                                if control[keytable["KEY_LED_FRIDAY_ENDIS_10"]] ~= nil then
                                    if control[keytable["KEY_LED_SATURDAY_ENDIS_10"]] ~= nil then
                                        if control[keytable["KEY_LED_SUNDAY_ENDIS_10"]] ~= nil then
                                            if control[keytable["KEY_LED_ENABLE_TIMEING_10"]] ~= nil then
                                                bodyBytes[0] = 0x0f
                                                bodyBytes[1] = valuetable["LED_TIME_OF_HOUR_10"]
                                                bodyBytes[2] = valuetable["LED_TIME_OF_MINUTE_10"]
                                                bodyBytes[3] = valuetable["LED_WEEK_EN_DIS_10"]
                                                    + valuetable["LED_CTRL_ONOFF_10"]
                                                bodyBytes[4] = valuetable["LED_ENABLE_TIMEING_10"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_FAN_MONDAY_ENDIS_1"]] ~= nil then
                    if control[keytable["KEY_FAN_WEDNESDAY_ENDIS_1"]] ~= nil then
                        if control[keytable["KEY_FAN_TUESDAY_ENDIS_1"]] ~= nil then
                            if control[keytable["KEY_FAN_THURSDAY_ENDIS_1"]] ~= nil then
                                if control[keytable["KEY_FAN_FRIDAY_ENDIS_1"]] ~= nil then
                                    if control[keytable["KEY_FAN_SATURDAY_ENDIS_1"]] ~= nil then
                                        if control[keytable["KEY_FAN_SUNDAY_ENDIS_1"]] ~= nil then
                                            if control[keytable["KEY_FAN_ENABLE_TIMEING_1"]] ~= nil then
                                                bodyBytes[0] = 0x36
                                                bodyBytes[1] = valuetable["FAN_TIME_OF_HOUR_1"]
                                                bodyBytes[2] = valuetable["FAN_TIME_OF_MINUTE_1"]
                                                bodyBytes[3] = valuetable["FAN_WEEK_EN_DIS_1"]
                                                    + valuetable["FAN_CTRL_ONOFF_1"]
                                                bodyBytes[4] = valuetable["FAN_ENABLE_TIMEING_1"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_FAN_MONDAY_ENDIS_2"]] ~= nil then
                    if control[keytable["KEY_FAN_WEDNESDAY_ENDIS_2"]] ~= nil then
                        if control[keytable["KEY_FAN_TUESDAY_ENDIS_2"]] ~= nil then
                            if control[keytable["KEY_FAN_THURSDAY_ENDIS_2"]] ~= nil then
                                if control[keytable["KEY_FAN_FRIDAY_ENDIS_2"]] ~= nil then
                                    if control[keytable["KEY_FAN_SATURDAY_ENDIS_2"]] ~= nil then
                                        if control[keytable["KEY_FAN_SUNDAY_ENDIS_2"]] ~= nil then
                                            if control[keytable["KEY_FAN_ENABLE_TIMEING_2"]] ~= nil then
                                                bodyBytes[0] = 0x37
                                                bodyBytes[1] = valuetable["FAN_TIME_OF_HOUR_2"]
                                                bodyBytes[2] = valuetable["FAN_TIME_OF_MINUTE_2"]
                                                bodyBytes[3] = valuetable["FAN_WEEK_EN_DIS_2"]
                                                    + valuetable["FAN_CTRL_ONOFF_2"]
                                                bodyBytes[4] = valuetable["FAN_ENABLE_TIMEING_2"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_FAN_MONDAY_ENDIS_3"]] ~= nil then
                    if control[keytable["KEY_FAN_WEDNESDAY_ENDIS_3"]] ~= nil then
                        if control[keytable["KEY_FAN_TUESDAY_ENDIS_3"]] ~= nil then
                            if control[keytable["KEY_FAN_THURSDAY_ENDIS_3"]] ~= nil then
                                if control[keytable["KEY_FAN_FRIDAY_ENDIS_3"]] ~= nil then
                                    if control[keytable["KEY_FAN_SATURDAY_ENDIS_3"]] ~= nil then
                                        if control[keytable["KEY_FAN_SUNDAY_ENDIS_3"]] ~= nil then
                                            if control[keytable["KEY_FAN_ENABLE_TIMEING_3"]] ~= nil then
                                                bodyBytes[0] = 0x38
                                                bodyBytes[1] = valuetable["FAN_TIME_OF_HOUR_3"]
                                                bodyBytes[2] = valuetable["FAN_TIME_OF_MINUTE_3"]
                                                bodyBytes[3] = valuetable["FAN_WEEK_EN_DIS_3"]
                                                    + valuetable["FAN_CTRL_ONOFF_3"]
                                                bodyBytes[4] = valuetable["FAN_ENABLE_TIMEING_3"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_FAN_MONDAY_ENDIS_4"]] ~= nil then
                    if control[keytable["KEY_FAN_WEDNESDAY_ENDIS_4"]] ~= nil then
                        if control[keytable["KEY_FAN_TUESDAY_ENDIS_4"]] ~= nil then
                            if control[keytable["KEY_FAN_THURSDAY_ENDIS_4"]] ~= nil then
                                if control[keytable["KEY_FAN_FRIDAY_ENDIS_4"]] ~= nil then
                                    if control[keytable["KEY_FAN_SATURDAY_ENDIS_4"]] ~= nil then
                                        if control[keytable["KEY_FAN_SUNDAY_ENDIS_4"]] ~= nil then
                                            if control[keytable["KEY_FAN_ENABLE_TIMEING_4"]] ~= nil then
                                                bodyBytes[0] = 0x39
                                                bodyBytes[1] = valuetable["FAN_TIME_OF_HOUR_4"]
                                                bodyBytes[2] = valuetable["FAN_TIME_OF_MINUTE_4"]
                                                bodyBytes[3] = valuetable["FAN_WEEK_EN_DIS_4"]
                                                    + valuetable["FAN_CTRL_ONOFF_4"]
                                                bodyBytes[4] = valuetable["FAN_ENABLE_TIMEING_4"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_FAN_MONDAY_ENDIS_5"]] ~= nil then
                    if control[keytable["KEY_FAN_WEDNESDAY_ENDIS_5"]] ~= nil then
                        if control[keytable["KEY_FAN_TUESDAY_ENDIS_5"]] ~= nil then
                            if control[keytable["KEY_FAN_THURSDAY_ENDIS_5"]] ~= nil then
                                if control[keytable["KEY_FAN_FRIDAY_ENDIS_5"]] ~= nil then
                                    if control[keytable["KEY_FAN_SATURDAY_ENDIS_5"]] ~= nil then
                                        if control[keytable["KEY_FAN_SUNDAY_ENDIS_5"]] ~= nil then
                                            if control[keytable["KEY_FAN_ENABLE_TIMEING_5"]] ~= nil then
                                                bodyBytes[0] = 0x3a
                                                bodyBytes[1] = valuetable["FAN_TIME_OF_HOUR_5"]
                                                bodyBytes[2] = valuetable["FAN_TIME_OF_MINUTE_5"]
                                                bodyBytes[3] = valuetable["FAN_WEEK_EN_DIS_5"]
                                                    + valuetable["FAN_CTRL_ONOFF_5"]
                                                bodyBytes[4] = valuetable["FAN_ENABLE_TIMEING_5"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_FAN_MONDAY_ENDIS_6"]] ~= nil then
                    if control[keytable["KEY_FAN_WEDNESDAY_ENDIS_6"]] ~= nil then
                        if control[keytable["KEY_FAN_TUESDAY_ENDIS_6"]] ~= nil then
                            if control[keytable["KEY_FAN_THURSDAY_ENDIS_6"]] ~= nil then
                                if control[keytable["KEY_FAN_FRIDAY_ENDIS_6"]] ~= nil then
                                    if control[keytable["KEY_FAN_SATURDAY_ENDIS_6"]] ~= nil then
                                        if control[keytable["KEY_FAN_SUNDAY_ENDIS_6"]] ~= nil then
                                            if control[keytable["KEY_FAN_ENABLE_TIMEING_6"]] ~= nil then
                                                bodyBytes[0] = 0x3b
                                                bodyBytes[1] = valuetable["FAN_TIME_OF_HOUR_6"]
                                                bodyBytes[2] = valuetable["FAN_TIME_OF_MINUTE_6"]
                                                bodyBytes[3] = valuetable["FAN_WEEK_EN_DIS_6"]
                                                    + valuetable["FAN_CTRL_ONOFF_6"]
                                                bodyBytes[4] = valuetable["FAN_ENABLE_TIMEING_6"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_FAN_MONDAY_ENDIS_7"]] ~= nil then
                    if control[keytable["KEY_FAN_WEDNESDAY_ENDIS_7"]] ~= nil then
                        if control[keytable["KEY_FAN_TUESDAY_ENDIS_7"]] ~= nil then
                            if control[keytable["KEY_FAN_THURSDAY_ENDIS_7"]] ~= nil then
                                if control[keytable["KEY_FAN_FRIDAY_ENDIS_7"]] ~= nil then
                                    if control[keytable["KEY_FAN_SATURDAY_ENDIS_7"]] ~= nil then
                                        if control[keytable["KEY_FAN_SUNDAY_ENDIS_7"]] ~= nil then
                                            if control[keytable["KEY_FAN_ENABLE_TIMEING_7"]] ~= nil then
                                                bodyBytes[0] = 0x3c
                                                bodyBytes[1] = valuetable["FAN_TIME_OF_HOUR_7"]
                                                bodyBytes[2] = valuetable["FAN_TIME_OF_MINUTE_7"]
                                                bodyBytes[3] = valuetable["FAN_WEEK_EN_DIS_7"]
                                                    + valuetable["FAN_CTRL_ONOFF_7"]
                                                bodyBytes[4] = valuetable["FAN_ENABLE_TIMEING_7"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_FAN_MONDAY_ENDIS_8"]] ~= nil then
                    if control[keytable["KEY_FAN_WEDNESDAY_ENDIS_8"]] ~= nil then
                        if control[keytable["KEY_FAN_TUESDAY_ENDIS_8"]] ~= nil then
                            if control[keytable["KEY_FAN_THURSDAY_ENDIS_8"]] ~= nil then
                                if control[keytable["KEY_FAN_FRIDAY_ENDIS_8"]] ~= nil then
                                    if control[keytable["KEY_FAN_SATURDAY_ENDIS_8"]] ~= nil then
                                        if control[keytable["KEY_FAN_SUNDAY_ENDIS_8"]] ~= nil then
                                            if control[keytable["KEY_FAN_ENABLE_TIMEING_8"]] ~= nil then
                                                bodyBytes[0] = 0x3d
                                                bodyBytes[1] = valuetable["FAN_TIME_OF_HOUR_8"]
                                                bodyBytes[2] = valuetable["FAN_TIME_OF_MINUTE_8"]
                                                bodyBytes[3] = valuetable["FAN_WEEK_EN_DIS_8"]
                                                    + valuetable["FAN_CTRL_ONOFF_8"]
                                                bodyBytes[4] = valuetable["FAN_ENABLE_TIMEING_8"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_FAN_MONDAY_ENDIS_9"]] ~= nil then
                    if control[keytable["KEY_FAN_WEDNESDAY_ENDIS_9"]] ~= nil then
                        if control[keytable["KEY_FAN_TUESDAY_ENDIS_9"]] ~= nil then
                            if control[keytable["KEY_FAN_THURSDAY_ENDIS_9"]] ~= nil then
                                if control[keytable["KEY_FAN_FRIDAY_ENDIS_9"]] ~= nil then
                                    if control[keytable["KEY_FAN_SATURDAY_ENDIS_9"]] ~= nil then
                                        if control[keytable["KEY_FAN_SUNDAY_ENDIS_9"]] ~= nil then
                                            if control[keytable["KEY_FAN_ENABLE_TIMEING_9"]] ~= nil then
                                                bodyBytes[0] = 0x3e
                                                bodyBytes[1] = valuetable["FAN_TIME_OF_HOUR_9"]
                                                bodyBytes[2] = valuetable["FAN_TIME_OF_MINUTE_9"]
                                                bodyBytes[3] = valuetable["FAN_WEEK_EN_DIS_9"]
                                                    + valuetable["FAN_CTRL_ONOFF_9"]
                                                bodyBytes[4] = valuetable["FAN_ENABLE_TIMEING_9"]
                                            end
                                        end
                                    end
                                end
                ...
                if control[keytable["KEY_FAN_MONDAY_ENDIS_10"]] ~= nil then
                    if control[keytable["KEY_FAN_WEDNESDAY_ENDIS_10"]] ~= nil then
                        if control[keytable["KEY_FAN_TUESDAY_ENDIS_10"]] ~= nil then
                            if control[keytable["KEY_FAN_THURSDAY_ENDIS_10"]] ~= nil then
                                if control[keytable["KEY_FAN_FRIDAY_ENDIS_10"]] ~= nil then
                                    if control[keytable["KEY_FAN_SATURDAY_ENDIS_10"]] ~= nil then
                                        if control[keytable["KEY_FAN_SUNDAY_ENDIS_10"]] ~= nil then
                                            if control[keytable["KEY_FAN_ENABLE_TIMEING_10"]] ~= nil then
                                                bodyBytes[0] = 0x3f
                                                bodyBytes[1] = valuetable["FAN_TIME_OF_HOUR_10"]
                                                bodyBytes[2] = valuetable["FAN_TIME_OF_MINUTE_10"]
                                                bodyBytes[3] = valuetable["FAN_WEEK_EN_DIS_10"]
                                                    + valuetable["FAN_CTRL_ONOFF_10"]
                                                bodyBytes[4] = valuetable["FAN_ENABLE_TIMEING_10"]
                                            end
                                        end
                                    end
                                end
