...
function jsonToModel(jsonCmd)
    ...
    if streams[KEY_CMD_CODE] ~= nil then cmdCode = string2Int(streams[KEY_CMD_CODE]) end
    if streams[KEY_CMD_ID] ~= nil then cmdID = checkBoundary(streams[KEY_CMD_ID], 0, 255) end
    ...
    if streams[KEY_TIME_WARM_HR] ~= nil then timeWarmHr = checkBoundary(streams[KEY_TIME_WARM_HR], 0, 23) end
    if streams[KEY_TIME_WARM_MIN] ~= nil then timeWarmMin = checkBoundary(streams[KEY_TIME_WARM_MIN], 0, 59) end
