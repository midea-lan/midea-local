...
class TestC1GeneralMessageBody:
    ...
    def test_power_heating_temperatures(self) -> None:
        ...
        assert msg.error_code == C1ErrorCode.NONE
        ...
        assert msg.heating_mode == C1HeatingMode.ACTIVITY
    ...
    def test_power_off(self) -> None:
        ...
        assert msg.fault is False
        assert msg.heating_mode == C1HeatingMode.SLEEP
    ...
    def test_fault_state_body_3_bit7(self) -> None:
        ...
        msg = C1GeneralMessageBody(body)
        assert msg.error_code == C1ErrorCode.E8
    ...
    def test_regression_real_notify_payload(self) -> None:
        ...
        assert msg.heating_mode == C1HeatingMode.USER
    ...
    def test_packed_aux_byte(self) -> None:
        """Lua bodyBytes[33]: pump, 3-way, unit type (brightness bits unused)."""
        body = bytearray(32)
        body[22] = 0x0E  # pump, 3-way alt, radiator; no buzzer bit
        msg = C1GeneralMessageBody(body)
        assert msg.pump_on is True
        assert msg.three_way_mode == C1ThreeWayMode.ALTERNATE
        assert msg.heating_unit_type == C1HeatingUnitType.RADIATOR

    def test_error_code_multiple_flags(self) -> None:
        """Primary byte can set F0 and E8 at the same time."""
        body = bytearray(8)
        body[3] = 0x81
        assert c1_error_code(body) == (C1ErrorCode.F0 | C1ErrorCode.E8)
    ...
    def test_heating_mode_unknown(self) -> None:
        ...
        body[14] = 0xFF
        msg = C1GeneralMessageBody(body)
        assert msg.heating_mode == C1HeatingMode.UNKNOWN
...
class TestMessageSetHeating:
    ...
    def test_heating_set_body(self) -> None:
        ...
        msg.heating_mode = C1HeatingMode.ACTIVITY
