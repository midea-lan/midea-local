...
| ac | lua/ac | midealocal/devices/ac | MATCHED | 41 | filename type token 'ac' == DeviceType byte 0xAC |
| b0 | lua/b0 | midealocal/devices/b0 | MATCHED | 4 | BYTE_DEVICE_TYPE == DeviceType.B0 (0xB0) |
...
| b6 | lua/b6 | midealocal/devices/b6 | MATCHED | 6 | filename type token 'b6' == DeviceType byte 0xB6 |
...
| ca | lua/ca | midealocal/devices/ca | MATCHED | 14 | filename type token 'ca' == DeviceType byte 0xCA |
...
| e1 | lua/e1 | midealocal/devices/e1 | MATCHED | 6 | filename type token 'e1' == DeviceType byte 0xE1 |
| e2 | lua/e2 | midealocal/devices/e2 | MATCHED | 3 | filename type token 'e2' == DeviceType byte 0xE2 |
| e3 | lua/e3 | midealocal/devices/e3 | MATCHED | 7 | filename type token 'e3' == DeviceType byte 0xE3 |
...
| ed | lua/ed | midealocal/devices/ed | MATCHED | 8 | BYTE_DEVICE_TYPE == DeviceType.ED (0xED) |
...
| fc | lua/fc | midealocal/devices/fc | MATCHED | 2 | filename type token 'fc' == DeviceType byte 0xFC |
...
- UNMATCHED_NO_LUA: 4
- lua files under mapped device types: 164
