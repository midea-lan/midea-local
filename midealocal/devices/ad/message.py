...
class MessageADResponse(MessageResponse):
    ...
    def __init__(self, message: bytes) -> None:
        ...
        if self._body_type == ListTypes.X11:
            self.set_body(ADNotifyMessageBody(super().body, data_offset=1))
        elif self._body_type == ListTypes.X21:
            self.set_body(X21MessageBody(super().body, data_offset=1))
        elif self._body_type == ListTypes.X31:
            self.set_body(X31MessageBody(super().body, data_offset=1))
        self.set_attr()
