...
class CAExceptionMessageBody(MessageBody):
    ...
    def __init__(self, body: bytearray) -> None:
        ...
        self.eepromReadWriteError = body[3] & 0x10
        self.leftFlexzoneSensorError = body[3] & 0x20
        self.iceRoomSensorError = body[3] & 0x40
        self.mainDisplayCorrespondError = body[3] & 0x80
        self.iceMachineTemperatureError = body[4] & 0x01
        self.flexzoneDefrostingSensorError = body[4] & 0x02
        self.flexzoneDefrostingSensor2Error = body[4] & 0x04
        self.yogurtMachineSensorError = body[4] & 0x08
        self.iceMachineFrettingSwitchError = body[4] & 0x10
        self.iceMachinePipeFilterOvertime = body[4] & 0x20
        self.ambientHumiditySensorError = body[4] & 0x40
        self.storageHumiditySensorError = body[4] & 0x80
        self.radarSensor1Error = body[5] & 0x01
        self.radarSensor2Error = body[5] & 0x02
        self.radarSensor3Error = body[5] & 0x04
        self.radarSensor4Error = body[5] & 0x08
        self.radarSensor5Error = body[5] & 0x10
        self.functionZoneTemperatureSensorError = body[5] & 0x20
        self.normalZoneTemperatureSensorError = body[5] & 0x40
        self.humidityControlSensorError = body[5] & 0x80
        self.openDoorTooFrequently = body[6] & 0x01
        self.storageDoorAloneOpenFrequently = body[6] & 0x02
        self.freezingDoorAloneOpenFrequently = body[6] & 0x04
        self.barDoorAloneOpenFrequently = body[6] & 0x08
        self.snWritingError = body[6] & 0x20
        self.storageTemperatureOverheating = body[6] & 0x40
        self.storageTemperatureTooLow = body[6] & 0x80
        self.storageHeatingWireSensorError = body[7] & 0x01
        self.uartReceiverError = body[7] & 0x02
        self.crystalliteMainSensorError = body[7] & 0x08
        self.crystalliteBase1SensorError = body[7] & 0x10
        self.crystalliteBase2SensorError = body[7] & 0x20
        self.crystalliteBase3SensorError = body[7] & 0x40
        self.crystalliteBase4SensorError = body[7] & 0x80
