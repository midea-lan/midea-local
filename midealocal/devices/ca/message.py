...
class CAGeneralMessageBody(MessageBody):
    ...
    def __init__(self, body: bytearray) -> None:
        ...
        self.code_mode = body[1] & 0x01
        self.freezing_mode = body[1] & 0x02
        self.smart_mode = body[1] & 0x04
        self.energy_saving_mode = body[1] & 0x08
        self.holiday_mode = body[1] & 0x10
        self.moisturize_mode = body[1] & 0x20
        self.preservation_mode = body[1] & 0x40
        self.acmeFreezing_mode = body[1] & 0x80
        ...
        self.refrigeration_power = body[6] & 0x01  # refrigerationPowerValue
        self.l_variable_power = body[6] & 0x04  # lVariablePowerValue
        self.r_variable_power = body[6] & 0x08  # rVariablePowerValue
        self.freezing_power = body[6] & 0x10  # freezingPowerValue
        self.cross_peak_electricity_enter = body[6] & 0x20  # crossPeakElectricityEnter
        self.cross_peak_electricity = body[6] & 0x40  # crossPeakElectricity
        self.all_refrigeration_power = body[6] & 0x80  # allRefrigerationPower
        ...
        if len(body) > CA_GENERAL_BODY_LENGTH1:
            self.microcrystal_fresh = body[27] & 0x01
            self.dry_zone = body[27] & 0x02
            self.electronic_smell = body[27] & 0x04
