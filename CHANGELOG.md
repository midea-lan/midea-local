...
## [7.0.0](https://github.com/midea-lan/midea-local/compare/v6.7.0...v7.0.0) (2026-06-06)


### ⚠ BREAKING CHANGES

* **cloud:** rename MSmartHome ([#306](https://github.com/midea-lan/midea-local/issues/306))
* **device:** rollback and socket refresh_status ([#307](https://github.com/midea-lan/midea-local/issues/307))
* **device:** rollback and improve send/recv socket exception ([#304](https://github.com/midea-lan/midea-local/issues/304))
* **device:** socket exception and process rebuild ([#296](https://github.com/midea-lan/midea-local/issues/296))
* **cli:** download protocol ([#214](https://github.com/midea-lan/midea-local/issues/214))

### Features

* **40:** add `precision_halves` customization ([#248](https://github.com/midea-lan/midea-local/issues/248)) ([8f5ec79](https://github.com/midea-lan/midea-local/commit/8f5ec79fe859ad88519360353cd3b6e159200625))
...
* **ac:** mode capabilities ([#196](https://github.com/midea-lan/midea-local/issues/196)) ([43d9918](https://github.com/midea-lan/midea-local/commit/43d9918be79f8dbb4f8b126d121619d04efe47cf))
...
* add set_target_temperature for MideaFBDevice ([#179](https://github.com/midea-lan/midea-local/issues/179)) ([75f76ed](https://github.com/midea-lan/midea-local/commit/75f76edae8934617c9d6b50359f028f963b70900))
...
* **b8:** first implementation ([#225](https://github.com/midea-lan/midea-local/issues/225)) ([259e4f2](https://github.com/midea-lan/midea-local/commit/259e4f2f715b38a280789530941acc53d98beca4))
...
* **c3:** add option to set super_silent ([#210](https://github.com/midea-lan/midea-local/issues/210)) ([dcef500](https://github.com/midea-lan/midea-local/commit/dcef500f073ce150283730132fd4a3155850e332))
...
* **c3:** query and set silence level ([#227](https://github.com/midea-lan/midea-local/issues/227)) ([556f7c2](https://github.com/midea-lan/midea-local/commit/556f7c234d4581472b0ce2f3830289b2ba529c90))
* **c3:** temperature step as customize ([#209](https://github.com/midea-lan/midea-local/issues/209)) ([4da6e3e](https://github.com/midea-lan/midea-local/commit/4da6e3eb18eae9b24b4300274e307db0af8633de))
...
* **cli:** download protocol ([#214](https://github.com/midea-lan/midea-local/issues/214)) ([7a99374](https://github.com/midea-lan/midea-local/commit/7a993745c0c7fcf1e9eff86a2287e3cbff3f3d8d))
* **cli:** midealocal CLI tool ([#204](https://github.com/midea-lan/midea-local/issues/204)) ([236e33a](https://github.com/midea-lan/midea-local/commit/236e33a95fde65aba499832bb6901f32ac21628d))
* **cli:** set attribute from device ([#241](https://github.com/midea-lan/midea-local/issues/241)) ([6f0a109](https://github.com/midea-lan/midea-local/commit/6f0a10942c0b5defd3622c14bcd2795b34ec01a8))
* **cli:** use of preset account if cloud info missing ([#278](https://github.com/midea-lan/midea-local/issues/278)) ([84293bf](https://github.com/midea-lan/midea-local/commit/84293bfd86b9bb55f59b6897ff5d356df51f7fdb))
...
* enable py.typed ([#95](https://github.com/midea-lan/midea-local/issues/95)) ([08365d8](https://github.com/midea-lan/midea-local/commit/08365d86dda1ef46bca40b36cef8e49d4d9b23d9))
* expose cloud servers ([#128](https://github.com/midea-lan/midea-local/issues/128)) ([a2fac82](https://github.com/midea-lan/midea-local/commit/a2fac82d3f5edba3729da83c8f7cb25c38d1781e))
* first commit ([c996071](https://github.com/midea-lan/midea-local/commit/c996071375bb4ac84d5d8e08c799f581c75354da))
* improve get_midea_cloud ([#182](https://github.com/midea-lan/midea-local/issues/182)) ([deef1ec](https://github.com/midea-lan/midea-local/commit/deef1ec060faf090ac629522c0d14f65b9936f09))
* library_test colorlog ([#191](https://github.com/midea-lan/midea-local/issues/191)) ([d5db805](https://github.com/midea-lan/midea-local/commit/d5db805b3435f02edfd655cc33490d9b4f19e16a))
* **message:** body parsers ([#235](https://github.com/midea-lan/midea-local/issues/235)) ([c636eee](https://github.com/midea-lan/midea-local/commit/c636eeef5128504c079704d023e2215896e3c770))
* parse all the response items from MeijuCloud for get_device_inf ([#231](https://github.com/midea-lan/midea-local/issues/231)) ([1976eb6](https://github.com/midea-lan/midea-local/commit/1976eb63578698d2b9a745a92c9c61a887219e0d))
* redact data from cloud ([#232](https://github.com/midea-lan/midea-local/issues/232)) ([c61991e](https://github.com/midea-lan/midea-local/commit/c61991eb93ca817d6245328fe1f5828a33dc5738))
* rework auth flow - part 1 ([#219](https://github.com/midea-lan/midea-local/issues/219)) ([d8ac4fb](https://github.com/midea-lan/midea-local/commit/d8ac4fb5de25dbf04548b411f5a930878b32a2df))
* rework auth flow - part 2 ([#221](https://github.com/midea-lan/midea-local/issues/221)) ([f74ff8e](https://github.com/midea-lan/midea-local/commit/f74ff8e1af924d84621958d0c6d8659cef1b98e6))
* segregate connect/auth/refresh/enable device duties ([#233](https://github.com/midea-lan/midea-local/issues/233)) ([681bd79](https://github.com/midea-lan/midea-local/commit/681bd79f078deafe82cc4708f47c53c808dca064))


### Bug Fixes

* fix:  ([db2fdf0](https://github.com/midea-lan/midea-local/commit/db2fdf0bb4aa9d6a9e4ed47c876fd57f57f30c9f))
* `break` the loop when connected ([#244](https://github.com/midea-lan/midea-local/issues/244)) ([536f975](https://github.com/midea-lan/midea-local/commit/536f975b93a3d68466a1bfa5a7c152570121531e))
* **a1:** attribute with wrong default ([#55](https://github.com/midea-lan/midea-local/issues/55)) ([7e66870](https://github.com/midea-lan/midea-local/commit/7e66870df5b0003a55b26932bdb343db58395931))
...
* **ac:** correct attributes based on msg type ([#251](https://github.com/midea-lan/midea-local/issues/251)) ([fada9bc](https://github.com/midea-lan/midea-local/commit/fada9bc5fcc4158a6315566b8e9372c8805e21b4))
...
* add missing body_type "163" ([#317](https://github.com/midea-lan/midea-local/issues/317)) ([45f7bd2](https://github.com/midea-lan/midea-local/commit/45f7bd2432a04fb69c9fdb9b6204de7eac87aa2e))
* add more BodyType ([#321](https://github.com/midea-lan/midea-local/issues/321)) ([a1b4ac8](https://github.com/midea-lan/midea-local/commit/a1b4ac807e3b475f0a32f44c0f1d7af980d7a486))
* aes_decrypt params and code styling ([#175](https://github.com/midea-lan/midea-local/issues/175)) ([f4c6b87](https://github.com/midea-lan/midea-local/commit/f4c6b87dfa331ea321ad75aab21f6a71fa740035))
* allign set_target_temperature signatures ([#176](https://github.com/midea-lan/midea-local/issues/176)) ([4d8c843](https://github.com/midea-lan/midea-local/commit/4d8c84312de235aa2bbd16a8ae7ce03487a1c516))
* allign set_target_temperature signatures (part2) ([#177](https://github.com/midea-lan/midea-local/issues/177)) ([3466811](https://github.com/midea-lan/midea-local/commit/346681145852c7985ff469bc2869436a6244dc42))
* body_type default value is zero and not None ([#271](https://github.com/midea-lan/midea-local/issues/271)) ([bf6b4f0](https://github.com/midea-lan/midea-local/commit/bf6b4f0d0548bf495339cf793acd30673634f6d1))
* body_type NONE_VALUE checks ([#84](https://github.com/midea-lan/midea-local/issues/84)) ([b0337ba](https://github.com/midea-lan/midea-local/commit/b0337bae82a728678849a80f1d078460244298b1))
* **c3:** silent level as string ([#270](https://github.com/midea-lan/midea-local/issues/270)) ([c851e33](https://github.com/midea-lan/midea-local/commit/c851e33dc9e8f7bb5a2f7d49f2e7c557d3a7151f))
* **c3:** silent typo ([#265](https://github.com/midea-lan/midea-local/issues/265)) ([97defcd](https://github.com/midea-lan/midea-local/commit/97defcdc100424992c0f2bc7d4797cbbb6825076))
...
* **c3:** zone check ([#180](https://github.com/midea-lan/midea-local/issues/180)) ([d51cab4](https://github.com/midea-lan/midea-local/commit/d51cab40a7f7f1205b02db1b11c593ab5da9bffe))
* **capabilities:** make capabilities optional ([#217](https://github.com/midea-lan/midea-local/issues/217)) ([c269e71](https://github.com/midea-lan/midea-local/commit/c269e717c2b2b5e7f390f0e2ba781513584442b2))
...
* cleanup and complete body and subbody types lists ([#325](https://github.com/midea-lan/midea-local/issues/325)) ([914dcb8](https://github.com/midea-lan/midea-local/commit/914dcb8098efe50cc1583ad81fd22b49e9e2536b))
* **cli:** authenticate on discover v3 device ([#263](https://github.com/midea-lan/midea-local/issues/263)) ([05b0b11](https://github.com/midea-lan/midea-local/commit/05b0b11d98a3435373742c2cf50142f618700ed1))
* **cli:** authenticate to get keys ([#256](https://github.com/midea-lan/midea-local/issues/256)) ([a017e7a](https://github.com/midea-lan/midea-local/commit/a017e7af46130266226f6c9a100b05703dd6cb5c))
* **cli:** discover must return a list ([#266](https://github.com/midea-lan/midea-local/issues/266)) ([345794b](https://github.com/midea-lan/midea-local/commit/345794b1241c149c172c117412ed48707daff6b9))
* **cloud:** fix email obfuscation ([#245](https://github.com/midea-lan/midea-local/issues/245)) ([ad9f278](https://github.com/midea-lan/midea-local/commit/ad9f278c7284e7e80285d66adc8320bb944f1162))
* **cloud:** get default keys as static ([#229](https://github.com/midea-lan/midea-local/issues/229)) ([815643a](https://github.com/midea-lan/midea-local/commit/815643a1a59a14863090b0cdd65170605a8b91da))
* **cloud:** meiju cloud download_lua appliance_type error ([#281](https://github.com/midea-lan/midea-local/issues/281)) ([54f1bf4](https://github.com/midea-lan/midea-local/commit/54f1bf4a812c44590d9e01e9cd91c4c0f1768948))
* **cloud:** mideaair request fails on http exception ([#44](https://github.com/midea-lan/midea-local/issues/44)) ([4f18938](https://github.com/midea-lan/midea-local/commit/4f1893840b19559cdb639c2d5eb75a5b73ad7ad8))
...
* **crc8:** typing and removal of uneded code ([8bcf19d](https://github.com/midea-lan/midea-local/commit/8bcf19d08de1b74206758daf8780094c258d5967))
* **da:** avoid indexes out of bounds ([#199](https://github.com/midea-lan/midea-local/issues/199)) ([246f9c7](https://github.com/midea-lan/midea-local/commit/246f9c752f49a5425e06ea1b3772347bc4eb3880))
...
* **device:** capabilities ([#212](https://github.com/midea-lan/midea-local/issues/212)) ([f7cff37](https://github.com/midea-lan/midea-local/commit/f7cff3767522a6f1008a5f7b4ef8677ecd9296bc))
...
* **device:** prevent while true loop high cpu usage bug ([#298](https://github.com/midea-lan/midea-local/issues/298)) ([3bdec5c](https://github.com/midea-lan/midea-local/commit/3bdec5cbbad960d4fbc5b9a5520fa7c9219fe405))
* **device:** rollback and improve send/recv socket exception ([#304](https://github.com/midea-lan/midea-local/issues/304)) ([7083464](https://github.com/midea-lan/midea-local/commit/7083464bba91e2f341d09de3b90b6bc77ccac9cb))
* **device:** rollback and socket refresh_status ([#307](https://github.com/midea-lan/midea-local/issues/307)) ([f65b6ac](https://github.com/midea-lan/midea-local/commit/f65b6ac8fcc8ff2ae7085068498b96066213b658))
* **device:** socket exception and process rebuild ([#296](https://github.com/midea-lan/midea-local/issues/296)) ([7f2e572](https://github.com/midea-lan/midea-local/commit/7f2e57294802d6ecae64618d28d1659465077672))
...
* **e6:** min and max temp should be list[int] ([#172](https://github.com/midea-lan/midea-local/issues/172)) ([515ed59](https://github.com/midea-lan/midea-local/commit/515ed599a00b60558aa689733d9fc6289e9f027f))
...
* ed device power/lock return message set and body_type 0x15 parse ([#284](https://github.com/midea-lan/midea-local/issues/284)) ([d9d4fac](https://github.com/midea-lan/midea-local/commit/d9d4faca3bf7a3096f1e12a53dd5953b79f2a422))
...
* improve cloud token/keys retrival ([#189](https://github.com/midea-lan/midea-local/issues/189)) ([feb855f](https://github.com/midea-lan/midea-local/commit/feb855f4475aab882fad6acb73635491f23101f7))
* **library_test:** add cloud login ([#190](https://github.com/midea-lan/midea-local/issues/190)) ([8ad314e](https://github.com/midea-lan/midea-local/commit/8ad314e5dc1ee894c33309fae75ef9005db48751))
* **library_test:** missing session close ([#192](https://github.com/midea-lan/midea-local/issues/192)) ([267e730](https://github.com/midea-lan/midea-local/commit/267e7302c087a38faee60d48d75467cf0002f8ca))
...
* message protocol version default ([#316](https://github.com/midea-lan/midea-local/issues/316)) ([2f4e5d1](https://github.com/midea-lan/midea-local/commit/2f4e5d1d1335696cc3a179a67cf287eef54b6864))
...
* normalize old_protocol for E2 ([#93](https://github.com/midea-lan/midea-local/issues/93)) ([f64b0c8](https://github.com/midea-lan/midea-local/commit/f64b0c84d243b6b217ce2e16683950f0092e811f))
* protocol check in B6 devices ([#320](https://github.com/midea-lan/midea-local/issues/320)) ([55659c1](https://github.com/midea-lan/midea-local/commit/55659c19a642fadfd37aee32fbeae76e48aed3dd))
* rename X40 classes ([#183](https://github.com/midea-lan/midea-local/issues/183)) ([a8b07d2](https://github.com/midea-lan/midea-local/commit/a8b07d2f77e0345eb57d504a27361900845bb5f0))
* rollback get_keys with 3 keys ([#200](https://github.com/midea-lan/midea-local/issues/200)) ([54153a8](https://github.com/midea-lan/midea-local/commit/54153a8fd24c5f5ae3ef2b02e7ef863d18bc998a))
...
* tank is always seen as full ([#255](https://github.com/midea-lan/midea-local/issues/255)) ([3524405](https://github.com/midea-lan/midea-local/commit/3524405fd36131deb83c9ded236eb686860f58c2))
* TypeError when modelNumber is None ([#10](https://github.com/midea-lan/midea-local/issues/10)) ([f2855e7](https://github.com/midea-lan/midea-local/commit/f2855e750cc0d249463ee22a7abaf33e5e2915c6))
* wrong dependencies with package ([#215](https://github.com/midea-lan/midea-local/issues/215)) ([d63fc6b](https://github.com/midea-lan/midea-local/commit/d63fc6b49394f9bfc9c9cb32b34c36b5e97f02a6))
...
* **cloud:** rename MSmartHome ([#306](https://github.com/midea-lan/midea-local/issues/306)) ([20c796e](https://github.com/midea-lan/midea-local/commit/20c796eb9f9728ff4042f3caf2e0ff11012e12f5)), closes [#286](https://github.com/midea-lan/midea-local/issues/286)
